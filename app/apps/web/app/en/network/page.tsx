...
/**
 * `/en/network` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/network/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/en/network' })`, breadcrumb `Home` → `/en`,
 ...
 * `/en/network` and `alternates.languages` `en` + `x-default` → EN canonical.
 */
...
export default function EnNetworkPage() {
  return (
    <>
