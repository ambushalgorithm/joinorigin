...
/**
 * `/uk/signup` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/signup/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/uk/signup' })`, breadcrumb `Home` → `/uk`,
 ...
 * `/uk/signup` and `alternates.languages` `uk` + `en` + `x-default` → EN canonical.
 */
...
export default function UkSignupPage() {
  return (
    <>
      <SignupView />
      <JsonLd
