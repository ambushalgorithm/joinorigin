...
/**
 * `/uk/contact` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/contact/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/uk/contact' })`, breadcrumb `Home` → `/uk`,
 ...
 * `/uk/contact` and `alternates.languages` `uk` + `en` + `x-default` → EN canonical.
 */
