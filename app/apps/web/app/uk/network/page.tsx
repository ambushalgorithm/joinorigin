...
/**
 * `/uk/network` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/network/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/uk/network' })`, breadcrumb `Home` → `/uk`,
 ...
 * `/uk/network` and `alternates.languages` `uk` + `en` + `x-default` → EN canonical.
 */
...
export default function UkNetworkPage() {
  return (
    <>
