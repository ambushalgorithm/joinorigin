...
/**
 * `/uk/docs` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/docs/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/uk/docs' })`, breadcrumb `Home` → `/uk`,
 ...
 * `/uk/docs` and `alternates.languages` `uk` + `en` + `x-default` → EN canonical.
 */
...
export default function UkDocsPage() {
  return (
    <>
      <DocsView />
      <JsonLd
