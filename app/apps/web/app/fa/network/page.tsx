...
/**
 * `/fa/network` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/network/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/fa/network' })`, breadcrumb `Home` → `/fa`,
 ...
 * `/fa/network` and `alternates.languages` `fa` + `en` + `x-default` → EN canonical.
 */
...
export default function FaNetworkPage() {
  return (
    <>
