...
/**
 * `/fa/signup` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/signup/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/fa/signup' })`, breadcrumb `Home` → `/fa`,
 ...
 * `/fa/signup` and `alternates.languages` `fa` + `en` + `x-default` → EN canonical.
 */
...
export default function FaSignupPage() {
  return (
    <>
      <SignupView />
      <JsonLd
