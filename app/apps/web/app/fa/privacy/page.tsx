...
/**
 * `/fa/privacy` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/privacy/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/fa/privacy' })`, breadcrumb `Home` → `/fa`,
 ...
 * `/fa/privacy` and `alternates.languages` `fa` + `en` + `x-default` → EN canonical.
 */
...
export default function FaPrivacyPage() {
  return (
    <>
      <PrivacyView />
      <JsonLd
