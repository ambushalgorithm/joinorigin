...
/**
 * `/fa/docs` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/docs/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/fa/docs' })`, breadcrumb `Home` → `/fa`,
 ...
 * `/fa/docs` and `alternates.languages` `fa` + `en` + `x-default` → EN canonical.
 */
...
export default function FaDocsPage() {
  return (
    <>
      <DocsView />
      <JsonLd
