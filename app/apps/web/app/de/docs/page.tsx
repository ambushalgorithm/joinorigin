...
/**
 * `/de/docs` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/docs/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/de/docs' })`, breadcrumb `Home` → `/de`,
 ...
 * `/de/docs` and `alternates.languages` `de` + `en` + `x-default` → EN canonical.
 */
...
export default function DeDocsPage() {
  return (
    <>
      <DocsView />
      <JsonLd
