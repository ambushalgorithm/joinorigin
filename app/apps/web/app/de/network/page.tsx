...
/**
 * `/de/network` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/network/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/de/network' })`, breadcrumb `Home` → `/de`,
 ...
 * `/de/network` and `alternates.languages` `de` + `en` + `x-default` → EN canonical.
 */
...
export default function DeNetworkPage() {
  return (
    <>
