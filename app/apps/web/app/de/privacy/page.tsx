...
/**
 * `/de/privacy` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/privacy/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/de/privacy' })`, breadcrumb `Home` → `/de`,
 ...
 * `/de/privacy` and `alternates.languages` `de` + `en` + `x-default` → EN canonical.
 */
