...
/**
 * `/de/signup` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/signup/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/de/signup' })`, breadcrumb `Home` → `/de`,
 ...
 * `/de/signup` and `alternates.languages` `de` + `en` + `x-default` → EN canonical.
 */
