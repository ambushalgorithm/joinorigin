...
/**
 * `/de/terms` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/terms/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/de/terms' })`, breadcrumb `Home` → `/de`,
 ...
 * `/de/terms` and `alternates.languages` `de` + `en` + `x-default` → EN canonical.
 */
