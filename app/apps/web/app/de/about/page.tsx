...
/**
 * `/de/about` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/about/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/de/about' })`, breadcrumb `Home` → `/de`,
 ...
 * `/de/about` and `alternates.languages` `de` + `en` + `x-default` → EN canonical.
 */
