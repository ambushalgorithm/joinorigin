...
/**
 * `/hi/network` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/network/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/hi/network' })`, breadcrumb `Home` → `/hi`,
 ...
 * `/hi/network` and `alternates.languages` `hi` + `en` + `x-default` → EN canonical.
 */
...
export default function HiNetworkPage() {
  return (
    <>
