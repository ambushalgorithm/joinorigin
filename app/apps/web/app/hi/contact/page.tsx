...
/**
 * `/hi/contact` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/contact/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/hi/contact' })`, breadcrumb `Home` → `/hi`,
 ...
 * `/hi/contact` and `alternates.languages` `hi` + `en` + `x-default` → EN canonical.
 */
