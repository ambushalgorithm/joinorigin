...
/**
 * `/hi/about` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/about/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/hi/about' })`, breadcrumb `Home` → `/hi`,
 ...
 * `/hi/about` and `alternates.languages` `hi` + `en` + `x-default` → EN canonical.
 */
