...
/**
 * `/hi/docs` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/docs/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/hi/docs' })`, breadcrumb `Home` → `/hi`,
 ...
 * `/hi/docs` and `alternates.languages` `hi` + `en` + `x-default` → EN canonical.
 */
...
export default function HiDocsPage() {
  return (
    <>
      <DocsView />
      <JsonLd
