...
/**
 * `/hi/terms` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/terms/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/hi/terms' })`, breadcrumb `Home` → `/hi`,
 ...
 * `/hi/terms` and `alternates.languages` `hi` + `en` + `x-default` → EN canonical.
 */
...
export default function HiTermsPage() {
  return (
    <>
      <TermsView />
      <JsonLd
