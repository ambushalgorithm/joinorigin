...
/**
 * `/ar/docs` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/docs/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/ar/docs' })`, breadcrumb `Home` → `/ar`,
 ...
 * `/ar/docs` and `alternates.languages` `ar` + `en` + `x-default` → EN canonical.
 */
