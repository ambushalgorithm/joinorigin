...
/**
 * `/ar/signup` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/signup/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/ar/signup' })`, breadcrumb `Home` → `/ar`,
 ...
 * `/ar/signup` and `alternates.languages` `ar` + `en` + `x-default` → EN canonical.
 */
...
export default function ArSignupPage() {
  return (
    <>
      <SignupView />
      <JsonLd
