...
/**
 * `/fr/docs` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/docs/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/fr/docs' })`, breadcrumb `Home` → `/fr`,
 ...
 * `/fr/docs` and `alternates.languages` `fr` + `en` + `x-default` → EN canonical.
 */
...
export default function FrDocsPage() {
  return (
    <>
      <DocsView />
      <JsonLd
