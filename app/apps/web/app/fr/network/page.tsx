...
/**
 * `/fr/network` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/network/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/fr/network' })`, breadcrumb `Home` → `/fr`,
 ...
 * `/fr/network` and `alternates.languages` `fr` + `en` + `x-default` → EN canonical.
 */
...
export default function FrNetworkPage() {
  return (
    <>
