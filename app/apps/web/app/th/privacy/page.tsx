...
/**
 * `/th/privacy` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/privacy/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/th/privacy' })`, breadcrumb `Home` → `/th`,
 ...
 * `/th/privacy` and `alternates.languages` `th` + `en` + `x-default` → EN canonical.
 */
...
export default function ThPrivacyPage() {
  return (
    <>
      <PrivacyView />
      <JsonLd
