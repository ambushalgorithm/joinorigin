...
/**
 * `/th/network` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/network/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/th/network' })`, breadcrumb `Home` → `/th`,
 ...
 * `/th/network` and `alternates.languages` `th` + `en` + `x-default` → EN canonical.
 */
...
export default function ThNetworkPage() {
  return (
    <>
