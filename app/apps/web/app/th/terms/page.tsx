...
/**
 * `/th/terms` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/terms/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/th/terms' })`, breadcrumb `Home` → `/th`,
 ...
 * `/th/terms` and `alternates.languages` `th` + `en` + `x-default` → EN canonical.
 */
...
export default function ThTermsPage() {
  return (
    <>
      <TermsView />
      <JsonLd
