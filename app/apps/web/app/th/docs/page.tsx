...
/**
 * `/th/docs` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/docs/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/th/docs' })`, breadcrumb `Home` → `/th`,
 ...
 * `/th/docs` and `alternates.languages` `th` + `en` + `x-default` → EN canonical.
 */
...
export default function ThDocsPage() {
  return (
    <>
      <DocsView />
      <JsonLd
