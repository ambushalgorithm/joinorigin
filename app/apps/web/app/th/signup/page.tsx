...
/**
 * `/th/signup` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/signup/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/th/signup' })`, breadcrumb `Home` → `/th`,
 ...
 * `/th/signup` and `alternates.languages` `th` + `en` + `x-default` → EN canonical.
 */
...
export default function ThSignupPage() {
  return (
    <>
      <SignupView />
      <JsonLd
