...
/**
 * `/vi/terms` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/terms/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/vi/terms' })`, breadcrumb `Home` → `/vi`,
 ...
 * `/vi/terms` and `alternates.languages` `vi` + `en` + `x-default` → EN canonical.
 */
