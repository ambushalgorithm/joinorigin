...
/**
 * `/vi/privacy` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/privacy/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/vi/privacy' })`, breadcrumb `Home` → `/vi`,
 ...
 * `/vi/privacy` and `alternates.languages` `vi` + `en` + `x-default` → EN canonical.
 */
