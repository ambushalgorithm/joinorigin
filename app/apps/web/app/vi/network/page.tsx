...
/**
 * `/vi/network` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/network/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/vi/network' })`, breadcrumb `Home` → `/vi`,
 ...
 * `/vi/network` and `alternates.languages` `vi` + `en` + `x-default` → EN canonical.
 */
...
export default function ViNetworkPage() {
  return (
    <>
