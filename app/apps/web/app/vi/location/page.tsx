 ...
 * while canonical + hreflang localize to `/vi/location` with
...
export const metadata: Metadata = (() => {
  ...
  return localizeMetadata(locationMetadata(entry), 'vi', entry.path);
})();
...
export default async function ViLocationHubPage() {
  ...
  const data = buildLocationViewData(entry, 'vi', await getServerCountry());
