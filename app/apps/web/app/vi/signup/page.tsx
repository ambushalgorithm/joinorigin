...
/**
 * `/vi/signup` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/signup/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/vi/signup' })`, breadcrumb `Home` → `/vi`,
 ...
 * `/vi/signup` and `alternates.languages` `vi` + `en` + `x-default` → EN canonical.
 */
...
export default function ViSignupPage() {
  return (
    <>
      <SignupView />
      <JsonLd
