...
/**
 * `/zh-CN/about` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/about/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/zh-CN/about' })`, breadcrumb `Home` → `/zh-CN`,
 ...
 * `/zh-CN/about` and `alternates.languages` `zh-CN` + `en` + `x-default` → EN canonical.
 */
...
export default function ZhCNAboutPage() {
  return (
    <>
      <AboutView />
