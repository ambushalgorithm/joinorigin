...
/**
 * `/zh-CN/terms` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/terms/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/zh-CN/terms' })`, breadcrumb `Home` → `/zh-CN`,
 ...
 * `/zh-CN/terms` and `alternates.languages` `zh-CN` + `en` + `x-default` → EN canonical.
 */
...
export default function ZhCNTermsPage() {
  return (
    <>
      <TermsView />
      <JsonLd
