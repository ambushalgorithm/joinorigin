...
/**
 * `/zh-CN/signup` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/signup/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/zh-CN/signup' })`, breadcrumb `Home` → `/zh-CN`,
 ...
 * `/zh-CN/signup` and `alternates.languages` `zh-CN` + `en` + `x-default` → EN canonical.
 */
...
export default function ZhCNSignupPage() {
  return (
    <>
      <SignupView />
      <JsonLd
