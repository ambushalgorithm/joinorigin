...
/**
 * `/ja/privacy` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/privacy/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/ja/privacy' })`, breadcrumb `Home` → `/ja`,
 ...
 * `/ja/privacy` and `alternates.languages` `ja` + `en` + `x-default` → EN canonical.
 */
