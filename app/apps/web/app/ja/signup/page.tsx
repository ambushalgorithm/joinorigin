...
/**
 * `/ja/signup` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/signup/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/ja/signup' })`, breadcrumb `Home` → `/ja`,
 ...
 * `/ja/signup` and `alternates.languages` `ja` + `en` + `x-default` → EN canonical.
 */
