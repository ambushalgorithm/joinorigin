...
/**
 * `/ja/contact` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/contact/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/ja/contact' })`, breadcrumb `Home` → `/ja`,
 ...
 * `/ja/contact` and `alternates.languages` `ja` + `en` + `x-default` → EN canonical.
 */
