...
/**
 * `/ja/about` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/about/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/ja/about' })`, breadcrumb `Home` → `/ja`,
 ...
 * `/ja/about` and `alternates.languages` `ja` + `en` + `x-default` → EN canonical.
 */
