...
/**
 * `/pl/privacy` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/privacy/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/pl/privacy' })`, breadcrumb `Home` → `/pl`,
 ...
 * `/pl/privacy` and `alternates.languages` `pl` + `en` + `x-default` → EN canonical.
 */
