...
/**
 * `/pl/about` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/about/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/pl/about' })`, breadcrumb `Home` → `/pl`,
 ...
 * `/pl/about` and `alternates.languages` `pl` + `en` + `x-default` → EN canonical.
 */
