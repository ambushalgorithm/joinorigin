...
/**
 * `/pl/terms` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/terms/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/pl/terms' })`, breadcrumb `Home` → `/pl`,
 ...
 * `/pl/terms` and `alternates.languages` `pl` + `en` + `x-default` → EN canonical.
 */
