...
/**
 * `/pl/network` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/network/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/pl/network' })`, breadcrumb `Home` → `/pl`,
 ...
 * `/pl/network` and `alternates.languages` `pl` + `en` + `x-default` → EN canonical.
 */
...
export default function PlNetworkPage() {
  return (
    <>
