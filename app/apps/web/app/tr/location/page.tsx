 ...
 * while canonical + hreflang localize to `/tr/location` with
...
export const metadata: Metadata = (() => {
  ...
  return localizeMetadata(locationMetadata(entry), 'tr', entry.path);
})();
...
export default async function TrLocationHubPage() {
  ...
  const data = buildLocationViewData(entry, 'tr', await getServerCountry());
