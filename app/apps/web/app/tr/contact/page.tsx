...
/**
 * `/tr/contact` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/contact/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/tr/contact' })`, breadcrumb `Home` → `/tr`,
 ...
 * `/tr/contact` and `alternates.languages` `tr` + `en` + `x-default` → EN canonical.
 */
