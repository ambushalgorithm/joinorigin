...
/**
 * `/tr/docs` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/docs/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/tr/docs' })`, breadcrumb `Home` → `/tr`,
 ...
 * `/tr/docs` and `alternates.languages` `tr` + `en` + `x-default` → EN canonical.
 */
