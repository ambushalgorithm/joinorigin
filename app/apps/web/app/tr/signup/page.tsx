...
/**
 * `/tr/signup` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/signup/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/tr/signup' })`, breadcrumb `Home` → `/tr`,
 ...
 * `/tr/signup` and `alternates.languages` `tr` + `en` + `x-default` → EN canonical.
 */
...
export default function TrSignupPage() {
  return (
    <>
      <SignupView />
      <JsonLd
