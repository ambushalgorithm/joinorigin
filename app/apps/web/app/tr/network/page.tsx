...
/**
 * `/tr/network` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/network/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/tr/network' })`, breadcrumb `Home` → `/tr`,
 ...
 * `/tr/network` and `alternates.languages` `tr` + `en` + `x-default` → EN canonical.
 */
...
export default function TrNetworkPage() {
  return (
    <>
