...
/**
 * `/it/network` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/network/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/it/network' })`, breadcrumb `Home` → `/it`,
 ...
 * `/it/network` and `alternates.languages` `it` + `en` + `x-default` → EN canonical.
 */
