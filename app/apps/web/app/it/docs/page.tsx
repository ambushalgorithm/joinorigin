...
/**
 * `/it/docs` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/docs/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/it/docs' })`, breadcrumb `Home` → `/it`,
 ...
 * `/it/docs` and `alternates.languages` `it` + `en` + `x-default` → EN canonical.
 */
