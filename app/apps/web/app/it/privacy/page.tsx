...
/**
 * `/it/privacy` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/privacy/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/it/privacy' })`, breadcrumb `Home` → `/it`,
 ...
 * `/it/privacy` and `alternates.languages` `it` + `en` + `x-default` → EN canonical.
 */
