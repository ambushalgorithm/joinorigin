...
/**
 * `/it/about` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/about/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/it/about' })`, breadcrumb `Home` → `/it`,
 ...
 * `/it/about` and `alternates.languages` `it` + `en` + `x-default` → EN canonical.
 */
