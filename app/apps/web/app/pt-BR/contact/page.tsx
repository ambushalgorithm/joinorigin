...
/**
 * `/pt-BR/contact` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/contact/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/pt-BR/contact' })`, breadcrumb `Home` → `/pt-BR`,
 ...
 * `/pt-BR/contact` and `alternates.languages` `pt-BR` + `en` + `x-default` → EN canonical.
 */
    ...
    <>
      ...
      <JsonLd
        data={breadcrumbList([
          ...
          { name: 'Contact', path: '/pt-BR/contact' },
        ])}
      />
    </>
  );
