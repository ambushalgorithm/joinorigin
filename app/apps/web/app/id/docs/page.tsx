...
/**
 * `/id/docs` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/docs/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/id/docs' })`, breadcrumb `Home` → `/id`,
 ...
 * `/id/docs` and `alternates.languages` `id` + `en` + `x-default` → EN canonical.
 */
...
export default function IdDocsPage() {
  return (
    <>
      <DocsView />
      <JsonLd
