...
/**
 * `/id/terms` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/terms/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/id/terms' })`, breadcrumb `Home` → `/id`,
 ...
 * `/id/terms` and `alternates.languages` `id` + `en` + `x-default` → EN canonical.
 */
