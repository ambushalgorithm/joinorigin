...
/**
 * `/id/signup` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/signup/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/id/signup' })`, breadcrumb `Home` → `/id`,
 ...
 * `/id/signup` and `alternates.languages` `id` + `en` + `x-default` → EN canonical.
 */
...
export default function IdSignupPage() {
  return (
    <>
      <SignupView />
      <JsonLd
