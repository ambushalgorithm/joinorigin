...
/**
 * `/zh-TW/terms` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/terms/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/zh-TW/terms' })`, breadcrumb `Home` → `/zh-TW`,
 ...
 * `/zh-TW/terms` and `alternates.languages` `zh-TW` + `en` + `x-default` → EN canonical.
 */
