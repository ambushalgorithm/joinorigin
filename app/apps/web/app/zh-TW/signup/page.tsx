...
/**
 * `/zh-TW/signup` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/signup/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/zh-TW/signup' })`, breadcrumb `Home` → `/zh-TW`,
 ...
 * `/zh-TW/signup` and `alternates.languages` `zh-TW` + `en` + `x-default` → EN canonical.
 */
...
export default function ZhTWSignupPage() {
  return (
    <>
      <SignupView />
      <JsonLd
