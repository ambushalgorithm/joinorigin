 ...
 * `/zh-TW/guides` with `x-default` → EN canonical
...
export default function ZhTWGuidesHubPage() {
  const entries = guidePageEntriesWithFallback('zh-TW');
  const faq = guideHubFaq('zh-TW');
  return (
    <>
