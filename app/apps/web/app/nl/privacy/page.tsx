...
/**
 * `/nl/privacy` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/privacy/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/nl/privacy' })`, breadcrumb `Home` → `/nl`,
 ...
 * `/nl/privacy` and `alternates.languages` `nl` + `en` + `x-default` → EN canonical.
 */
