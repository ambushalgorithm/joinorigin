...
/**
 * `/nl/network` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/network/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/nl/network' })`, breadcrumb `Home` → `/nl`,
 ...
 * `/nl/network` and `alternates.languages` `nl` + `en` + `x-default` → EN canonical.
 */
...
export default function NlNetworkPage() {
  return (
    <>
