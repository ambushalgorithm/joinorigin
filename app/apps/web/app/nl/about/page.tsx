...
/**
 * `/nl/about` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/about/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/nl/about' })`, breadcrumb `Home` → `/nl`,
 ...
 * `/nl/about` and `alternates.languages` `nl` + `en` + `x-default` → EN canonical.
 */
