...
/**
 * `/nl/signup` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/signup/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/nl/signup' })`, breadcrumb `Home` → `/nl`,
 ...
 * `/nl/signup` and `alternates.languages` `nl` + `en` + `x-default` → EN canonical.
 */
...
export default function NlSignupPage() {
  return (
    <>
      <SignupView />
      <JsonLd
