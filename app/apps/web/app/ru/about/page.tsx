...
/**
 * `/ru/about` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/about/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/ru/about' })`, breadcrumb `Home` → `/ru`,
 ...
 * `/ru/about` and `alternates.languages` `ru` + `en` + `x-default` → EN canonical.
 */
