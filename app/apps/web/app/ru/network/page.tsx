...
/**
 * `/ru/network` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/network/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/ru/network' })`, breadcrumb `Home` → `/ru`,
 ...
 * `/ru/network` and `alternates.languages` `ru` + `en` + `x-default` → EN canonical.
 */
...
export default function RuNetworkPage() {
  return (
    <>
