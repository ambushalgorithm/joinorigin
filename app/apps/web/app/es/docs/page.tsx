...
/**
 * `/es/docs` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/docs/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/es/docs' })`, breadcrumb `Home` → `/es`,
 ...
 * `/es/docs` and `alternates.languages` `es` + `en` + `x-default` → EN canonical.
 */
