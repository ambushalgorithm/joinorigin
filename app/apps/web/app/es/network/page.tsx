...
/**
 * `/es/network` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/network/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/es/network' })`, breadcrumb `Home` → `/es`,
 ...
 * `/es/network` and `alternates.languages` `es` + `en` + `x-default` → EN canonical.
 */
...
export default function EsNetworkPage() {
  return (
    <>
