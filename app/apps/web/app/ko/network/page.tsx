...
/**
 * `/ko/network` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/network/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/ko/network' })`, breadcrumb `Home` → `/ko`,
 ...
 * `/ko/network` and `alternates.languages` `ko` + `en` + `x-default` → EN canonical.
 */
...
export default function KoNetworkPage() {
  return (
    <>
