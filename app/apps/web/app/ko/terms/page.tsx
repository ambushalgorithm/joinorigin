...
/**
 * `/ko/terms` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/terms/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/ko/terms' })`, breadcrumb `Home` → `/ko`,
 ...
 * `/ko/terms` and `alternates.languages` `ko` + `en` + `x-default` → EN canonical.
 */
