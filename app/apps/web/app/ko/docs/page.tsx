...
/**
 * `/ko/docs` — generated locale wrapper (TASK-448).
 *
 * Mirrors the EN `app/docs/page.tsx`
 * wrapper with the locale-prefixed path: `createMetadata({ path:
 * '/ko/docs' })`, breadcrumb `Home` → `/ko`,
 ...
 * `/ko/docs` and `alternates.languages` `ko` + `en` + `x-default` → EN canonical.
 */
