...
import hybridCommunitiesGuideUk from '../content/uk/guide/hybrid-communities';
import keepCommunityActiveGuideUk from '../content/uk/guide/keep-a-community-active';
...
import startCommunityGuideUk from '../content/uk/guide/start-a-community';
