...
import hybridCommunitiesGuidePl from '../content/pl/guide/hybrid-origins';
import keepCommunityActiveGuidePl from '../content/pl/guide/keep-an-origin-active';
...
import startCommunityGuidePl from '../content/pl/guide/start-an-origin';
