...
import hybridCommunitiesGuideDe from '../content/de/guide/hybrid-origins';
import keepCommunityActiveGuideDe from '../content/de/guide/keep-an-origin-active';
...
import startCommunityGuideDe from '../content/de/guide/start-an-origin';
