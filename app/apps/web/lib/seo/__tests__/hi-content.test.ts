...
import hybridCommunitiesGuideHi from '../content/hi/guide/hybrid-communities';
import keepCommunityActiveGuideHi from '../content/hi/guide/keep-a-community-active';
...
import startCommunityGuideHi from '../content/hi/guide/start-a-community';
