...
import hybridCommunitiesGuideRu from '../content/ru/guide/hybrid-communities';
import keepCommunityActiveGuideRu from '../content/ru/guide/keep-a-community-active';
...
import startCommunityGuideRu from '../content/ru/guide/start-a-community';
