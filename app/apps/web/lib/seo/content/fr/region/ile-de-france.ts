...
const content: RegionContent = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Oui. JoinOrigin n’a pas de bureaux locaux. La page de la région Île-de-France est traduite en français, et la plateforme aide les gens à trouver ou créer des communautés partout dans la région.',
    },
  ],
};
