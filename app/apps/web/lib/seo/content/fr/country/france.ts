...
const content: CountryContent = {
  ...
  locale: 'fr',
  slug: 'france',
  title: 'Origins en France | JoinOrigin',
  description:
    'Trouvez ou créez des Origins en France — des scènes startup de Paris aux associations, cafés et réseaux de petites entreprises. Liste d’attente JoinOrigin.',
  intro:
  ...
  faq: [
    {
      question: 'Comment trouver des Origins en France ?',
      answer:
    ...
    },
    {
      ...
      answer:
        'Oui. JoinOrigin n’a pas de bureaux locaux. Les pages France et Paris sont traduites en français, et la plateforme aide les gens à trouver ou créer des Origins partout dans le pays.',
    },
  ],
};
