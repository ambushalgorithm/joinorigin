...
const content: CityContent = {
  ...
  faq: [
    {
      question: 'Comment trouver une communauté à Montréal ?',
      answer:
        'Commencez par les pages par type de groupe : communautés de startups, créatives, politiques, meetups et de petites entreprises. Chacune décrit les vrais quartiers, lieux et formats où les Montréalais se rassemblent. JoinOrigin est en ligne — créez votre profil et trouvez ou créez votre communauté dès aujourd’hui.',
    },
    {
      question: 'Est-il réaliste de créer une communauté à Montréal ?',
      answer:
        'Oui. La ville a des lieux publics gratuits, une chaleureuse culture de café et une scène de festivals mondialement connue. Les guides couvrent la création d’une communauté, l’organisation d’un meetup et l’obtention de vos dix premiers membres.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Non. JoinOrigin n’a ni bureaux locaux ni personnel local. Toutes les descriptions de communautés reflètent le paysage réel de la ville, et la plateforme aide les Montréalais à trouver ou créer des communautés.',
    },
  ],
};
