...
const content: GuideContent = {
  ...
  title:
    'Comment obtenir vos 10 premiers membres pour un Origin nouveau ou en croissance | JoinOrigin',
  description:
    'Obtenez vos 10 premiers membres sans gros budget — que vous lanciez un nouvel Origin ou redynamisiez un Origin existant, partez de votre réseau personnel, partagez des liens d’invitation et faites du salon l’endroit que les gens veulent rejoindre. Étapes pratiques de JoinOrigin.',
  intro: [
    'Les dix premiers membres sont les plus difficiles à obtenir et les plus importants, car ils définissent la culture d’une communauté avant qu’elle n’ait une réputation pour attirer des inconnus — et ils sont tout aussi précieux quand un Origin existant est à l’arrêt ou redémarre, car un noyau engagé est ce qui transforme un groupe silencieux en communauté vivante. Ce problème des dix premiers est fondamentalement un problème de mise en relation, et c’est le problème central que JoinOrigin résout.',
  ...
  dataPoints: [
    ...
    'JoinOrigin est un système d’exploitation communautaire conçu pour aider les personnes à trouver ou créer des Origins — il ne recrute pas de membres et n’organise pas d’événements.',
  ],
  faq: [
    {
    ...
    },
    {
      ...
      answer:
        'Oui. JoinOrigin aide les personnes à découvrir et à créer des Origins — un endroit où les personnes qui cherchent un groupe peuvent trouver le vôtre et rejoindre son salon via un lien. Les étapes de ce guide — invitations personnelles et un excellent premier rassemblement — sont les moyens les plus fiables de trouver vos premiers membres.',
    },
  ],
  sections: [
    'Listez cinquante personnes que vous connaissez déjà. Écrivez toute personne qui correspond à l’objectif de la communauté : amis, collègues, camarades de classe, anciens collègues, voisins et connaissances en ligne. Il vous faut environ cinq fois plus de noms que les dix que vous voulez. JoinOrigin donne à votre Origin un foyer visible et un salon que les gens peuvent trouver — mais les premiers noms viennent encore des personnes que vous connaissez. Listez cinquante noms et traitez chacun comme une présentation personnelle.',
  ...
  steps: [
    {
      ...
      joinOriginNote:
        'JoinOrigin donne à votre Origin un foyer visible et un salon que les gens peuvent trouver — mais les premiers noms viennent encore des personnes que vous connaissez. Listez cinquante noms et traitez chacun comme une présentation personnelle.',
    },
    {
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin garde l’adhésion et la communication de votre Origin dans un salon organisé plutôt que sur une feuille d’inscription. Un simple lien vers le salon rend le suivi possible.',
    },
    {
