...
/**
 * « Comment créer un Origin » — guide intemporel L1 (design §6.1,
 * TASK-326).
 *
...
const content: GuideContent = {
  ...
  title: 'Créer un Origin : guide pas à pas | JoinOrigin',
  description:
    'Apprenez à créer un Origin — ou à donner à un Origin existant un foyer numérique unique — publiez un groupe, ouvrez son salon et faites entrer les membres via un lien d’invitation. Étapes pratiques de JoinOrigin.',
  intro: [
    'La partie la plus difficile de la création d’un Origin est rarement le lieu, l’ordre du jour ou le budget — c’est trouver les premières personnes qui partagent votre intérêt et leur donner un endroit clair pour se connecter. C’est exactement le problème que JoinOrigin résout.',
  ...
  dataPoints: [
    ...
    'JoinOrigin est un système d’exploitation communautaire conçu pour aider les personnes à trouver ou créer des Origins — il n’organise pas d’événements locaux et ne revendique pas de personnel local.',
  ],
  faq: [
    {
      question: 'Combien de temps faut-il pour créer un Origin ?',
      answer:
    ...
    {
      question: 'Comment JoinOrigin peut-il m’aider à créer un Origin ?',
      answer:
  ...
  steps: [
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin aide votre Origin à rester découvrable et connecté à mesure qu’elle grandit — un seul endroit où le rythme, la promesse, le salon et les personnes sont visibles. Faites-vous découvrir et développez-vous.',
    },
  ],
};
