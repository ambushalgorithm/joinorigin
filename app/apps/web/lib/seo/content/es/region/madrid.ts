...
const content: RegionContent = {
  ...
  description:
    'Encuentra o crea Origins en la Comunidad de Madrid — desde las escenas de startups y creativas de la capital hasta los pueblos de la región. Lista de espera de JoinOrigin.',
  intro:
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Sí. JoinOrigin no tiene oficinas locales. La página de la región de Madrid está traducida al español, y la plataforma ayuda a la gente a encontrar o crear Origins en cualquier lugar de la región.',
    },
  ],
};
