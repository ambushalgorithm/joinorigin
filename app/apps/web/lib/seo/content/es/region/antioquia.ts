...
const content: RegionContent = {
  ...
  locale: 'es',
  slug: 'antioquia',
  title: 'Origins en Antioquia | JoinOrigin',
  description:
    'Encuentra o crea Origins en Antioquia — grupos de startups, creativos, políticos, encuentros y pequeñas empresas en todo el departamento. Únete a la lista de espera de JoinOrigin.',
  intro:
  ...
  faq: [
    ...
    {
      question: '¿Cuál es la mejor manera de empezar un Origin en Antioquia?',
      answer:
    ...
    },
    {
      ...
      answer:
        'Sí. JoinOrigin no tiene oficinas locales. Las páginas de Medellín están disponibles en español y el producto ayuda a las personas a encontrar o crear Origins en cualquier lugar de Antioquia.',
    },
  ],
};
