...
const content: RegionContent = {
  ...
  locale: 'es',
  slug: 'atlantico',
  title: 'Origins en Atlántico | JoinOrigin',
  description:
    'Encuentra o crea Origins en Atlántico — grupos de startups, creativos, políticos, encuentros y pequeñas empresas en la costa caribeña de Colombia. Únete a la lista de espera de JoinOrigin.',
  intro:
  ...
  faq: [
    ...
    {
      question: '¿Cuál es la mejor manera de empezar un Origin en Atlántico?',
      answer:
    ...
    },
    {
      ...
      answer:
        'Sí. JoinOrigin no tiene oficinas locales. Las páginas de Barranquilla están disponibles en español y el producto ayuda a las personas a encontrar o crear Origins en cualquier lugar del Atlántico.',
    },
  ],
};
