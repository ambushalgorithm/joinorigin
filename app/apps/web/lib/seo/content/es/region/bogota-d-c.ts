...
const content: RegionContent = {
  ...
  description:
    'Encuentra o crea Origins en Bogotá — grupos de startups, creativos, políticos, encuentros y pequeñas empresas en el distrito capital. Únete a la lista de espera de JoinOrigin.',
  intro:
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Sí. JoinOrigin no tiene oficinas locales. Las páginas de Bogotá están disponibles en español y el producto ayuda a las personas a encontrar o crear Origins en el distrito capital y en todo el país.',
    },
  ],
};
