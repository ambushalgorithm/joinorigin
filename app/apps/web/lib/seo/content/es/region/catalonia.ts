...
const content: RegionContent = {
  ...
  locale: 'es',
  slug: 'catalonia',
  title: 'Comunidades en Cataluña | JoinOrigin',
  description:
    'Encuentra o crea comunidades en Cataluña — desde las escenas de startups y creativas de Barcelona hasta los pueblos de la región. Lista de espera de JoinOrigin.',
  intro:
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Sí. JoinOrigin no tiene oficinas locales. La página de la región de Cataluña está traducida al español, y la plataforma ayuda a la gente a encontrar o crear comunidades en cualquier lugar de la región.',
    },
  ],
};
