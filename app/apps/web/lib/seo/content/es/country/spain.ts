...
const content: CountryContent = {
  ...
  locale: 'es',
  slug: 'spain',
  title: 'Origins en España | JoinOrigin',
  description:
    'Encuentra o crea Origins en España — desde escenas de startups en Madrid y Barcelona hasta asociaciones de vecinos y redes de pequeñas empresas. Lista de espera de JoinOrigin.',
  intro:
  ...
  faq: [
    {
      question: '¿Cómo encuentro Origins en España?',
      answer:
    ...
    {
      question: '¿Puedo crear un Origin en una ciudad española?',
      answer:
        'Sí. Las ciudades españolas tienen espacio público abundante — terrazas, plazas y parques — y una cultura social cálida que facilita las primeras reuniones. Las guías paso a paso cubren cómo crear un Origin desde la primera idea hasta un ritmo estable.',
    },
    {
      question: '¿JoinOrigin opera en España?',
      answer:
        'Sí. JoinOrigin no tiene oficinas locales. Las páginas de España y Madrid están traducidas al español, y la plataforma ayuda a la gente a encontrar o crear Origins en cualquier lugar del país.',
    },
  ],
};
