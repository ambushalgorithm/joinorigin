...
const content: CountryContent = {
  ...
  locale: 'es',
  slug: 'colombia',
  title: 'Origins en Colombia | JoinOrigin',
  description:
    'Encuentra o crea Origins en Colombia — desde grupos de startups en Bogotá hasta escenas de innovación en Medellín y redes de pequeñas empresas en todo el país. Únete a la lista de espera de JoinOrigin.',
  intro:
  ...
  faq: [
    {
      question: '¿Cómo encuentro Origins en Colombia?',
      answer:
    ...
    },
    {
      ...
      answer:
        'Sí. JoinOrigin no tiene oficinas locales. Las páginas de Bogotá, Medellín y Barranquilla están disponibles en español y el producto ayuda a las personas a encontrar o crear Origins en cualquier lugar de Colombia.',
    },
  ],
};
