...
const content: CountryContent = {
  ...
  locale: 'es',
  slug: 'peru',
  title: 'Origins en Perú | JoinOrigin',
  description:
    'Encuentra o crea Origins en Perú — desde grupos de startups en Lima hasta redes creativas y de pequeñas empresas en la costa, la sierra y la selva. Únete a la lista de espera de JoinOrigin.',
  intro:
  ...
  faq: [
    {
      question: '¿Cómo encuentro Origins en Perú?',
      answer:
    ...
    },
    {
      ...
      answer:
        'Sí. JoinOrigin no tiene oficinas locales. Las páginas de Lima están disponibles en español y el producto ayuda a las personas a encontrar o crear Origins en cualquier lugar del Perú.',
    },
  ],
};
