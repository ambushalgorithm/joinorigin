...
const content: GuideContent = {
  ...
  intro: [
    ...
    'JoinOrigin es un sistema operativo comunitario diseñado para ayudar a las personas a encontrar comunidades a las que unirse y a crear las suyas propias — de modo que un encuentro tiene un hogar donde los miembros interesados pueden descubrir el grupo, unirse a su sala y coordinar la reunión en lugar de depender de la lista de contactos de una sola persona. JoinOrigin no reserva lugares ni organiza eventos: el propósito completo de la plataforma es conectar a personas que comparten un interés, y la reunión en sí es tuya para dirigirla.',
  ...
  dataPoints: [
    ...
    'JoinOrigin es un sistema operativo comunitario diseñado para ayudar a las personas a encontrar o crear comunidades; no reserva lugares ni organiza eventos.',
  ],
  faq: [
    {
    ...
    },
    {
      ...
      answer:
        'Sí. JoinOrigin ayuda a las personas a encontrar y crear comunidades: un hogar digital organizado donde la sala de un grupo es el lugar donde los miembros se coordinan y donde un encuentro puede descubrirse. JoinOrigin no organiza eventos por sí mismo, por lo que los pasos prácticos de esta guía son tuyos para ejecutarlos.',
    },
  ],
  sections: [
  ...
  steps: [
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin es el lugar donde las personas que buscan una comunidad la encuentran y se unen mediante un enlace. Promociona en los grupos de nicho y boletines donde tu audiencia ya se reúne y comparte el enlace de unión con cada asistente.',
    },
    {
