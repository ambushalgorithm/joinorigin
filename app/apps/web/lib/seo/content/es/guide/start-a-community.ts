...
/**
 * «Cómo crear una comunidad» — guía L1 siempre vigente (diseño §6.1,
 * TASK-326).
 *
...
const content: GuideContent = {
  ...
  title: 'Cómo crear una comunidad: guía paso a paso | JoinOrigin',
  description:
    'Aprende a crear una comunidad — o a dar a una existente un único hogar digital — publica un grupo, abre su sala y trae a los miembros mediante un enlace de unión. Pasos prácticos de JoinOrigin.',
  intro: [
    'La parte más difícil de crear una comunidad rara vez es el lugar, la agenda o el presupuesto: es encontrar a las primeras personas que comparten tu interés y darles un lugar claro donde conectarse. Ese es exactamente el problema que resuelve JoinOrigin.',
  ...
  dataPoints: [
    ...
    'JoinOrigin es un sistema operativo comunitario diseñado para ayudar a las personas a encontrar o crear comunidades: no organiza eventos locales ni reclama personal local.',
  ],
  faq: [
    {
      question: '¿Cuánto se tarda en crear una comunidad?',
      answer:
    ...
    {
      question: '¿Cuál es el error más común al crear una comunidad?',
      answer:
    ...
    {
      question: '¿Cómo puede ayudarme JoinOrigin a crear una comunidad?',
      answer:
  ...
  sections: [
    ...
    'Invita personalmente a tus primeros diez miembros. Las invitaciones personales convierten mucho mejor que las publicaciones públicas. Escribe a amigos, colegas y conocidos que encajen con la audiencia, comparte el enlace de unión y pídeles que traigan a otra persona. JoinOrigin facilita el descubrimiento: un lugar donde las personas que buscan una comunidad pueden encontrar la tuya y unirse mediante un enlace. Las invitaciones personales siguen haciendo el trabajo pesado, y cada miembro que invitas se convierte en un canal hacia su propia red.',
    ...
    'Publica un ritmo constante y crece despacio. Mantén el mismo día y formato durante varios meses antes de expandirte. El crecimiento se acumula mediante referencias cuando cada miembro puede describir qué es la comunidad en una frase y compartir su enlace de unión. JoinOrigin ayuda a tu comunidad a seguir siendo localizable y conectada a medida que crece: un solo lugar donde el ritmo, la promesa, la sala y las personas son visibles. Date a conocer y crece.',
  ],
  steps: [
    {
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin facilita el descubrimiento: un lugar donde las personas que buscan una comunidad pueden encontrar la tuya y unirse mediante un enlace. Las invitaciones personales siguen haciendo el trabajo pesado, y cada miembro que invitas se convierte en un canal hacia su propia red.',
    },
    {
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin ayuda a tu comunidad a seguir siendo localizable y conectada a medida que crece: un solo lugar donde el ritmo, la promesa, la sala y las personas son visibles. Date a conocer y crece.',
    },
  ],
};
