...
const content: GuideContent = {
  ...
  title:
    'Cómo conseguir tus primeros 10 miembros para una comunidad nueva o en crecimiento | JoinOrigin',
  description:
    'Consigue tus primeros 10 miembros sin un gran presupuesto — ya sea que estés lanzando una comunidad nueva o revitalizando una existente — parte de tu red personal, comparte enlaces de invitación y haz que la sala sea el lugar al que las personas quieran unirse. Pasos prácticos de JoinOrigin.',
  intro: [
    ...
    'Esta guía divide el problema de los primeros diez miembros en pasos concretos — ya sea que estés comenzando una comunidad nueva o reactivando una existente: partir de las personas que ya conoces, publicar tu grupo para que tenga una sala a la que unirse, invitar personalmente con enlaces, realizar una primera reunión que convierta a los asistentes en promotores y construir un hábito simple de recomendación para que cada miembro traiga al siguiente — y cada paso muestra dónde ayuda JoinOrigin.',
  ],
  dataPoints: [
    ...
    'JoinOrigin es un sistema operativo comunitario diseñado para ayudar a las personas a encontrar o crear comunidades: no recluta miembros ni organiza eventos.',
  ],
  faq: [
    {
    ...
    },
    {
      ...
      answer:
        'Sí. JoinOrigin ayuda a las personas a descubrir y crear comunidades: un lugar donde las personas que buscan un grupo pueden encontrar el tuyo y unirse a su sala mediante un enlace. Los pasos de esta guía — invitaciones personales y una gran primera reunión — son las formas más fiables de encontrar tus primeros miembros.',
    },
  ],
  sections: [
    'Haz una lista de cincuenta personas que ya conoces. Anota a cualquiera que encaje con el propósito de la comunidad: amigos, colegas, compañeros de clase, excompañeros de trabajo, vecinos y conocidos en línea. Necesitas unas cinco veces más nombres que los diez que quieres. JoinOrigin da a tu comunidad un hogar visible y una sala que las personas pueden encontrar — pero los primeros nombres siguen viniendo de personas que conoces. Haz la lista de cincuenta y trata a cada uno como una presentación personal.',
    ...
    'Invita a todos los asistentes a la sala. Al final de la reunión, comparte el enlace de unión y agrega a cualquiera que quiera quedarse. La sala es donde la comunidad vive entre reuniones: un miembro que se unió a la sala es un miembro que probablemente volverá. JoinOrigin mantiene la membresía y la comunicación de tu comunidad en una sala organizada en lugar de en una hoja de registro. Un enlace simple hacia la sala hace posible el seguimiento.',
  ...
  steps: [
    {
      ...
      joinOriginNote:
        'JoinOrigin da a tu comunidad un hogar visible y una sala que las personas pueden encontrar — pero los primeros nombres siguen viniendo de personas que conoces. Haz la lista de cincuenta y trata a cada uno como una presentación personal.',
    },
    {
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin mantiene la membresía y la comunicación de tu comunidad en una sala organizada en lugar de en una hoja de registro. Un enlace simple hacia la sala hace posible el seguimiento.',
    },
    {
