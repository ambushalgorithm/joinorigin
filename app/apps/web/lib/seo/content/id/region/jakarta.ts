...
const content: RegionContent = {
  ...
  description:
    'Temukan atau mulai Origins di Jakarta — ekosistem startup, dunia kreatif di Kemang dan Senopati, serta jaringan profesional di Sudirman. Bergabunglah dengan JoinOrigin.',
  intro:
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Ya. JoinOrigin tidak memiliki kantor lokal. Platform ini membantu orang menemukan atau memulai Origins di mana pun di Jakarta, dan halaman Jakarta diterjemahkan ke bahasa Indonesia untuk melayani audiens lokal.',
    },
  ],
};
