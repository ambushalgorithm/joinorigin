 ...
 * bergabung dengan ruang grup, tempat Origin benar-benar hidup. Nilai
...
const content: GuideContent = {
  ...
  title: 'Cara Mendapatkan 10 Anggota Pertama untuk Origin Baru atau yang Berkembang | JoinOrigin',
  description:
    'Dapatkan 10 anggota pertama tanpa anggaran besar — baik Anda meluncurkan Origin baru maupun menghidupkan kembali yang sudah ada, mulailah dari jaringan pribadi Anda, bagikan tautan undangan, dan jadikan ruang sebagai tempat yang ingin diikuti orang. Langkah praktis dari JoinOrigin.',
  intro: [
    'Sepuluh anggota pertama adalah yang paling sulit didapatkan dan paling penting, karena mereka mendefinisikan budaya Origin sebelum Origin itu punya reputasi untuk menarik orang asing — dan mereka sama berharganya ketika Origin yang sudah ada sedang mandek atau memulai ulang, karena inti yang berkomitmenlah yang mengubah grup yang sepi menjadi grup yang hidup. Masalah sepuluh-pertama itu pada dasarnya adalah masalah menghubungkan orang, dan itu adalah masalah inti yang dipecahkan JoinOrigin.',
  ...
  sections: [
    ...
    'Buat mengundang orang lain semudah mungkin. Beri anggota satu kalimat yang bisa mereka ulangi dan satu tautan yang bisa mereka bagikan: "Ini meetup bulanan untuk pendiri baru berbagi pelajaran — gabung di sini." Deskripsi pendek yang jelas adalah alat rekrutmen paling efektif. JoinOrigin memungkinkan Origin dideskripsikan, ditemukan, dan diikuti dalam satu tempat — anggota bisa menunjuk orang ke ruang alih-alih menjelaskannya. Beri anggota satu kalimat dan satu tautan yang bisa mereka ulangi.',
  ],
  steps: [
    {
      title: 'Buat daftar lima puluh orang yang sudah Anda kenal',
      body: 'Tuliskan siapa pun yang sesuai dengan tujuan Origin: teman, kolega, teman sekelas, mantan rekan kerja, tetangga, dan kenalan daring. Anda butuh sekitar lima kali lebih banyak nama daripada sepuluh yang Anda inginkan.',
      joinOriginNote:
        'JoinOrigin memberi Origin Anda rumah yang terlihat dan ruang yang bisa ditemukan orang — tetapi nama pertama tetap berasal dari orang yang Anda kenal. Buat daftar lima puluh dan perlakukan setiap nama sebagai perkenalan personal.',
    },
    {
      title: 'Terbitkan grup Anda dan buka ruangnya',
      body: 'Origin yang tidak bisa Anda tunjukkan belum ada — dan Origin yang rumahnya tersebar di obrolan dan daftar hampir sama sulitnya untuk dikembangkan. Terbitkan grup dengan misi yang jelas, dan biarkan ruangnya dibuat otomatis sehingga ada tempat nyata untuk anggota mendarat.',
      joinOriginNote:
    ...
    },
    {
      ...
      body: 'Kirim pesan singkat yang menyebut nama Origin, tanggal pertama atau percakapan pertama, dan mengapa Anda pikir mereka akan menikmatinya — dan sertakan tautan bergabung. Pesan personal mengalahkan kiriman umum, dan tanggal spesifik mengalahkan janji yang samar.',
      joinOriginNote:
    ...
    },
    {
      ...
      body: 'Jadikan itu bagian normal dari permintaan: "Bawa teman yang mungkin menyukai ini." Undangan rujukan adalah cara jaringan kecil berlipat menjadi Origin sungguhan.',
      joinOriginNote:
        'JoinOrigin memberi anggota satu rumah yang bisa dibagikan untuk Origin — sehingga percakapan rujukan mengarah ke tautan nyata dan ruang nyata. Jadikan "bawa teman" bagian dari permintaan, dan beri mereka tautan untuk dibagikan.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin tidak menjalankan acara — pengalaman itu milik Anda. Platform membantu Origin terbentuk di sekitarnya: satu ruang yang bisa ditunjuk anggota setelahnya untuk menjaga koneksi tetap berlanjut.',
    },
    {
      title: 'Undang setiap peserta ke dalam ruang',
      body: 'Di akhir pertemuan, bagikan tautan bergabung dan tambahkan siapa pun yang ingin tetap terhubung. Ruang adalah tempat Origin hidup di antara pertemuan — anggota yang bergabung dengan ruang adalah anggota yang cenderung kembali.',
      joinOriginNote:
        'JoinOrigin menjaga keanggotaan dan komunikasi Origin Anda dalam satu ruang terorganisir alih-alih lembar pendaftaran. Tautan sederhana ke ruang memungkinkan tindak lanjut.',
    },
    {
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin memungkinkan Origin dideskripsikan, ditemukan, dan diikuti dalam satu tempat — anggota bisa menunjuk orang ke ruang alih-alih menjelaskannya. Beri anggota satu kalimat dan satu tautan yang bisa mereka ulangi.',
    },
  ],
};
