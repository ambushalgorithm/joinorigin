...
const content: GuideContent = {
  ...
  description:
    'Temukan co-founder yang melengkapi keterampilan Anda — baik Anda meluncurkan usaha baru maupun mengembangkan usaha yang sudah berjalan, terbitkan halaman ide, temui orang di Origins dan ruangnya, jalankan proyek uji coba, dan ajukan pertanyaan yang mencegah perpecahan. Dari JoinOrigin.',
  intro: [
    'Menemukan co-founder adalah keputusan hubungan yang menyamar sebagai keputusan perekrutan, dan pada intinya ini adalah masalah menghubungkan orang yang lain: orang yang tepat sering kali berjarak satu perkenalan hangat, di suatu tempat di Origin yang belum Anda temukan. Itulah masalah yang dibantu JoinOrigin — dan masalahnya sama baik Anda masih di tahap ide maupun menjalankan perusahaan yang sudah ada yang membutuhkan mitra untuk melangkah ke tahap berikutnya.',
  ...
  faq: [
    {
      ...
      answer:
        'Kebanyakan pendiri bertemu melalui jaringan hangat — acara, Origins, ruang, dan perkenalan dari orang yang mereka percaya. Menerbitkan ide yang bisa ditemukan orang, lalu hadir secara konsisten di Origins dan ruang yang sama, adalah cara paling andal untuk bertemu calon co-founder.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'JoinOrigin membantu orang menemukan Origins dan kolaborator — termasuk jenis Origins tempat para pendiri bertemu — dengan halaman ide dan ruang tempat percakapan bisa terjadi. JoinOrigin tidak mempertemukan pendiri, jadi langkah jaringan dan proyek uji coba dalam panduan ini adalah jalur Anda yang paling andal.',
    },
  ],
  sections: [
    'Petakan dulu kesenjangan keterampilan Anda. Tuliskan apa yang benar-benar Anda kuasai dan apa yang dibutuhkan usaha yang tidak Anda miliki. Co-founder harus menutup kesenjangan terbesar Anda — teknis, komersial, atau operasional — bukan menggandakan kekuatan Anda. JoinOrigin dibangun di sekitar profil, ide, dan Origins, bukan pencocokan — jadi nasihat jujurnya tetap sama: ketahui kesenjangan apa yang perlu Anda tutup sebelum mencari. Tuliskan kekuatan Anda dan kebutuhan usaha Anda.',
    ...
    'Garap jaringan yang ada untuk perkenalan hangat. Beri tahu lima orang yang Anda percaya apa yang Anda bangun dan jenis co-founder yang Anda butuhkan. Minta masing-masing satu nama. Perkenalan hangat mengalahkan penjangkauan dingin di hampir semua kasus. JoinOrigin membuat Origins mudah ditemukan, yang memperluas jaringan hangat Anda seiring waktu — dan setiap perkenalan dapat mengarah ke ruang tempat percakapan sesungguhnya terjadi. Beri tahu lima orang yang Anda percaya persis jenis co-founder yang Anda butuhkan.',
    'Hadir secara konsisten di Origins dan ruang yang relevan. Hadiri acara dan bergabunglah dengan grup tempat orang yang tepat berkumpul: meetup pendiri, komunitas industri, coworking space, dan ruang daring. Pengulangan membangun kepercayaan yang mengarah pada perkenalan. JoinOrigin membantu orang menemukan Origins yang sesuai dengan tujuan mereka — jenis tempat para pendiri bertemu — dan bergabung dengan ruangnya. Pilih meetup dan ruang tempat orang yang tepat sudah berkumpul dan terus hadir.',
    'Lakukan percakapan pertama yang terstruktur. Tanyakan tentang keterampilan mereka, toleransi risiko, komitmen waktu, dan mengapa mereka ingin memulai atau mengembangkan sesuatu. Bagikan jawaban Anda sendiri. Ini adalah wawancara timbal balik, bukan pitch. JoinOrigin tidak mempertemukan pendiri atau menjalankan percakapan — wawancara timbal balik adalah milik Anda. Platform menempatkan Anda di Origins dan ruang yang sama dengan calon kolaborator — sisanya terserah Anda.',
    'Jalankan proyek uji coba bersama. Pilih sesuatu yang kecil dan nyata — prototipe, halaman arahan, atau pilot berbayar — dan kerjakan selama empat hingga enam minggu. Perhatikan bagaimana Anda membagi pekerjaan, menangani umpan balik, dan bersikap di bawah tekanan. JoinOrigin memberi Origins ruang bersama untuk pekerjaan dan proyek mereka — tempat alami bagi proyek uji coba untuk muncul. Prototipe kecil yang nyata adalah uji yang paling andal.',
    'Putuskan berdasarkan uji coba, bukan potensi. Tanyakan apakah Anda akan mempercayakan reputasi Anda kepada orang ini, apakah mereka berkomunikasi dengan jujur, dan apakah bekerja bersama menggerakkan Anda. Jika uji coba terasa canggung, percayai sinyal itu. JoinOrigin tidak membuat keputusan untuk Anda. Nilai jujurnya adalah konteks Origin dan ruang yang memungkinkan Anda bertemu dan bekerja dengan kandidat — uji coba tetap memberi tahu Anda yang sebenarnya.',
  ...
  steps: [
    {
      ...
      joinOriginNote:
        'JoinOrigin dibangun di sekitar profil, ide, dan Origins, bukan pencocokan — jadi nasihat jujurnya tetap sama: ketahui kesenjangan apa yang perlu Anda tutup sebelum mencari. Tuliskan kekuatan Anda dan kebutuhan usaha Anda.',
    },
    {
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin membuat Origins mudah ditemukan, yang memperluas jaringan hangat Anda seiring waktu — dan setiap perkenalan dapat mengarah ke ruang tempat percakapan sesungguhnya terjadi. Beri tahu lima orang yang Anda percaya persis jenis co-founder yang Anda butuhkan.',
    },
    {
      title: 'Hadir secara konsisten di Origins dan ruang yang relevan',
      ...
      joinOriginNote:
        'JoinOrigin membantu orang menemukan Origins yang sesuai dengan tujuan mereka — jenis tempat para pendiri bertemu — dan bergabung dengan ruangnya. Pilih meetup dan ruang tempat orang yang tepat sudah berkumpul dan terus hadir.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin tidak mempertemukan pendiri atau menjalankan percakapan — wawancara timbal balik adalah milik Anda. Platform menempatkan Anda di Origins dan ruang yang sama dengan calon kolaborator — sisanya terserah Anda.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin memberi Origins ruang bersama untuk pekerjaan dan proyek mereka — tempat alami bagi proyek uji coba untuk muncul. Prototipe kecil yang nyata adalah uji yang paling andal.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin tidak membuat keputusan untuk Anda. Nilai jujurnya adalah konteks Origin dan ruang yang memungkinkan Anda bertemu dan bekerja dengan kandidat — uji coba tetap memberi tahu Anda yang sebenarnya.',
    },
    {
