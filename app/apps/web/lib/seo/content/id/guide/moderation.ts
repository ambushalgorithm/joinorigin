...
/**
 * "Moderasi Komunitas" — panduan L1 yang selalu relevan (desain §6.1,
 ...
 * komunitas pihak ketiga atau menyediakan staf moderasi. "Ruang" merujuk
...
const content: GuideContent = {
  ...
  locale: 'id',
  slug: 'moderation',
  title: 'Moderasi Komunitas: Cara Menjaga Grup Sehat & Ramah | JoinOrigin',
  description:
    'Moderasi komunitas dengan aturan yang jelas, tindakan dini, dan de-eskalasi — baik Anda menyiapkan grup baru maupun memperbaiki budaya grup yang mapan, kendali kreator adalah kepemilikan ruang Matrix, dengan peran yang diberlakukan di Element. Langkah praktis dari JoinOrigin.',
  intro: [
    'Setiap komunitas yang tumbuh pada akhirnya akan menghadapi momen yang menguji budayanya — perdebatan panas, spammer, anggota yang membuat orang lain tidak nyaman, atau kesalahpahaman yang membesar. Moderasi adalah praktik melindungi ruang agar komunitas tetap ramah, dan itu menjadi perlu justru karena komunitas terdiri dari orang-orang yang terhubung satu sama lain. Koneksi itulah masalah inti yang dibantu JoinOrigin — dan praktiknya berlaku sama baik untuk komunitas mapan yang memperbaiki budayanya maupun grup baru yang menetapkan ekspektasi sebelum anggota pertama datang.',
    ...
    'Panduan ini menyusun sistem moderasi praktis — baik komunitas Anda benar-benar baru maupun memiliki sejarah bertahun-tahun yang perlu dibersihkan: aturan komunitas tertulis yang singkat dan spesifik, jalur penegakan yang jelas dengan peringatan sebelum penghapusan, teknik de-eskalasi situasi tegang, dan nasihat jujur tentang kapan melibatkan anggota dan kapan bertindak sendiri. Setiap langkah menunjukkan tempat JoinOrigin membantu.',
  ],
  dataPoints: [
    'Aturan komunitas tertulis yang jelas mengurangi konflik dengan menetapkan ekspektasi sebelum insiden terjadi.',
  ...
  faq: [
    {
      question: 'Apakah komunitas kecil benar-benar butuh aturan moderasi?',
      answer:
        'Ya, dan semakin dini semakin baik. Dua atau tiga aturan singkat yang ditulis sebelum konflik terjadi jauh lebih mudah diterapkan daripada aturan yang diciptakan setelah konflik. Komunitas kecil punya lebih sedikit insiden, tetapi insiden yang terjadi sama menyakitkannya.',
    },
    {
    ...
    {
      question: 'Kapan saya harus menghapus seseorang dari komunitas?',
      answer:
    ...
    {
      question: 'Bisakah JoinOrigin membantu saya memoderasi komunitas?',
      answer:
  ...
  sections: [
    'Tulis tiga hingga lima aturan yang jelas. Jaga aturan tetap singkat, spesifik, dan positif: "Bersikap hormat", "Tetap pada topik", "Tidak ada spam atau promosi diri", "Tidak setuju dengan ide, bukan dengan orang". Unggah di tempat setiap anggota baru akan melihatnya — idealnya disematkan di ruang. Di JoinOrigin aturan dan nilai komunitas terlihat di ruangnya sejak hari pertama — anggota baru melihatnya sebelum bergabung. Sematkan aturan singkat Anda di tempat setiap anggota baru akan melihatnya.',
    'Tetapkan nada sebagai pemilik ruang. Tunjukkan perilaku yang Anda inginkan — sambut pendatang baru, ucapkan terima kasih kepada kontributor, dan tangani masalah dengan tenang. Teladan kreator menetapkan dasar budaya komunitas. JoinOrigin tidak mengawasi komunitas — nada ditetapkan oleh kreator dan anggota. Platform membuat perilaku ramah terlihat; tunjukkan perilaku yang Anda inginkan di ruang.',
    ...
    'Bagikan beban dengan co-moderator. Rekrut satu atau dua anggota tepercaya dan sepakati aturan penegakan. Komunitas yang bergantung pada satu moderator menjadi rapuh dan bias. JoinOrigin tidak menyediakan staf moderasi — co-moderator adalah sesama anggota. Kreator menetapkan peran kepada co-moderator di Element — peran Matrix native, tanpa sistem khusus. Rekrut satu atau dua anggota tepercaya dan beri mereka peran yang jelas.',
  ],
  steps: [
    {
      ...
      joinOriginNote:
        'Di JoinOrigin aturan dan nilai komunitas terlihat di ruangnya sejak hari pertama — anggota baru melihatnya sebelum bergabung. Sematkan aturan singkat Anda di tempat setiap anggota baru akan melihatnya.',
    },
    {
      title: 'Tetapkan nada sebagai pemilik ruang',
      body: 'Tunjukkan perilaku yang Anda inginkan — sambut pendatang baru, ucapkan terima kasih kepada kontributor, dan tangani masalah dengan tenang. Teladan kreator menetapkan dasar budaya komunitas.',
      joinOriginNote:
        'JoinOrigin tidak mengawasi komunitas — nada ditetapkan oleh kreator dan anggota. Platform membuat perilaku ramah terlihat; tunjukkan perilaku yang Anda inginkan di ruang.',
    },
    {
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin menjaga interaksi komunitas tetap terorganisir dan tenang secara desain, tetapi de-eskalasi tetap kerajinan manusia. Perlambat percakapan dan pindahkan hal yang panas ke ruang privat.',
    },
    {
    ...
    },
    {
      ...
      body: 'Rekrut satu atau dua anggota tepercaya dan sepakati aturan penegakan. Komunitas yang bergantung pada satu moderator menjadi rapuh dan bias.',
      joinOriginNote:
