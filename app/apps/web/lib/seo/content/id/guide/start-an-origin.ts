...
/**
 * "Cara Memulai Origin" — panduan L1 yang selalu relevan (desain §6.1,
...
const content: GuideContent = {
  ...
  title: 'Cara Memulai Origin: Panduan Langkah demi Langkah | JoinOrigin',
  description:
    'Pelajari cara memulai Origin — atau memberi Origin yang sudah ada satu rumah digital — terbitkan grup, buka ruangnya, dan bawa anggota masuk melalui tautan bergabung. Langkah praktis dari JoinOrigin.',
  intro: [
    'Bagian tersulit dari memulai Origin jarang adalah venue, agenda, atau anggaran — yang sulit adalah menemukan orang pertama yang berbagi minat Anda dan memberi mereka satu tempat yang jelas untuk terhubung. Itulah persisnya masalah yang dipecahkan JoinOrigin.',
    'JoinOrigin adalah OS komunitas yang dibangun di sekitar lingkaran digital: Anda menerbitkan grup, ruangnya dibuat otomatis, dan anggota bergabung melalui tautan. Ruang adalah tempat Origin benar-benar hidup — ruang Matrix yang dikendalikan kreator tempat anggota berbicara, berbagi pembaruan, dan merencanakan bersama sejak hari pertama, alih-alih tersebar di spreadsheet, pesan yang bertebaran, dan formulir pendaftaran. Acara tatap muka ada hanya sebagai konsekuensi hilir: setelah grup terbentuk dan ruangnya hidup, anggota boleh memilih bertemu tatap muka — dan JoinOrigin tidak menjalankan acara lokal. Inti platform adalah menghubungkan orang yang sebaliknya tidak akan pernah bertemu, karena itulah setiap langkah dalam panduan ini bersesuaian dengan sesuatu yang dibantu JoinOrigin.',
    'Pendekatan ini berlaku untuk semua jenis Origin: lingkaran pendiri, klub buku, grup lari lokal, jaringan usaha kecil, atau Origin profesional daring — dan berlaku baik Anda mulai dari nol maupun meresmikan grup yang sudah bertemu informal. Prinsip intinya sederhana — orang bergabung karena janji yang jelas, dan mereka bertahan karena pengalamannya secara andal memenuhi janji itu. Anda tidak butuh anggaran besar, venue, atau audiens yang sudah ada untuk memulai; Anda butuh tujuan yang jelas, langkah pertama yang realistis, dan disiplin untuk mengulanginya.',
  ],
  dataPoints: [
    'Kebanyakan Origin yang sukses dimulai dengan audiens yang sempit dan spesifik, bukan "semua orang yang tertarik".',
    ...
    'JoinOrigin adalah OS komunitas yang dirancang untuk membantu orang menemukan atau memulai Origins — tidak menjalankan acara lokal atau mengklaim staf lokal.',
  ],
  faq: [
    {
      question: 'Berapa lama untuk memulai Origin?',
      answer:
        'Anda bisa menerbitkan grup dan membuka ruangnya dalam beberapa minggu jika menjaga cakupannya kecil: satu tujuan, satu tautan bergabung, dan aliran undangan personal yang stabil. Origin itu sendiri butuh beberapa bulan partisipasi konsisten di ruang sebelum terasa mapan.',
    },
    {
      question: 'Apakah saya butuh uang atau venue untuk memulai?',
      answer:
        'Tidak. Inti digital Origin — grup yang diterbitkan dan ruangnya — tidak berbiaya dan tidak butuh venue. Banyak grup kemudian memilih bertemu tatap muka; perpustakaan, kedai kopi, taman, dan ruang coworking menyelenggarakan pertemuan pertama secara gratis di kebanyakan kota.',
    },
    {
      question: 'Apa kesalahan paling umum saat memulai Origin?',
      answer:
        'Mencoba melayani semua orang. Origin dengan tujuan yang samar menarik sedikit anggota berkomitmen. Tentukan satu audiens spesifik dan satu hasil yang jelas, tulis di halaman grup, dan biarkan Origin berkembang dari sana.',
    },
    {
      question: 'Bagaimana JoinOrigin bisa membantu saya memulai Origin?',
      answer:
        'Menerbitkan grup di JoinOrigin otomatis membuat ruangnya dan anggota bergabung melalui tautan — satu rumah digital terorganisir untuk tujuan, orang, dan percakapan Origin. JoinOrigin tidak menjalankan acara lokal, jadi langkah praktis dalam panduan ini berfungsi di platform dan dengan alat yang sudah Anda miliki.',
    },
  ],
  sections: [
    'Definisikan tujuan yang jelas. Putuskan untuk siapa Origin ini, masalah apa yang dipecahkannya, dan seperti apa anggota yang berhasil. Tulis misi satu kalimat seperti "grup untuk pendiri baru di Jakarta berbagi pelajaran tahap awal". JoinOrigin memberi tujuan Anda rumah — halaman grup publik tempat misi, audiens, dan janji terlihat oleh siapa pun yang mencari grup seperti Anda. Tulis misinya dan letakkan di depan setiap undangan.',
    'Terbitkan grup dan buka ruangnya. Inti digital Origin adalah grup yang diterbitkan dengan ruang tempat anggota bisa berbicara. Di JoinOrigin, menerbitkan grup otomatis membuat ruangnya — kreator memilikinya sejak detik nol dan dapat mengundang, menghapus, serta menetapkan peran di dalam Element. Di JoinOrigin tidak ada langkah "buat obrolannya nanti": terbitkan grup dan ruangnya langsung ada, dengan kreator sebagai pemilik ruang. Siapkan rumah grup dan ruangnya di alat yang sudah Anda gunakan jika Anda lebih suka.',
  ...
  steps: [
    ...
    },
    {
      ...
      body: 'Inti digital Origin adalah grup yang diterbitkan dengan ruang tempat anggota bisa berbicara. Di JoinOrigin, menerbitkan grup otomatis membuat ruangnya — kreator memilikinya sejak detik nol dan dapat mengundang, menghapus, serta menetapkan peran di dalam Element.',
      joinOriginNote:
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin mempermudah penemuan — tempat orang yang mencari Origin dapat menemukan Origin Anda dan bergabung melalui tautan. Undangan personal tetap menjadi penggerak utama, dan setiap anggota yang Anda undang menjadi saluran ke jaringan mereka sendiri.',
    },
    {
      title: 'Pilih format dan frekuensi (keputusan hilir)',
      body: 'Setelah grup terbentuk, pilih format berulang — diskusi bulanan, sesi kerja mingguan, pembicaraan, atau jalan santai sosial. Berulang mengalahkan sekali jalan karena kebiasaanlah yang mengubah orang asing menjadi anggota. Ini keputusan hilir: grup boleh berkumpul tatap muka nanti, tetapi ruang sudah menjadi rumah Origin.',
      joinOriginNote:
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin tidak menyediakan staf atau menjalankan pertemuan — pengalaman itu milik Anda untuk dirancang. Platform membantu Origin terbentuk di sekitarnya: satu ruang bersama tempat tanggal, ringkasan, dan langkah berikutnya hidup.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin menyimpan memori bersama Origin di satu tempat — catatan, keputusan, dan apa yang diminta anggota — sehingga iterasi terlihat alih-alih hilang. Tanyakan langsung kepada anggota di ruang setelah setiap pertemuan.',
    },
    {
      title: 'Terbitkan ritme yang konsisten dan tumbuh perlahan',
      body: 'Pertahankan hari dan format yang sama selama beberapa bulan sebelum memperluas. Pertumbuhan berlipat melalui rujukan ketika setiap anggota bisa menggambarkan apa itu Origin dalam satu kalimat dan membagikan tautan bergabungnya.',
      joinOriginNote:
        'JoinOrigin membantu Origin Anda tetap mudah ditemukan dan terhubung saat ia tumbuh — satu tempat di mana ritme, janji, ruang, dan orang-orangnya terlihat. Mulailah ditemukan dan bertumbuh.',
    },
  ],
};
