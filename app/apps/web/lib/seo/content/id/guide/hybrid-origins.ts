...
/**
 * "Origin Hibrida" — panduan L1 yang selalu relevan (desain §6.1,
 ...
 * Origin hibrida — satu Origin, satu ruang, dua titik masuk. Nilai
...
const content: GuideContent = {
  ...
  locale: 'id',
  slug: 'hybrid-origins',
  title: 'Origin Hibrida: Cara Menjalankan Tatap Muka + Daring Bersama | JoinOrigin',
  description:
    'Jalankan Origin hibrida tempat ruang menghubungkan anggota tatap muka dan daring — baik Anda memulai dari nol maupun menjadikan Origin yang ada sebagai hibrida, pilih alat yang tepat, rancang partisipasi yang setara, dan jaga kedua audiens tetap terlibat. Dari JoinOrigin.',
  intro: [
    'Origin hibrida menyatukan orang di dua tempat sekaligus — secara fisik di venue dan secara virtual melalui layar — dan tantangan sesungguhnya lagi-lagi tentang orang: memastikan kedua audiens merasa menjadi bagian dari satu Origin yang terhubung, bukan dua Origin terpisah. JoinOrigin dibangun dengan tepat untuk tujuan menghubungkan orang itu, dan modelnya berlaku sama baik untuk Origin yang sudah ada maupun yang baru dimulai — grup tatap muka yang mapan dapat menambahkan separuh daring, dan Origin daring dapat mulai berkumpul secara lokal.',
    ...
    'Panduan ini mencakup keputusan praktis yang membuat Origin hibrida berhasil — untuk grup baru dan yang sudah ada: memutuskan apakah hibrida adalah model yang tepat, membangun ruang yang dibagikan kedua audiens, memilih format dan alat yang sesuai, merancang pertemuan sehingga anggota tatap muka dan daring berbagi pengalaman yang sama, mengelola ruang agar tidak ada pihak yang mendominasi, dan menjaga ruang persisten yang menyatukan Origin di antara pertemuan. Setiap langkah menunjukkan tempat JoinOrigin membantu.',
  ],
  dataPoints: [
    'Origin hibrida adalah satu Origin dengan dua titik masuk, bukan dua audiens yang dilayani secara terpisah.',
  ...
  faq: [
    {
      question: 'Kapan Origin sebaiknya menjadi hibrida?',
      answer:
        'Ketika sebagian audiens Anda secara andal tidak bisa hadir tatap muka — karena jarak, jadwal, atau mobilitas — dan Origin tetap ingin memiliki satu identitas bersama. Jika semua orang bisa bertemu secara lokal, bertemu tatap muka lebih sederhana dan sering kali lebih baik.',
    },
    {
      question: 'Apa pengaturan alat minimum untuk pertemuan hibrida?',
      answer:
        'Satu tautan panggilan video untuk anggota jarak jauh, satu dokumen bersama untuk catatan, dan satu ruang tempat kedua audiens tetap terhubung di antara pertemuan. Lebih banyak alat berarti lebih banyak titik kegagalan; mulai minimal dan tambahkan hanya yang diminta Origin.',
    },
    {
    ...
    {
      question: 'Bisakah JoinOrigin membantu saya menjalankan Origin hibrida?',
      answer:
        'Ya. JoinOrigin membantu orang menemukan dan memulai Origins — satu ruang tempat anggota lokal dan jarak jauh tetap terhubung. JoinOrigin tidak menyediakan alat acara, jadi praktik hibrida praktis dalam panduan ini bekerja dengan alat yang sudah Anda miliki.',
    },
  ],
  sections: [
    'Putuskan apakah hibrida adalah model yang tepat. Pilih hibrida ketika masuk akal untuk bertemu tatap muka. Jika sebagian besar anggota bisa bertemu secara lokal, bertemu tatap muka membuat ikatan lebih kuat — hibrida memungkinkan kepercayaan terbentuk lebih cepat dan membaca orang lebih mendalam. JoinOrigin dirancang untuk membantu Origin mana pun menemukan dan mempertahankan anggota, tetapi keputusan format adalah milik Anda. Pilih hibrida hanya ketika masuk akal untuk bertemu tatap muka.',
    'Bangun ruang yang menghubungkan kedua audiens. Sebelum yang lainnya, pastikan Origin punya ruang bersama tempat anggota jarak jauh dan lokal berbicara, berbagi pembaruan, dan melihat langkah berikutnya yang sama. Ruang itulah yang membuat hibrida terasa seperti satu Origin, bukan dua. Di JoinOrigin setiap grup punya ruang sejak diterbitkan — permukaan persisten yang menyatukan bagian daring dan tatap muka. Siapkan satu ruang bersama yang bisa diikuti kedua audiens.',
    ...
    'Rancang agenda untuk dua audiens. Jalankan ronde perkenalan yang menyertakan anggota jarak jauh dengan nama, jaga visual di layar bersama, dan beri ruang bagi pihak daring untuk berbicara. Agenda hibrida menyebut kedua audiens secara eksplisit. Di JoinOrigin kedua audiens berbagi satu ruang Origin, yang membuat "merancang untuk dua audiens" menjadi cocok secara alami. Sebut kedua audiens secara eksplisit dalam agenda.',
    'Tugaskan orang penghubung. Satu orang memantau sisi jarak jauh: menyapa yang terlambat, memanggil tangan daring, dan meneruskan apa yang terlewat di venue. Tanpa penghubung, audiens daring menjadi penonton. JoinOrigin tidak menyediakan staf acara — orang penghubung adalah peran manusia. Platform menjaga Origin tetap terorganisir dalam satu ruang sehingga penghubung punya satu tempat untuk melihat siapa yang bergabung dan apa yang dibagikan.',
    ...
    'Tangkap dan bagikan hasil di ruang. Unggah catatan, rekaman, dan langkah berikutnya di ruang bersama setelah setiap pertemuan. Artefak yang terlihat menjaga kedua audiens tetap terhubung dan membuat Origin terasa produktif. Di JoinOrigin hasil Origin hidup dalam satu ruang terorganisir — catatan, rekaman, langkah berikutnya. Unggah semuanya di ruang bersama setelah setiap pertemuan.',
  ],
  steps: [
    {
      ...
      joinOriginNote:
        'JoinOrigin dirancang untuk membantu Origin mana pun menemukan dan mempertahankan anggota, tetapi keputusan format adalah milik Anda. Pilih hibrida hanya ketika masuk akal untuk bertemu tatap muka.',
    },
    {
      title: 'Bangun ruang yang menghubungkan kedua audiens',
      body: 'Sebelum yang lainnya, pastikan Origin punya ruang bersama tempat anggota jarak jauh dan lokal berbicara, berbagi pembaruan, dan melihat langkah berikutnya yang sama. Ruang itulah yang membuat hibrida terasa seperti satu Origin, bukan dua.',
      joinOriginNote:
    ...
    },
    {
      ...
      joinOriginNote:
        'Di JoinOrigin kedua audiens berbagi satu ruang Origin, yang membuat "merancang untuk dua audiens" menjadi cocok secara alami. Sebut kedua audiens secara eksplisit dalam agenda.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin tidak menyediakan staf acara — orang penghubung adalah peran manusia. Platform menjaga Origin tetap terorganisir dalam satu ruang sehingga penghubung punya satu tempat untuk melihat siapa yang bergabung dan apa yang dibagikan.',
    },
    {
    ...
    },
    {
      ...
      body: 'Origin hidup di ruang antara acara: anggota jarak jauh dan lokal berbagi pembaruan, bertanya, dan merencanakan bersama di sana. Hibrida bukan satu format acara — ini ruang bersama yang berkelanjutan.',
      joinOriginNote:
    ...
    },
    {
      ...
      body: 'Unggah catatan, rekaman, dan langkah berikutnya di ruang bersama setelah setiap pertemuan. Artefak yang terlihat menjaga kedua audiens tetap terhubung dan membuat Origin terasa produktif.',
      joinOriginNote:
        'Di JoinOrigin hasil Origin hidup dalam satu ruang terorganisir — catatan, rekaman, langkah berikutnya. Unggah semuanya di ruang bersama setelah setiap pertemuan.',
    },
  ],
};
