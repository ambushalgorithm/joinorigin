 ...
 * nhóm, nơi Origin thực sự sống. Giá trị JoinOrigin được đan vào phần mở
...
const content: GuideContent = {
  ...
  title: 'Cách Có 10 Thành viên Đầu tiên cho một Origin Mới hoặc Đang Phát triển | JoinOrigin',
  description:
    'Có 10 thành viên đầu tiên mà không cần ngân sách lớn — dù bạn đang khởi động một Origin mới hay tái tiếp năng lượng một Origin hiện hữu, bắt đầu từ mạng lưới cá nhân của bạn, chia sẻ các liên kết mời, và làm cho phòng trở thành nơi mọi người muốn tham gia. Các bước thực tế từ JoinOrigin.',
  intro: [
    'Mười thành viên đầu tiên khó có được nhất và quan trọng nhất, vì họ định nghĩa văn hóa của một Origin trước khi nó có bất kỳ danh tiếng nào để thu hút người lạ — và họ cũng quý giá không kém khi một Origin hiện hữu đang trì trệ hoặc khởi động lại, vì một lõi cam kết là thứ biến một nhóm im lặng thành một nhóm sống động. Vấn đề mười người đầu tiên đó về cơ bản là một vấn đề kết nối con người, và nó là vấn đề cốt lõi JoinOrigin giải quyết.',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Có. JoinOrigin giúp mọi người khám phá và bắt đầu Origins — một nơi những người đang tìm một nhóm có thể tìm thấy của bạn và tham gia phòng của nó qua một liên kết. Các bước trong hướng dẫn này — lời mời cá nhân và một buổi tụ họp đầu tiên tuyệt vời — là những cách đáng tin cậy nhất để tìm các thành viên đầu tiên của bạn.',
    },
  ],
  sections: [
    'Liệt kê năm mươi người bạn đã biết. Viết xuống bất kỳ ai phù hợp với mục đích của Origin: bạn bè, đồng nghiệp, bạn cùng lớp, đồng nghiệp cũ, hàng xóm, và người quen trực tuyến. Bạn cần khoảng gấp năm lần số tên so với mười người bạn muốn. JoinOrigin cho Origin của bạn một mái nhà hiện hữu và một phòng mọi người có thể tìm thấy — nhưng những cái tên đầu tiên vẫn đến từ những người bạn biết. Liệt kê năm mươi và coi mỗi người như một lời giới thiệu cá nhân.',
    'Công bố nhóm của bạn và mở phòng của nó. Một Origin bạn không thể trỏ đến chưa tồn tại — và một Origin có mái nhà phân tán qua các cuộc trò chuyện và danh sách gần như khó phát triển không kém. Công bố nhóm với một sứ mệnh rõ ràng, và để phòng của nó tự động tạo để có một nơi thực sự cho thành viên đặt chân đến. Công bố một nhóm trên JoinOrigin tự động tạo phòng của nó — phòng là bề mặt tham gia, và người sáng lập sở hữu nó từ đầu. Thiết lập nhóm và phòng của nó bằng những công cụ bạn đang dùng trước khi bạn mời bất kỳ ai nếu bạn thích.',
    'Mời cá nhân với một yêu cầu cụ thể và một liên kết. Gửi một tin nhắn ngắn nêu tên Origin, ngày đầu tiên hoặc cuộc trò chuyện đầu tiên, và vì sao bạn nghĩ họ sẽ thích — và kèm liên kết tham gia. Tin nhắn cá nhân thắng bài đăng chung chung, và một ngày cụ thể thắng một lời hứa mơ hồ. JoinOrigin xóa ma sát của việc tham gia khi mọi người tìm thấy bạn — một liên kết, một cú nhấp, vào phòng. Một tin nhắn cá nhân ngắn với một ngày cụ thể và một liên kết chuyển đổi tốt hơn bất kỳ bài đăng công khai nào.',
    'Nhờ mọi người được mời mang theo một người. Biến nó thành một phần bình thường của lời mời: "Mang một người bạn có thể thích điều này." Lời mời giới thiệu là cách các mạng lưới nhỏ nhân lên thành các Origins thực sự. JoinOrigin cho thành viên một mái nhà có thể chia sẻ duy nhất cho Origin — để các cuộc trò chuyện giới thiệu trỏ đến một liên kết thực và một phòng thực. Biến "mang một người bạn" thành một phần của lời mời, và cho họ liên kết để chia sẻ.',
    'Tổ chức một buổi tụ họp đầu tiên thực sự tốt. Dành năng lượng của bạn cho trải nghiệm, không phải số lượng: một lời chào ấm áp, một hình thức rõ ràng, và một thời gian kết thúc xác định. Những người thích buổi tụ họp đầu tiên sẽ mang mười người tiếp theo. JoinOrigin không vận hành sự kiện — trải nghiệm là của bạn. Nền tảng giúp Origin hình thành quanh nó: một phòng nơi thành viên có thể trỏ đến sau đó và duy trì kết nối.',
    'Mời mọi người tham dự vào phòng. Kết thúc buổi tụ họp, chia sẻ liên kết tham gia và thêm bất kỳ ai muốn ở lại. Phòng là nơi Origin sống giữa các buổi tụ họp — một thành viên đã tham gia phòng là một thành viên có khả năng quay lại. JoinOrigin giữ tư cách thành viên và giao tiếp của Origin bạn trong một phòng có tổ chức thay vì một bảng đăng ký. Một liên kết đơn giản vào phòng giữ cho việc theo dõi khả thi.',
    ...
    'Làm cho việc mời người khác cực kỳ dễ dàng. Cho thành viên một câu họ có thể lặp lại và một liên kết họ có thể chia sẻ: "Đây là buổi gặp gỡ hàng tháng cho các nhà sáng lập mới để chia sẻ bài học — tham gia tại đây." Một mô tả ngắn, rõ ràng là công cụ tuyển dụng hiệu quả nhất. JoinOrigin cho phép một Origin được mô tả, tìm thấy, và tham gia trong một nơi — thành viên có thể trỏ mọi người đến phòng thay vì giải thích nó. Cho thành viên một câu và một liên kết họ có thể lặp lại.',
  ],
  steps: [
    {
      title: 'Liệt kê năm mươi người bạn đã biết',
      body: 'Viết xuống bất kỳ ai phù hợp với mục đích của Origin: bạn bè, đồng nghiệp, bạn cùng lớp, đồng nghiệp cũ, hàng xóm, và người quen trực tuyến. Bạn cần khoảng gấp năm lần số tên so với mười người bạn muốn.',
      joinOriginNote:
        'JoinOrigin cho Origin của bạn một mái nhà hiện hữu và một phòng mọi người có thể tìm thấy — nhưng những cái tên đầu tiên vẫn đến từ những người bạn biết. Liệt kê năm mươi và coi mỗi người như một lời giới thiệu cá nhân.',
    },
    {
      title: 'Công bố nhóm của bạn và mở phòng của nó',
      body: 'Một Origin bạn không thể trỏ đến chưa tồn tại — và một Origin có mái nhà phân tán qua các cuộc trò chuyện và danh sách gần như khó phát triển không kém. Công bố nhóm với một sứ mệnh rõ ràng, và để phòng của nó tự động tạo để có một nơi thực sự cho thành viên đặt chân đến.',
      joinOriginNote:
    ...
    },
    {
      ...
      body: 'Gửi một tin nhắn ngắn nêu tên Origin, ngày đầu tiên hoặc cuộc trò chuyện đầu tiên, và vì sao bạn nghĩ họ sẽ thích — và kèm liên kết tham gia. Tin nhắn cá nhân thắng bài đăng chung chung, và một ngày cụ thể thắng một lời hứa mơ hồ.',
      joinOriginNote:
    ...
    },
    {
      ...
      body: 'Biến nó thành một phần bình thường của lời mời: "Mang một người bạn có thể thích điều này." Lời mời giới thiệu là cách các mạng lưới nhỏ nhân lên thành các Origins thực sự.',
      joinOriginNote:
        'JoinOrigin cho thành viên một mái nhà có thể chia sẻ duy nhất cho Origin — để các cuộc trò chuyện giới thiệu trỏ đến một liên kết thực và một phòng thực. Biến "mang một người bạn" thành một phần của lời mời, và cho họ liên kết để chia sẻ.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin không vận hành sự kiện — trải nghiệm là của bạn. Nền tảng giúp Origin hình thành quanh nó: một phòng nơi thành viên có thể trỏ đến sau đó và duy trì kết nối.',
    },
    {
      title: 'Mời mọi người tham dự vào phòng',
      body: 'Kết thúc buổi tụ họp, chia sẻ liên kết tham gia và thêm bất kỳ ai muốn ở lại. Phòng là nơi Origin sống giữa các buổi tụ họp — một thành viên đã tham gia phòng là một thành viên có khả năng quay lại.',
      joinOriginNote:
        'JoinOrigin giữ tư cách thành viên và giao tiếp của Origin bạn trong một phòng có tổ chức thay vì một bảng đăng ký. Một liên kết đơn giản vào phòng giữ cho việc theo dõi khả thi.',
    },
    {
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin cho phép một Origin được mô tả, tìm thấy, và tham gia trong một nơi — thành viên có thể trỏ mọi người đến phòng thay vì giải thích nó. Cho thành viên một câu và một liên kết họ có thể lặp lại.',
    },
  ],
};
