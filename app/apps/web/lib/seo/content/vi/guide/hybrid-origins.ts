...
/**
 * "Origin Kết hợp" — hướng dẫn cấp L1 dài hạn (design §6.1, TASK-326).
 *
 * Tái trọng tâm vào mô hình kết nối → tham gia → phòng kỹ thuật số: phòng là
 * thứ kết nối phần trực tuyến và (hệ quả phía sau) trực tiếp của một Origin
 * kết hợp — một Origin, một phòng, hai điểm vào. Giá trị JoinOrigin được
...
const content: GuideContent = {
  ...
  locale: 'vi',
  slug: 'hybrid-origins',
  title: 'Origin Kết hợp: Cách Vận hành Trực tiếp + Trực tuyến Cùng nhau | JoinOrigin',
  description:
    'Vận hành một Origin kết hợp nơi phòng kết nối thành viên trực tiếp và trực tuyến — dù bạn đang bắt đầu mới hay biến một Origin hiện hữu thành kết hợp, chọn đúng công cụ, thiết kế sự tham gia bình đẳng, và giữ cả hai đối tượng gắn kết. Từ JoinOrigin.',
  intro: [
    'Một Origin kết hợp đưa mọi người lại gần nhau ở hai nơi cùng một lúc — vật lý trong một địa điểm và ảo qua một màn hình — và thách thức thực sự lại nằm ở con người: đảm bảo cả hai đối tượng cảm thấy họ thuộc về một Origin kết nối duy nhất, không phải hai Origin tách biệt. JoinOrigin được xây dựng chính xác với mục tiêu kết nối con người đó, và mô hình hoạt động cho một Origin đã tồn tại cũng như cho một Origin mới bắt đầu — một nhóm trực tiếp đã thành lập có thể thêm một nửa trực tuyến, và một Origin trực tuyến có thể bắt đầu tụ họp địa phương.',
    ...
    'Hướng dẫn này bao phủ các quyết định thực tế làm cho Origins kết hợp thành công — cho nhóm mới và nhóm hiện hữu: quyết định liệu kết hợp có phải là mô hình đúng, xây dựng phòng mà cả hai đối tượng chia sẻ, chọn một hình thức và công cụ phù hợp, thiết kế buổi tụ họp để thành viên trực tiếp và trực tuyến chia sẻ cùng một trải nghiệm, quản lý không gian để không bên nào lấn át, và giữ một phòng bền vững giữ Origin lại với nhau giữa các buổi tụ họp. Mỗi bước cho thấy JoinOrigin giúp ở đâu.',
  ],
  dataPoints: [
    'Một Origin kết hợp là một Origin với hai điểm vào, không phải hai đối tượng cần phục vụ riêng biệt.',
  ...
  faq: [
    {
      question: 'Khi nào một Origin nên chuyển sang kết hợp?',
      answer:
        'Khi một phần đối tượng của bạn đáng tin cậy không thể tham dự trực tiếp — vì khoảng cách, lịch trình, hoặc khả năng di chuyển — và Origin vẫn muốn một danh tính chung duy nhất. Nếu mọi người có thể gặp mặt địa phương, gặp trực tiếp đơn giản hơn và thường tốt hơn.',
    },
    {
      question: 'Thiết lập công cụ tối thiểu cho một buổi tụ họp kết hợp là gì?',
      answer:
        'Một liên kết cuộc gọi video cho thành viên từ xa, một tài liệu chung cho ghi chú, và một phòng nơi cả hai đối tượng duy trì kết nối giữa các buổi tụ họp. Thêm công cụ là thêm điểm lỗi; bắt đầu tối giản và chỉ thêm điều Origin yêu cầu.',
    },
    {
    ...
    {
      question: 'JoinOrigin có thể giúp tôi vận hành một Origin kết hợp không?',
      answer:
        'Có. JoinOrigin giúp mọi người tìm và bắt đầu Origins — một phòng nơi thành viên địa phương và từ xa duy trì kết nối. JoinOrigin không cung cấp công cụ sự kiện, vì vậy các thực hành kết hợp thực tế trong hướng dẫn này hoạt động với những công cụ bạn đã có.',
    },
  ],
  sections: [
    'Quyết định liệu kết hợp có phải là mô hình đúng. Chuyển sang kết hợp khi nó hợp lý để gặp mặt trực tiếp. Nếu hầu hết thành viên có thể gặp mặt địa phương, gặp trực tiếp làm mối liên kết mạnh hơn — kết hợp cho phép niềm tin xây dựng nhanh hơn và đọc hiểu con người kỹ hơn. JoinOrigin được thiết kế để giúp bất kỳ Origin nào tìm và giữ thành viên, nhưng quyết định hình thức là của bạn. Chuyển sang kết hợp chỉ khi nó hợp lý để gặp mặt trực tiếp.',
    'Xây dựng phòng kết nối cả hai đối tượng. Trước bất cứ điều gì khác, đảm bảo Origin có một phòng chung nơi thành viên từ xa và địa phương trò chuyện, chia sẻ cập nhật, và thấy cùng các bước tiếp theo. Phòng là thứ làm cho kết hợp cảm thấy như một Origin thay vì hai. Trên JoinOrigin mọi nhóm có một phòng từ khi công bố — bề mặt bền vững giữ phần trực tuyến và trực tiếp lại với nhau. Thiết lập một phòng chung cả hai đối tượng có thể tham gia.',
    ...
    'Thiết kế chương trình cho hai đối tượng. Chạy một vòng giới thiệu bao gồm thành viên từ xa bằng tên, giữ hình ảnh trên một màn hình chung, và để không gian cho phía trực tuyến phát biểu. Một chương trình kết hợp nêu tên cả hai đối tượng một cách tường minh. Trên JoinOrigin cả hai đối tượng chia sẻ một phòng Origin, làm cho "thiết kế cho hai đối tượng" trở thành sự phù hợp tự nhiên. Nêu tên cả hai đối tượng một cách tường minh trong chương trình.',
    ...
    'Nắm bắt và chia sẻ kết quả trong phòng. Đăng ghi chú, bản ghi, và các bước tiếp theo trong phòng chung sau mỗi buổi tụ họp. Một hiện vật hiện hữu giữ cả hai đối tượng kết nối và làm Origin cảm thấy có năng suất. Trên JoinOrigin kết quả của một Origin sống trong một phòng có tổ chức — ghi chú, bản ghi, các bước tiếp theo. Đăng chúng trong phòng chung sau mỗi buổi tụ họp.',
  ],
  steps: [
    {
      ...
      joinOriginNote:
        'JoinOrigin được thiết kế để giúp bất kỳ Origin nào tìm và giữ thành viên, nhưng quyết định hình thức là của bạn. Chuyển sang kết hợp chỉ khi nó hợp lý để gặp mặt trực tiếp.',
    },
    {
      title: 'Xây dựng phòng kết nối cả hai đối tượng',
      body: 'Trước bất cứ điều gì khác, đảm bảo Origin có một phòng chung nơi thành viên từ xa và địa phương trò chuyện, chia sẻ cập nhật, và thấy cùng các bước tiếp theo. Phòng là thứ làm cho kết hợp cảm thấy như một Origin thay vì hai.',
      joinOriginNote:
    ...
    },
    {
      ...
      joinOriginNote:
        'Trên JoinOrigin cả hai đối tượng chia sẻ một phòng Origin, làm cho "thiết kế cho hai đối tượng" trở thành sự phù hợp tự nhiên. Nêu tên cả hai đối tượng một cách tường minh trong chương trình.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin không bố trí nhân sự sự kiện — người cầu nối là một vai trò con người. Nền tảng giữ Origin có tổ chức trong một phòng để cầu nối có một nơi thấy ai đã tham gia và điều gì đã được chia sẻ.',
    },
    {
    ...
    },
    {
      ...
      body: 'Origin sống trong phòng giữa các sự kiện: thành viên từ xa và địa phương chia sẻ cập nhật, đặt câu hỏi, và lên kế hoạch cùng nhau ở đó. Kết hợp không phải một định dạng sự kiện — nó là một không gian chung liên tục.',
      joinOriginNote:
    ...
    },
    {
      ...
      body: 'Đăng ghi chú, bản ghi, và các bước tiếp theo trong phòng chung sau mỗi buổi tụ họp. Một hiện vật hiện hữu giữ cả hai đối tượng kết nối và làm Origin cảm thấy có năng suất.',
      joinOriginNote:
        'Trên JoinOrigin kết quả của một Origin sống trong một phòng có tổ chức — ghi chú, bản ghi, các bước tiếp theo. Đăng chúng trong phòng chung sau mỗi buổi tụ họp.',
    },
  ],
};
