  ...
  faq: [
    {
      ...
      answer:
        'Hầu hết nhà sáng lập gặp nhau qua các mạng lưới ấm áp — sự kiện, Origins, phòng, và lời giới thiệu từ những người họ tin tưởng. Công bố một ý tưởng mọi người có thể tìm thấy, rồi xuất hiện nhất quán trong cùng các Origins và phòng của họ, là cách đáng tin cậy nhất để gặp các đồng sáng lập tiềm năng.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'JoinOrigin giúp mọi người tìm Origins và cộng tác viên — bao gồm loại Origins nơi các nhà sáng lập gặp nhau — với một trang ý tưởng và một phòng nơi các cuộc trò chuyện có thể diễn ra. JoinOrigin không ghép cặp nhà sáng lập, vì vậy các bước kết nối và dự án thử nghiệm trong hướng dẫn này là con đường đáng tin cậy nhất của bạn.',
    },
  ],
  sections: [
    'Lập bản đồ các khoảng trống kỹ năng trước. Viết xuống điều bạn thực sự giỏi và điều dự án kinh doanh cần mà bạn không có. Một đồng sáng lập nên lấp khoảng trống lớn nhất của bạn — kỹ thuật, thương mại, hoặc vận hành — không phải lặp lại điểm mạnh của bạn. JoinOrigin được xây dựng quanh hồ sơ, ý tưởng, và Origins, không phải mai mối — vì vậy lời khuyên trung thực vẫn như mọi khi: biết khoảng trống bạn cần lấp trước khi bạn tìm. Viết điểm mạnh của bạn và nhu cầu của dự án kinh doanh xuống.',
    ...
    'Dùng mạng lưới hiện hữu của bạn cho những lời giới thiệu ấm áp. Nói với năm người bạn tin tưởng điều bạn đang xây dựng và loại đồng sáng lập bạn cần. Nhờ mỗi người cho một cái tên. Lời giới thiệu ấm áp thắng tiếp cận lạnh trong hầu hết mọi trường hợp. JoinOrigin làm cho các Origins dễ tìm, mở rộng mạng lưới ấm áp của bạn theo thời gian — và mỗi lời giới thiệu có thể dẫn đến một phòng nơi cuộc trò chuyện thực sự diễn ra. Nói với năm người bạn tin tưởng chính xác loại đồng sáng lập bạn cần.',
    'Xuất hiện nhất quán trong các Origins và phòng liên quan. Tham dự sự kiện và tham gia các nhóm nơi đúng loại người tụ họp: buổi gặp gỡ nhà sáng lập, cộng đồng ngành, không gian làm việc chung, và các phòng trực tuyến. Sự lặp lại xây dựng niềm tin dẫn đến lời giới thiệu. JoinOrigin giúp mọi người tìm các Origins khớp với mục tiêu của họ — loại nơi các nhà sáng lập gặp nhau — và tham gia phòng của họ. Chọn các buổi gặp gỡ và phòng nơi đúng người đã tụ họp và tiếp tục xuất hiện.',
    'Có các cuộc trò chuyện đầu tiên có cấu trúc. Hỏi về kỹ năng, khả năng chấp nhận rủi ro, cam kết thời gian, và vì sao họ muốn bắt đầu hoặc phát triển điều gì đó. Chia sẻ câu trả lời của chính bạn. Đây là một cuộc phỏng vấn tương hỗ, không phải một lời chào hàng. JoinOrigin không ghép cặp nhà sáng lập hoặc vận hành các cuộc trò chuyện — cuộc phỏng vấn tương hỗ là của bạn. Nền tảng đặt bạn vào cùng các Origins và phòng với các cộng tác viên tiềm năng — phần còn lại tùy bạn.',
    'Chạy một dự án thử nghiệm cùng nhau. Chọn một điều nhỏ và thực tế — một nguyên mẫu, một trang đích, hoặc một dự án trả phí thử nghiệm — và làm việc trên nó từ bốn đến sáu tuần. Quan sát cách bạn phân chia công việc, xử lý phản hồi, và hành xử dưới áp lực. JoinOrigin mang lại cho Origins một phòng chung cho công việc và dự án của họ — một nơi tự nhiên để một dự án thử nghiệm xuất hiện. Một nguyên mẫu thực tế nhỏ là bài kiểm tra đáng tin cậy nhất.',
    'Quyết định dựa trên thử nghiệm, không phải tiềm năng. Hỏi liệu bạn có tin tưởng giao danh tiếng của mình cho người này, liệu họ giao tiếp trung thực, và liệu làm việc cùng nhau có tiếp thêm năng lượng cho bạn không. Nếu thử nghiệm cảm thấy căng thẳng, hãy tin tín hiệu đó. JoinOrigin không thay bạn quyết định. Giá trị trung thực của nó là bối cảnh Origin và phòng cho phép bạn gặp và làm việc với các ứng viên — thử nghiệm vẫn nói cho bạn sự thật.',
  ...
  steps: [
    {
      ...
      joinOriginNote:
        'JoinOrigin được xây dựng quanh hồ sơ, ý tưởng, và Origins, không phải mai mối — vì vậy lời khuyên trung thực vẫn như mọi khi: biết khoảng trống bạn cần lấp trước khi bạn tìm. Viết điểm mạnh của bạn và nhu cầu của dự án kinh doanh xuống.',
    },
    {
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin làm cho các Origins dễ tìm, mở rộng mạng lưới ấm áp của bạn theo thời gian — và mỗi lời giới thiệu có thể dẫn đến một phòng nơi cuộc trò chuyện thực sự diễn ra. Nói với năm người bạn tin tưởng chính xác loại đồng sáng lập bạn cần.',
    },
    {
      title: 'Xuất hiện nhất quán trong các Origins và phòng liên quan',
      ...
      joinOriginNote:
        'JoinOrigin giúp mọi người tìm các Origins khớp với mục tiêu của họ — loại nơi các nhà sáng lập gặp nhau — và tham gia phòng của họ. Chọn các buổi gặp gỡ và phòng nơi đúng người đã tụ họp và tiếp tục xuất hiện.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin không ghép cặp nhà sáng lập hoặc vận hành các cuộc trò chuyện — cuộc phỏng vấn tương hỗ là của bạn. Nền tảng đặt bạn vào cùng các Origins và phòng với các cộng tác viên tiềm năng — phần còn lại tùy bạn.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin mang lại cho Origins một phòng chung cho công việc và dự án của họ — một nơi tự nhiên để một dự án thử nghiệm xuất hiện. Một nguyên mẫu thực tế nhỏ là bài kiểm tra đáng tin cậy nhất.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin không thay bạn quyết định. Giá trị trung thực của nó là bối cảnh Origin và phòng cho phép bạn gặp và làm việc với các ứng viên — thử nghiệm vẫn nói cho bạn sự thật.',
    },
    {
