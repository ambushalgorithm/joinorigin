...
/**
 * "Điều hành Origin" — hướng dẫn cấp L1 dài hạn (design §6.1, TASK-326).
 *
 ...
 * JoinOrigin không điều hành Origins bên thứ ba hoặc cung cấp nhân sự điều
...
const content: GuideContent = {
  ...
  locale: 'vi',
  slug: 'moderation',
  title: 'Điều hành Origin: Cách Giữ các Nhóm Khỏe mạnh & Chào đón | JoinOrigin',
  description:
    'Điều hành một Origin với quy tắc rõ ràng, hành động sớm, và giảm leo thang — dù bạn đang thiết lập một nhóm hoàn toàn mới hay sửa văn hóa của một nhóm đã thành lập, quyền kiểm soát của người sáng lập là quyền sở hữu phòng Matrix, với vai trò được thực thi trong Element. Các bước thực tế từ JoinOrigin.',
  intro: [
    'Mọi Origin phát triển cuối cùng sẽ đối mặt với một khoảnh khắc thử thách văn hóa của nó — một cuộc tranh cãi gay gắt, một kẻ gửi rác, một thành viên làm người khác khó chịu, hoặc một hiểu lầm leo thang. Điều hành là thực hành bảo vệ không gian để Origin duy trì sự chào đón, và nó chỉ trở nên cần thiết vì cộng đồng được tạo nên từ con người kết nối với nhau. Sự kết nối đó là vấn đề cốt lõi JoinOrigin giúp giải quyết — và các thực hành áp dụng tốt cho một Origin đã thành lập đang sửa văn hóa của nó cũng như cho một nhóm mới đặt kỳ vọng trước khi thành viên đầu tiên đến.',
    ...
    'Hướng dẫn này trình bày một hệ thống điều hành thực tế — dù Origin của bạn hoàn toàn mới hay có nhiều năm lịch sử cần dọn dẹp: quy tắc Origin viết ra ngắn và cụ thể, một con đường thực thi rõ ràng với cảnh báo trước khi xóa, kỹ thuật giảm leo thang các tình huống căng thẳng, và lời khuyên trung thực về khi nào nên liên quan đến thành viên và khi nào hành động một mình. Mỗi bước cho thấy JoinOrigin giúp ở đâu.',
  ],
  dataPoints: [
    'Quy tắc Origin rõ ràng, viết ra giảm xung đột bằng cách đặt kỳ vọng trước khi sự cố xảy ra.',
  ...
  faq: [
    {
      question: 'Các Origins nhỏ có thực sự cần quy tắc điều hành không?',
      answer:
        'Có, và càng sớm càng tốt. Hai hoặc ba quy tắc ngắn viết trước khi xung đột xảy ra dễ áp dụng hơn nhiều so với quy tắc phát minh sau khi xung đột xảy ra. Các Origins nhỏ có ít sự cố hơn, nhưng những sự cố họ có cũng đau đớn không kém.',
    },
    {
    ...
    {
      question: 'Khi nào tôi nên xóa ai đó khỏi Origin?',
      answer:
    ...
    {
      question: 'JoinOrigin có thể giúp tôi điều hành Origin của mình không?',
      answer:
  ...
  sections: [
    'Viết ba đến năm quy tắc rõ ràng. Giữ chúng ngắn, cụ thể, và tích cực: "Tôn trọng", "Đúng chủ đề", "Không gửi rác hoặc tự quảng bá", "Bất đồng với ý tưởng, không phải con người". Đăng chúng nơi mọi thành viên mới sẽ thấy — lý tưởng là ghim trong phòng. Trên JoinOrigin quy tắc và giá trị của một Origin hiện hữu trong phòng của nó từ ngày đầu tiên — thành viên mới thấy chúng trước khi tham gia. Ghim các quy tắc ngắn của bạn nơi mọi thành viên mới sẽ thấy.',
    'Đặt tông nền với tư cách chủ phòng. Làm gương cho hành vi bạn muốn — chào đón người mới, cảm ơn người đóng góp, và xử lý vấn đề một cách bình tĩnh. Tấm gương của người sáng lập đặt nền tảng văn hóa cho Origin. JoinOrigin không can thiệp Origins — tông nền được đặt bởi người sáng lập và thành viên. Nền tảng làm cho hành vi chào đón hiện hữu; làm gương cho hành vi bạn muốn trong phòng.',
  ...
  steps: [
    {
      ...
      joinOriginNote:
        'Trên JoinOrigin quy tắc và giá trị của một Origin hiện hữu trong phòng của nó từ ngày đầu tiên — thành viên mới thấy chúng trước khi tham gia. Ghim các quy tắc ngắn của bạn nơi mọi thành viên mới sẽ thấy.',
    },
    {
      title: 'Đặt tông nền với tư cách chủ phòng',
      body: 'Làm gương cho hành vi bạn muốn — chào đón người mới, cảm ơn người đóng góp, và xử lý vấn đề một cách bình tĩnh. Tấm gương của người sáng lập đặt nền tảng văn hóa cho Origin.',
      joinOriginNote:
        'JoinOrigin không can thiệp Origins — tông nền được đặt bởi người sáng lập và thành viên. Nền tảng làm cho hành vi chào đón hiện hữu; làm gương cho hành vi bạn muốn trong phòng.',
    },
    {
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin giữ các tương tác Origin có tổ chức và bình tĩnh theo thiết kế, nhưng giảm leo thang vẫn là một nghề thủ công con người. Làm chậm cuộc trò chuyện lại và đưa sự nóng giận vào một phòng riêng.',
    },
    {
    ...
    },
    {
      ...
      body: 'Tuyển một hoặc hai thành viên đáng tin cậy và thống nhất các quy tắc thực thi. Một Origin phụ thuộc vào một người điều hành duy nhất trở nên mong manh và thiên vị.',
      joinOriginNote:
