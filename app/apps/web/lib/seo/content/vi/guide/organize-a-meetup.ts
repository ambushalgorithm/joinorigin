...
const content: GuideContent = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Có. JoinOrigin giúp mọi người tìm và bắt đầu Origins — một mái nhà kỹ thuật số có tổ chức nơi phòng của một nhóm là nơi thành viên điều phối và nơi một buổi gặp gỡ có thể được khám phá. JoinOrigin không tự tổ chức sự kiện, vì vậy các bước thực tế trong hướng dẫn này là của bạn để vận hành.',
    },
  ],
  sections: [
  ...
  steps: [
    ...
    },
    {
      ...
      joinOriginNote:
        'Trên JoinOrigin thành viên có thể thấy hình thức của một Origin trước khi tham gia — thu hút đúng người và đặt kỳ vọng. Chọn một hình thức đối tượng của bạn thực sự sẽ xuất hiện.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin làm cho nhịp của một Origin hiện hữu trong một nơi, để thành viên biết ngày tiếp theo mà không phải tìm kiếm. Bảo vệ khung giờ định kỳ của bạn như một cuộc hẹn.',
    },
    {
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin là nơi những người đang tìm một Origin tìm thấy nó và tham gia qua một liên kết. Quảng bá trong các nhóm ngách và bản tin nơi đối tượng của bạn đã tụ họp, và chia sẻ liên kết tham gia với mọi người tham dự.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin không bố trí nhân sự sự kiện — trải nghiệm là của bạn. Nền tảng giữ câu chuyện của Origin trong một phòng có tổ chức — lời hứa, nhịp, và con người. Kết thúc đúng giờ là tín hiệu tôn trọng mạnh nhất.',
    },
    {
      title: 'Theo dõi trong vòng 24 giờ trong phòng',
      body: 'Cảm ơn người tham dự, chia sẻ bất kỳ liên kết hoặc ghi chú nào, và mời phản hồi nơi cả nhóm có thể thấy. Việc theo dõi là thứ biến một sự kiện đơn lẻ thành một Origin định kỳ.',
      joinOriginNote:
        'JoinOrigin cho một Origin một phòng bền vững nơi tóm tắt, ngày tiếp theo, và phản hồi sống — biến một sự kiện đơn lẻ thành một Origin định kỳ. Được khám phá và giữ đà tiếp tục.',
    },
  ],
};
