...
const content: CountryContent = {
  ...
  locale: 'pl',
  slug: 'poland',
  title: 'Społeczności w Polsce | JoinOrigin',
  description:
    'Znajdź lub załóż społeczności w Polsce — od scen startupowych po sieci małych firm. Lista oczekujących JoinOrigin.',
  intro:
  ...
  faq: [
    {
      question: 'Jak znaleźć społeczności w Polsce?',
      answer:
        'Skorzystaj z centrum /location, wybierz miasto, a następnie przejrzyj strony typów grup — społeczności startupowe, kreatywne, polityczne, spotkaniowe i małych firm. Fundacje, centra kultury i lokalne platformy wydarzeń to również dobre punkty startowe dla grup offline.',
    },
    {
      question: 'Czym jest budżet obywatelski w polskich miastach?',
      answer:
        'Budżet obywatelski to realna instytucja w wielu polskich miastach: mieszkańcy zgłaszają i głosują na lokalne projekty — od placów zabaw po remonty parków. Udział w spotkaniu dzielnicy to jeden z najszybszych sposobów na poznanie zaangażowanych sąsiadów i założenie społeczności obywatelskiej.',
    },
    {
      question: 'Czy JoinOrigin działa w Polsce?',
      answer:
        'Tak. JoinOrigin nie ma lokalnych biur. Strony Warszawy są dostępne po polsku i po angielsku, a produkt pomaga ludziom znajdować lub zakładać społeczności w dowolnym miejscu w Polsce.',
    },
  ],
};
