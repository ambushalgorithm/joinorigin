...
const content: GuideContent = {
  ...
  description:
    'Znajdź współzałożyciela, który uzupełnia Twoje umiejętności — niezależnie od tego, czy rozpoczynasz, czy rozwijasz istniejące przedsięwzięcie, opublikuj stronę pomysłu, poznawaj ludzi w Origins i ich pokojach, poprowadź projekt próbny i zadaj pytania, które zapobiegają rozstaniom. Od JoinOrigin.',
  intro: [
  ...
  dataPoints: [
    ...
    'JoinOrigin to system operacyjny społeczności zaprojektowany, aby pomagać ludziom znajdować Origins i współpracowników; nie jest usługą kojarzenia par i nie ma lokalnych biur.',
  ],
  faq: [
    {
      question: 'Gdzie większość ludzi znajduje swojego współzałożyciela?',
      answer:
        'Większość założycieli poznaje się przez ciepłe sieci — wydarzenia, Origins, pokoje i polecenia od zaufanych osób. Opublikowanie pomysłu, który ludzie mogą znaleźć, a następnie konsekwentne pojawianie się w tych samych Origins i ich pokojach to najbardziej niezawodny sposób na poznanie potencjalnych współzałożycieli.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'JoinOrigin pomaga ludziom znajdować Origins i współpracowników — w tym rodzaje Origins, w których spotykają się założyciele — dzięki stronie pomysłu i pokojowi, w którym mogą toczyć się rozmowy. JoinOrigin nie dopasowuje założycieli, więc kroki dotyczące networkingu i projektu próbnego z tego poradnika to Twoja najbardziej niezawodna ścieżka.',
    },
  ],
  sections: [
  ...
  steps: [
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin czyni Origins znajdowalnymi, co z czasem rozszerza Twoją ciepłą sieć — a każde polecenie może prowadzić do pokoju, w którym odbywa się prawdziwa rozmowa. Powiedz pięciu zaufanym osobom dokładnie, jakiego rodzaju współzałożyciela potrzebujesz.',
    },
    {
      title: 'Pojawiaj się konsekwentnie w istotnych Origins i ich pokojach',
      ...
      joinOriginNote:
        'JoinOrigin pomaga ludziom znajdować Origins pasujące do ich celów — rodzaj miejsca, w którym spotykają się założyciele — i dołączać do ich pokoi. Wybierz spotkania i pokoje, w których już gromadzą się właściwi ludzie, i ciągle się tam pojawiaj.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin nie dopasowuje założycieli ani nie prowadzi rozmów — wzajemny wywiad należy do Ciebie. Platforma stawia Cię w tych samych Origins i pokojach co potencjalnych współpracowników — reszta zależy od Ciebie.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin daje Origins wspólny pokój dla ich pracy i projektów — co jest naturalnym miejscem, w którym może wyłonić się projekt próbny. Mały prawdziwy prototyp to najbardziej niezawodny test.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin nie podejmuje decyzji za Ciebie. Jego uczciwa wartość to kontekst Origin i pokoju, który pozwala Ci poznawać i pracować z kandydatami — to próba wciąż mówi Ci prawdę.',
    },
    {
