...
const content: GuideContent = {
  ...
  dataPoints: [
    ...
    'JoinOrigin to system operacyjny społeczności zaprojektowany, aby pomagać ludziom znajdować lub zakładać Origins; nie rezerwuje miejsc ani nie obsadza wydarzeń.',
  ],
  faq: [
    {
    ...
    },
    {
      ...
      answer:
        'Tak. JoinOrigin pomaga ludziom znajdować i zakładać Origins — jeden zorganizowany cyfrowy dom, w którym pokój grupy jest miejscem koordynacji i w którym spotkanie może zostać odkryte. JoinOrigin sam nie organizuje wydarzeń, więc praktyczne kroki z tego poradnika należą do Ciebie.',
    },
  ],
  sections: [
  ...
  steps: [
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin to miejsce, w którym ludzie szukający Origin znajdują je i dołączają przez link. Promuj w niszowych grupach i biuletynach, w których już gromadzi się Twoja grupa odbiorców, i udostępniaj link do dołączenia każdemu uczestnikowi.',
    },
    {
