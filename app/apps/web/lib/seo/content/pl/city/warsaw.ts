...
const content: CityContent = {
  ...
  slug: 'warsaw',
  pageTitles: {
    city: 'Społeczności w Warszawie | JoinOrigin',
    cityDescription:
      'Znajdź lub załóż społeczności w Warszawie — grupy startupowe, kreatywne, polityczne, spotkaniowe i małych firm w stolicy Polski. Lista oczekujących JoinOrigin.',
    variants: {
      startup: 'Społeczności startupowe w Warszawie | JoinOrigin',
      creative: 'Społeczności kreatywne w Warszawie | JoinOrigin',
      political: 'Społeczności polityczne i obywatelskie w Warszawie | JoinOrigin',
      meetup: 'Społeczności spotkaniowe w Warszawie | JoinOrigin',
      'small-business': 'Społeczności małych firm w Warszawie | JoinOrigin',
    },
    variantDescriptions: {
      startup:
        'Znajdź lub załóż społeczności startupowe w Warszawie — założyciele, inżynierowie i operatorzy wokół Woli, The Heart i sceny technologicznej. Lista oczekujących JoinOrigin.',
      creative:
        'Znajdź lub załóż społeczności kreatywne w Warszawie — studia, galerie i kolektywy wokół Pragi, Wisły i centrum miasta. Lista oczekujących JoinOrigin.',
      political:
        'Znajdź lub załóż społeczności polityczne i obywatelskie w Warszawie — rady dzielnic, budżet obywatelski i lokalne kampanie. Lista oczekujących JoinOrigin.',
      meetup:
        'Znajdź lub załóż społeczności spotkaniowe w Warszawie — wieczory nad Wisłą, bary mleczne i życie parków. Lista oczekujących JoinOrigin.',
      'small-business':
        'Znajdź lub załóż społeczności małych firm w Warszawie — handlowcy targowi, sprzedawcy w food hallach i sklepy osiedlowe. Lista oczekujących JoinOrigin.',
    },
    ideas: '30 pomysłów na wydarzenia społecznościowe w Warszawie | JoinOrigin',
    ideasDescription:
      'Odkryj 30 pomysłów na wydarzenia społecznościowe w Warszawie — wydarzenia networkingowe, edukacyjne, plenerowe, profesjonalne, kreatywne i prospołeczne. Lista oczekujących JoinOrigin.',
  },
  intro: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      {
        question: 'Czy te wydarzenia mogą stać się prawdziwymi społecznościami?',
        answer:
          'Tak — powtarzalne formaty to sposób, w jaki zaczyna się większość warszawskich społeczności, a obywatelska tradycja miasta daje Ci sprawdzony wzorzec. Poradniki krok po kroku prowadzą od pierwszego wydarzenia do stabilnej społeczności.',
      },
    ],
  },
  faq: [
    {
      question: 'Jak znaleźć społeczność w Warszawie?',
      answer:
        'Skorzystaj ze stron typów grup dla społeczności startupowych, kreatywnych, politycznych, spotkaniowych i małych firm. Każda opisuje prawdziwe dzielnice, miejsca i formaty, w których gromadzą się warszawiacy. JoinOrigin działa — utwórz swój profil i znajdź lub załóż swoją społeczność już dziś.',
    },
    {
      question: 'Czy założenie społeczności w Warszawie jest realistyczne?',
      answer:
        'Tak. Warszawa ma bulwary wiślane, hojne parki, silną kulturę kawiarnianą i poważną tradycję obywatelską. Poradniki obejmują zakładanie społeczności, organizowanie spotkań i zdobywanie pierwszych dziesięciu członków.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Nie. JoinOrigin nie ma lokalnych biur ani personelu. Wszystkie opisy społeczności odzwierciedlają prawdziwy krajobraz miasta, a platforma pomaga warszawiakom znajdować lub zakładać społeczności.',
    },
  ],
};
