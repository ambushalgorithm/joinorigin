...
const content: GuideContent = {
  ...
  title:
    'Como Conseguir Seus Primeiros 10 Membros para um Origin Novo ou em Crescimento | JoinOrigin',
  description:
    'Consiga seus primeiros 10 membros sem um grande orçamento — esteja você lançando um Origin novo ou reenergizando um existente, comece pela sua rede pessoal, compartilhe links de convite e faça da sala o lugar onde as pessoas querem entrar. Passos práticos da JoinOrigin.',
  intro: [
    'Os dez primeiros membros são os mais difíceis de conseguir e os mais importantes, porque definem a cultura de uma comunidade antes de ela ter qualquer reputação para atrair estranhos — e eles são igualmente valiosos quando um Origin existente está parado ou recomeçando, porque um núcleo comprometido é o que transforma um grupo silencioso em um grupo vivo. Esse problema dos primeiros dez é, no fundo, um problema de conectar pessoas, e é o problema central que a JoinOrigin resolve.',
    ...
    'Este guia divide o problema dos primeiros dez membros em passos concretos — esteja você começando um Origin novo ou revivendo um existente: partir das pessoas que você já conhece, publicar seu grupo para que ele tenha uma sala para participar, convidar pessoalmente com links, fazer um primeiro encontro que converta participantes em promotores e construir um hábito simples de indicação para que cada membro traga o próximo — e cada passo mostra onde a JoinOrigin ajuda.',
  ],
  dataPoints: [
    ...
    'A JoinOrigin é um sistema operacional de comunidades desenhado para ajudar as pessoas a encontrar ou começar Origins — ela não recruta membros nem organiza eventos.',
  ],
  faq: [
    {
    ...
    },
    {
      ...
      answer:
        'Sim. A JoinOrigin ajuda as pessoas a descobrir e começar Origins — um lugar onde pessoas que procuram um grupo podem encontrar o seu e entrar na sala por um link. Os passos deste guia — convites pessoais e um ótimo primeiro encontro — são os caminhos mais confiáveis para encontrar seus primeiros membros.',
    },
  ],
  sections: [
    'Liste cinquenta pessoas que você já conhece. Escreva qualquer pessoa que se encaixe no propósito da comunidade: amigos, colegas, colegas de turma, ex-companheiros de trabalho, vizinhos e conhecidos online. Você precisa de cerca de cinco vezes mais nomes do que os dez que quer. A JoinOrigin dá ao seu Origin um lar visível e uma sala que as pessoas podem encontrar — mas os primeiros nomes ainda vêm de pessoas que você conhece. Liste cinquenta e trate cada um como uma apresentação pessoal.',
  ...
  steps: [
    {
      ...
      joinOriginNote:
        'A JoinOrigin dá ao seu Origin um lar visível e uma sala que as pessoas podem encontrar — mas os primeiros nomes ainda vêm de pessoas que você conhece. Liste cinquenta e trate cada um como uma apresentação pessoal.',
    },
    {
    ...
    },
    {
      ...
      joinOriginNote:
        'A JoinOrigin mantém a associação e a comunicação do seu Origin em uma sala organizada, em vez de uma planilha de inscrição. Um link simples para a sala mantém o acompanhamento possível.',
    },
    {
