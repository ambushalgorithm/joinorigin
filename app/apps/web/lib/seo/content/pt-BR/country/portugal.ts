...
const content: CountryContent = {
  ...
  locale: 'pt-BR',
  slug: 'portugal',
  title: 'Origins em Portugal | JoinOrigin',
  description:
  ...
  faq: [
    {
      question: 'Como encontro Origins em Portugal?',
      answer:
    ...
    {
      question: 'Posso criar um Origin em uma cidade portuguesa?',
      answer:
    ...
    },
    {
      ...
      answer:
        'Sim. A JoinOrigin não tem escritórios locais. As páginas de Portugal e Lisboa estão traduzidas para o português, e a plataforma ajuda as pessoas a encontrar ou criar Origins em qualquer lugar do país.',
    },
  ],
};
