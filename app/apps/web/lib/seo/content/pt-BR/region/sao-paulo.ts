...
const content: RegionContent = {
  ...
  description:
    'Encontre ou comece comunidades em São Paulo — grupos de startups, criativos, políticos, encontros e pequenas empresas em todo o estado. Entre na lista de espera da JoinOrigin.',
  intro:
  ...
  faq: [
    ...
    {
      question: 'Qual é a melhor maneira de começar uma comunidade em São Paulo?',
      answer:
    ...
    },
    {
      ...
      answer:
        'Sim. A JoinOrigin não tem escritórios locais. As páginas de São Paulo estão disponíveis em português, e o produto ajuda as pessoas a encontrar ou começar comunidades em todo o estado.',
    },
  ],
};
