...
/**
 * Inhoud voor Noord-Holland — Nederlandse vertaling
 * (per-taalinhoudsbestand).
 *
 * Tekst voor de regiogagina `nl` van Noord-Holland op
 * `/nl/location/the-netherlands/north-holland`.
 */
const content: RegionContent = {
  ...
  dataPoints: [
    'Noord-Holland heeft ongeveer 2,9 miljoen inwoners.',
    'Bevat Amsterdam, de hoofdstad, en steden als Haarlem en Alkmaar.',
    'Nederlands is de primaire taal; Engels wordt veel gesproken.',
    'Sterke verenigingscultuur en fietsvriendelijke geografie.',
  ],
  faq: [
    {
      question: 'Is Noord-Holland anders dan de scene van Amsterdam?',
      answer:
        'Ja. Noord-Holland is de bredere provincie — Amsterdam plus de omliggende steden en kust. De meeste nationale gemeenschappen komen in de hoofdstad bijeen, maar de provincie heeft sterke lokale scenes en buitengemeenschappen.',
    },
    {
      question: 'Welke delen van Noord-Holland hebben actieve gemeenschappen?',
      answer:
        'Amsterdam is het dichtste centrum voor professionele en creatieve groepen; Haarlem heeft een sterke culturele scene, en de kust ondersteunt strand- en watersportgemeenschappen.',
    },
    {
      question: 'Werkt JoinOrigin in Noord-Holland?',
      answer:
        'Ja. JoinOrigin heeft geen lokale kantoren. De pagina voor de regio Noord-Holland is in het Nederlands vertaald, en het platform helpt mensen om overal in de provincie gemeenschappen te vinden of te starten.',
    },
  ],
};
