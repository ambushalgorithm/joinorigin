...
const content: GuideContent = {
  ...
  title: 'Hoe haal je je eerste 10 leden binnen voor een nieuw of groeiend Origin | JoinOrigin',
  description:
  ...
  dataPoints: [
    ...
    'JoinOrigin is een community-besturingssysteem dat mensen helpt Origins te vinden of te starten — het werft geen leden en organiseert geen evenementen.',
  ],
  faq: [
    {
  ...
  steps: [
    {
      ...
      joinOriginNote:
        'JoinOrigin geeft je Origin een zichtbaar thuis en een kamer die mensen kunnen vinden — maar de eerste namen komen nog steeds uit mensen die je kent. Maak een lijst van vijftig en behandel elke naam als een persoonlijke introductie.',
    },
    {
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin houdt het lidmaatschap en de communicatie van je Origin in één georganiseerde kamer in plaats van een aanmeldlijst. Een simpele link naar de kamer houdt de opvolging mogelijk.',
    },
    {
