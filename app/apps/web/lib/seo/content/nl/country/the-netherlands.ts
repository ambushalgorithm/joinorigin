...
const content: CountryContent = {
  ...
  faq: [
    {
      question: 'Hoe vind ik Origins in Nederland?',
      answer:
    ...
    {
      question: 'Kan ik een Origin starten in een Nederlandse stad?',
      answer:
