...
const content: CountryContent = {
  ...
  faq: [
    {
      question: 'How do I find communities in South Africa?',
      answer:
        'Use the /location hub to pick a city, then explore the group-type pages for startup, creative, political, meetup, and small business communities. Churches, stokvels, sports clubs, and coworking spaces are also reliable starting points for offline groups.',
    },
    {
