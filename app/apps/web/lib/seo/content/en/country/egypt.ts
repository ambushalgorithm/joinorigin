...
const content: CountryContent = {
  ...
  faq: [
    {
      question: 'How do I find Origins in Egypt?',
      answer:
        'Use the /location hub to pick a city, then explore the group-type pages for startup, creative, political, meetup, and small business Origins. Ahwa cafés, university campuses, and cultural centers are also strong starting points for offline groups.',
    },
    {
