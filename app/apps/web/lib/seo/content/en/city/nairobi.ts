...
const content: CityContent = {
  ...
  intro: [
    ...
    'For anyone looking to find or start an Origin, Nairobi rewards specificity, consistency, and a willingness to meet people where they already are.',
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes — recurring formats are how most Nairobi Origins start, and the chama tradition gives you a proven pattern of trust and consistency. The how-to guides walk through the first event to a stable Origin.',
      },
    ],
  },
  faq: [
    {
      question: 'How do I find an Origin in Nairobi?',
      answer:
        'Use the group-type pages for startup, creative, political, meetup, and small business Origins. Each describes the real neighborhoods, venues, and formats where Nairobi residents gather. JoinOrigin is live — create your profile and find or start your Origin today.',
    },
    {
      question: 'Is it realistic to start an Origin in Nairobi?',
      answer:
        'Yes. Nairobi has affordable venues, generous public green space, and a strong culture of self-organized groups. The guides cover starting an Origin, organizing a meetup, and getting your first ten members.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Nairobi residents find or start Origins.',
    },
  ],
};
