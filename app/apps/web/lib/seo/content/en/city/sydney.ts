...
const content: CityContent = {
  ...
  intro: [
    ...
    "For finding or starting an Origin, Sydney rewards a clear purpose and a good venue: the city's lifestyle culture means people are busy and selective, but groups that offer genuine value and a welcoming tone build loyal followings quickly.",
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes — recurring formats are how most Sydney Origins start, and the lifestyle culture rewards consistency. The how-to guides walk through the first event to a stable Origin.',
      },
    ],
  },
  faq: [
    {
      question: 'How do I find an Origin in Sydney?',
      answer:
        'Use the group-type pages for startup, creative, political, meetup, and small business Origins. Each describes the real districts, venues, and formats where Sydneysiders gather. JoinOrigin is live — create your profile and find or start your Origin today.',
    },
    {
      question: 'Is it realistic to start an Origin in Sydney?',
      answer:
        'Yes. Sydney has a strong startup scene, a deep creative culture, and spectacular free venues. The guides cover starting an Origin, organizing a meetup, and getting your first ten members.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Sydneysiders find or start Origins.',
    },
  ],
};
