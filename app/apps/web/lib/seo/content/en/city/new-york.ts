...
const content: CityContent = {
  ...
  intro: [
    ...
    'Venue culture is equally rich: coworking spaces, coffee shops, libraries, and even rooftops regularly host evening events. Whether you want to find an Origin or launch one, New York gives you density, diversity, and infrastructure that few cities can match.',
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes — recurring formats are how most Origins start. The how-to guides explain the steps from a first event to a stable Origin with organizers and rituals.',
      },
    ],
  },
  faq: [
    {
      question: 'How do I find an Origin in New York City?',
      answer:
        'Start with the group-type pages: startup, creative, political, meetup, and small business Origins. Each lists the real venues, institutions, and formats where New Yorkers gather. JoinOrigin is live — create your profile and find or start your Origin today.',
    },
    {
      question: 'Is it realistic to start an Origin in NYC?',
      answer:
    ...
    },
    {
      ...
      answer:
        'Yes. Every venue type mentioned — coworking spaces, libraries, parks, community gardens, neighborhood bars — exists across the boroughs. Venue suggestions are compiled from real, publicly known community spaces and current community reporting.',
    },
    {
      question: 'Does JoinOrigin have an office in New York?',
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps New Yorkers find or start Origins.',
    },
  ],
};
