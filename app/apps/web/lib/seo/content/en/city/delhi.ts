...
const content: CityContent = {
  ...
  intro: [
    ...
    "For finding or starting a community, Delhi rewards organizers who pick a clear neighbourhood and a clear purpose. The metro makes cross-city attendance easier than it looks, and the city's culture of debate means a well-framed topic reliably fills a room.",
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes — recurring formats are how most Delhi communities start, and the metro makes it easy for people to commit to a weekly session. The how-to guides walk through the first event to a stable community.',
      },
    ],
  },
  faq: [
    {
      question: 'How do I find a community in Delhi?',
      answer:
        'Use the group-type pages for startup, creative, political, meetup, and small business communities. Each describes the real districts, venues, and formats where Delhiites gather. JoinOrigin is live — create your profile and find or start your community today.',
    },
    {
      question: 'Is it realistic to start a community in Delhi?',
      answer:
        'Yes. Delhi has deep social energy, a strong culture of debate, and a metro that makes cross-city events practical. The guides cover starting a community, organizing a meetup, and getting your first ten members.',
    },
    {
      question: 'Are the venue suggestions on this page real?',
      answer:
        'Yes. Every venue type mentioned — Lodhi Garden, Hauz Khas Village, Dilli Haat, Old Delhi lanes, community centres — exists in Delhi. We never fabricate member counts, ratings, or local offices.',
    },
    {
      question: 'Does JoinOrigin have an office in Delhi?',
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Delhiites find or start communities.',
    },
  ],
};
