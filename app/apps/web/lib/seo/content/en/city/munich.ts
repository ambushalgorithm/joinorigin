...
const content: CityContent = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Yes. Every venue type mentioned — beer gardens, the Isar riverbanks, Viktualienmarkt, Alpenverein huts, public libraries — exists in Munich. We never fabricate member counts, ratings, or local offices.',
    },
    {
