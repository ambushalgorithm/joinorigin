...
const content: CityContent = {
  ...
  intro: [
    ...
    "For finding or starting an Origin, Bengaluru rewards specificity and a good venue: choose a neighbourhood that fits your group, pick a format people can attend after work, and the city's density of curious professionals will do the rest.",
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes — recurring formats are how most Bengaluru Origins start, and the café and brewery culture gives you proven venues. The how-to guides walk through the first event to a stable Origin.',
      },
    ],
  },
  faq: [
    {
      question: 'How do I find an Origin in Bengaluru?',
      answer:
        'Use the group-type pages for startup, creative, political, meetup, and small business Origins. Each describes the real districts, venues, and formats where Bengalureans gather. JoinOrigin is live — create your profile and find or start your Origin today.',
    },
    {
      question: 'Is it realistic to start an Origin in Bengaluru?',
      answer:
        'Yes. Bengaluru has a young, mobile population, a strong café and brewery culture, and a dense professional network. The guides cover starting an Origin, organizing a meetup, and getting your first ten members.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Bengalureans find or start Origins.',
    },
  ],
};
