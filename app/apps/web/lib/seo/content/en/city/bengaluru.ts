...
const content: CityContent = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Yes. Every venue type mentioned — Cubbon Park, Lalbagh, brewery taprooms, Church Street cafés, tech park event rooms — exists in Bengaluru. We never fabricate member counts, ratings, or local offices.',
    },
    {
