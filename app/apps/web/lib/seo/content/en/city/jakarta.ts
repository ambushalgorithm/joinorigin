...
const content: CityContent = {
  ...
  intro: [
    ...
    "For finding or starting a community, Jakarta rewards organisers who respect the traffic: choose a venue that is easy to reach, start on time, and build in food and coffee — the city's hospitality culture makes shared meals the fastest way to build belonging.",
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Yes — recurring formats are how most Jakarta communities start, and the city's warmth keeps members coming back. The how-to guides walk through the first event to a stable community.",
      },
    ],
  },
  faq: [
    {
      question: 'How do I find a community in Jakarta?',
      answer:
        'Use the group-type pages for startup, creative, political, meetup, and small business communities. Each describes the real districts, venues, and formats where Jakartans gather. JoinOrigin is live — create your profile and find or start your community today.',
    },
    {
      question: 'Is it realistic to start a community in Jakarta?',
      answer:
        'Yes. Jakarta has a huge population, a strong startup scene, and a famously warm culture. The guides cover starting a community, organizing a meetup, and getting your first ten members.',
    },
    {
      question: 'Are the venue suggestions on this page real?',
      answer:
        'Yes. Every venue type mentioned — Monas, Kota Tua, Kemang cafés, SCBD coworking floors — exists in Jakarta. We never fabricate member counts, ratings, or local offices.',
    },
    {
      question: 'Does JoinOrigin have an office in Jakarta?',
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Jakartans find or start communities.',
    },
  ],
};
