...
const content: CityContent = {
  ...
  intro: [
    ...
    'Lima’s weather is famously gray — a coastal fog called garúa covers the sky for much of the year — but the city’s social life is warm and lively: the Malecón boardwalk, the beaches of the Costa Verde, the bars of Barranco, and the cevicherías of every neighborhood. For finding or starting a community, Lima rewards choosing a neighborhood, a good venue, and a group that celebrates the city’s food and its proud, hospitable culture.',
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes — recurring formats are how most Lima communities start. The how-to guides walk through the steps from a first event to a stable community with organizers and rituals.',
      },
    ],
  },
  faq: [
    {
      question: 'How do I find a community in Lima?',
      answer:
        'Start with the group-type pages: startup, creative, political, meetup, and small business communities. Each describes the real neighborhoods, venues, and formats where Limaños gather. JoinOrigin is live — create your profile and find or start your community today.',
    },
    {
      question: 'Is it realistic to start a community in Lima?',
      answer:
        'Yes. The city has free public venues, a mild year-round climate, and a warm, hospitable culture. The guides cover starting a community, organizing a meetup, and getting your first ten members.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Limaños find or start communities.',
    },
  ],
};
