  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes — recurring formats are how most Cape Town communities start, and the city’s outdoor culture gives you proven patterns of consistency. The how-to guides walk through the first event to a stable community.',
      },
    ],
  },
  faq: [
    {
      question: 'How do I find a community in Cape Town?',
      answer:
    ...
    {
      question: 'Is it realistic to start a community in Cape Town?',
      answer:
