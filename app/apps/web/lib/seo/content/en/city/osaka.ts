...
const content: CityContent = {
  ...
  intro: [
    ...
    "For finding or starting an Origin, Osaka rewards personality and warmth: be direct, bring food, and keep the tone friendly — the city's culture of kuidaore (eat till you drop) makes shared meals the fastest way to build belonging.",
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes — recurring formats and shared meals are how most Osaka Origins start. The how-to guides walk through the first event to a stable Origin.',
      },
    ],
  },
  faq: [
    {
      question: 'How do I find an Origin in Osaka?',
      answer:
        'Use the group-type pages for startup, creative, political, meetup, and small business Origins. Each describes the real districts, venues, and formats where Osakans gather. JoinOrigin is live — create your profile and find or start your Origin today.',
    },
    {
      question: 'Is it realistic to start an Origin in Osaka?',
      answer:
        'Yes. Osaka has a warm, direct culture, famous food, and reliable trains. The guides cover starting an Origin, organizing a meetup, and getting your first ten members.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Osakans find or start Origins.',
    },
  ],
};
