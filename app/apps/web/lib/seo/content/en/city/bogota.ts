...
const content: CityContent = {
  ...
  intro: [
    ...
    'The city has transformed itself over the past decades, and its residents are proud of that story: bike lanes, public libraries, and community programs are real parts of daily life. For finding or starting a community, Bogotá rewards showing up consistently, choosing a neighborhood, and building a group that matches the city’s energy and its warm, direct social style.',
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes — recurring formats are how most Bogotá communities start. The how-to guides walk through the steps from a first event to a stable community with organizers and rituals.',
      },
    ],
  },
  faq: [
    {
      question: 'How do I find a community in Bogotá?',
      answer:
    ...
    {
      question: 'Is it realistic to start a community in Bogotá?',
      answer:
        'Yes. The city has free public venues, a young and energetic population, and a strong civic culture. The guides cover starting a community, organizing a meetup, and getting your first ten members.',
    },
    {
