...
const content: CityContent = {
  ...
  intro: [
    ...
    'The city rewards the confident organizer: it is dense, lively, and full of people who show up — but traffic, altitude, and rain season shape the calendar. For finding or starting a community, Mexico City rewards choosing a neighborhood, a clear language (Spanish, English, or both), and a venue with good transit access.',
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes — recurring formats are how most Mexico City communities start. The how-to guides walk through the steps from a first event to a stable community with organizers and rituals.',
      },
    ],
  },
  faq: [
    {
      question: 'How do I find a community in Mexico City?',
      answer:
    ...
    {
      question: 'Is it realistic to start a community in Mexico City?',
      answer:
        'Yes. The city has free public venues, a vast and curious population, and a rich culture of gathering. The guides cover starting a community, organizing a meetup, and getting your first ten members.',
    },
    {
      question: 'Are the venue suggestions on this page real?',
      answer:
        'Yes. Every venue type mentioned — Chapultepec Park, Xochimilco canals, Roma cafés, public markets, cultural centers — exists in Mexico City. We never fabricate member counts, ratings, or local offices.',
    },
    {
