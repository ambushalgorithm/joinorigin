...
const content: CityContent = {
  ...
  intro: [
    ...
    "For finding or starting a community, Mumbai rewards people who respect the commute: choose a central venue, keep events tight and on time, and lean on the city's famous street food and coastal breeze to build warmth quickly.",
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Yes — recurring formats are how most Mumbai communities start, and the city's density means a consistent weekly session quickly builds a following. The how-to guides walk through the first event to a stable community.",
      },
    ],
  },
  faq: [
    {
      question: 'How do I find a community in Mumbai?',
      answer:
        'Use the group-type pages for startup, creative, political, meetup, and small business communities. Each describes the real districts, venues, and formats where Mumbaikars gather. JoinOrigin is live — create your profile and find or start your community today.',
    },
    {
      question: 'Is it realistic to start a community in Mumbai?',
      answer:
        'Yes. Mumbai has huge density, reliable public transport, and a culture of showing up for practical, well-run events. The guides cover starting a community, organizing a meetup, and getting your first ten members.',
    },
    {
      question: 'Are the venue suggestions on this page real?',
      answer:
        'Yes. Every venue type mentioned — Marine Drive, Juhu Beach, Kala Ghoda galleries, BKC coworking floors, street-food lanes — exists in Mumbai. We never fabricate member counts, ratings, or local offices.',
    },
    {
      question: 'Does JoinOrigin have an office in Mumbai?',
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Mumbaikars find or start communities.',
    },
  ],
};
