...
const content: CityContent = {
  ...
  intro: [
    ...
    "For finding or starting a community, Seoul rewards energy and trend-awareness: formats move fast here, so a clear identity and a consistent weekly rhythm matter more than long-term plans. The city's café culture and 24-hour energy mean venues are almost always available.",
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Yes — recurring formats are how most Seoul communities start, and the city's energy sustains them. The how-to guides walk through the first event to a stable community.",
      },
    ],
  },
  faq: [
    {
      question: 'How do I find a community in Seoul?',
      answer:
        'Use the group-type pages for startup, creative, political, meetup, and small business communities. Each describes the real districts, venues, and formats where Seoulites gather. JoinOrigin is live — create your profile and find or start your community today.',
    },
    {
      question: 'Is it realistic to start a community in Seoul?',
      answer:
        'Yes. Seoul has huge social energy, a dense café culture, and reliable public transport. The guides cover starting a community, organizing a meetup, and getting your first ten members.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Seoulites find or start communities.',
    },
  ],
};
