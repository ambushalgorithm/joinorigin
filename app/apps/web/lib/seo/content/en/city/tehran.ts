...
const content: CityContent = {
  ...
  intro: [
    ...
    'For anyone looking to find or start a community, Tehran rewards choosing a district, building trust through repeated meetups, and leveraging the city’s extraordinary pool of talent and energy.',
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes — recurring formats are how most Tehran communities start, and the café and tea-house culture gives you a proven pattern of regular gathering. The how-to guides walk through the first event to a stable community.',
      },
    ],
  },
  faq: [
    {
      question: 'How do I find a community in Tehran?',
      answer:
        'Use the group-type pages for startup, creative, political, meetup, and small business communities. Each describes the real districts, venues, and formats where Tehran residents gather. JoinOrigin is live — create your profile and find or start your community today.',
    },
    {
      question: 'Is it realistic to start a community in Tehran?',
      answer:
        'Yes. Tehran has enormous density, a rich café culture, and a strong tradition of self-organized groups. The guides cover starting a community, organizing a meetup, and getting your first ten members.',
    },
    {
      question: 'Are the venue suggestions on this page real?',
      answer:
        'Yes. Every venue type mentioned — Tochal trailheads, Mellat Park, Valiasr cafés, the Grand Bazaar, central co-working spaces — exists in Tehran. We never fabricate member counts, ratings, or local offices.',
    },
    {
      question: 'Does JoinOrigin have an office in Tehran?',
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Tehran residents find or start communities.',
    },
  ],
};
