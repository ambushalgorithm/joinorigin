  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes — recurring formats are how most Barranquilla communities start. The how-to guides walk through the steps from a first event to a stable community with organizers and rituals.',
      },
    ],
  },
  faq: [
    {
      question: 'How do I find a community in Barranquilla?',
      answer:
    ...
    {
      question: 'Is it realistic to start a community in Barranquilla?',
      answer:
        'Yes. The city has free public venues, a warm costeño culture, and a festive social life. The guides cover starting a community, organizing a meetup, and getting your first ten members.',
    },
    {
      question: 'Are the venue suggestions on this page real?',
      answer:
        'Yes. Every venue type mentioned — the Gran Malecón, Plaza de la Paz, Riomar cafés, Barrio Abajo cultural spaces, neighborhood markets — exists in Barranquilla. We never fabricate member counts, ratings, or local offices.',
    },
    {
