...
const content: CityContent = {
  ...
  intro: [
    ...
    'For anyone looking to find or start an Origin, Cairo rewards choosing a district, building relationships over many cups of tea, and committing to a regular rhythm that the city’s density will amplify.',
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes — recurring formats are how most Cairo Origins start, and the ahwa tradition gives you a proven pattern of regular gathering. The how-to guides walk through the first event to a stable Origin.',
      },
    ],
  },
  faq: [
    {
      question: 'How do I find an Origin in Cairo?',
      answer:
        'Use the group-type pages for startup, creative, political, meetup, and small business Origins. Each describes the real districts, venues, and formats where Cairo residents gather. JoinOrigin is live — create your profile and find or start your Origin today.',
    },
    {
      question: 'Is it realistic to start an Origin in Cairo?',
      answer:
        'Yes. Cairo has enormous density, a rich café culture, and a strong tradition of self-organized groups. The guides cover starting an Origin, organizing a meetup, and getting your first ten members.',
    },
    {
      question: 'Are the venue suggestions on this page real?',
      answer:
        'Yes. Every venue type mentioned — Nile walkways, Zamalek cafés, Khan el-Khalili, New Cairo co-working spaces — exists in Cairo. Venue suggestions are compiled from real, publicly known community spaces and current community reporting.',
    },
    {
      question: 'Does JoinOrigin have an office in Cairo?',
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Cairo residents find or start Origins.',
    },
  ],
};
