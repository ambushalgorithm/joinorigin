...
const content: CityContent = {
  ...
  intro: [
    ...
    "For finding or starting a community, Chennai rewards patience and respect for its traditions: learn a little Tamil, schedule around the festival calendar, and the city's warmth and loyalty will keep members coming back for years.",
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Yes — recurring formats are how most Chennai communities start, and the city's loyalty keeps members coming back. The how-to guides walk through the first event to a stable community.",
      },
    ],
  },
  faq: [
    {
      question: 'How do I find a community in Chennai?',
      answer:
        'Use the group-type pages for startup, creative, political, meetup, and small business communities. Each describes the real districts, venues, and formats where Chennaites gather. JoinOrigin is live — create your profile and find or start your community today.',
    },
    {
      question: 'Is it realistic to start a community in Chennai?',
      answer:
        'Yes. Chennai has a strong cultural calendar, loyal communities, and a growing tech corridor. The guides cover starting a community, organizing a meetup, and getting your first ten members.',
    },
    {
      question: 'Are the venue suggestions on this page real?',
      answer:
        "Yes. Every venue type mentioned — the Marina, Elliot's Beach, Mylapore sabhas, Tidel Park coworking floors — exists in Chennai. We never fabricate member counts, ratings, or local offices.",
    },
    {
      question: 'Does JoinOrigin have an office in Chennai?',
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Chennaites find or start communities.',
    },
  ],
};
