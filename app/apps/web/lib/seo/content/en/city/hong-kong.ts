...
const content: CityContent = {
  ...
  intro: [
    ...
    "For finding or starting an Origin, Hong Kong rewards efficiency and authenticity: spaces are expensive, so formats that are well-organised and genuinely useful win, and the city's dim sum and tea culture makes shared meals a natural part of building trust.",
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Yes — recurring formats are how most Hong Kong Origins start, and the city's density sustains them. The how-to guides walk through the first event to a stable Origin.",
      },
    ],
  },
  faq: [
    {
      question: 'How do I find an Origin in Hong Kong?',
      answer:
        'Use the group-type pages for startup, creative, political, meetup, and small business Origins. Each describes the real districts, venues, and formats where Hongkongers gather. JoinOrigin is live — create your profile and find or start your Origin today.',
    },
    {
      question: 'Is it realistic to start an Origin in Hong Kong?',
      answer:
        'Yes. Hong Kong has huge density, excellent transport, and a culture that values well-organised events. The guides cover starting an Origin, organizing a meetup, and getting your first ten members.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Hongkongers find or start Origins.',
    },
  ],
};
