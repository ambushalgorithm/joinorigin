...
const content: CityContent = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Yes. Every venue type mentioned — hawker centres, Marina Bay, Gillman Barracks, Tiong Bahru cafés — exists in Singapore. We never fabricate member counts, ratings, or local offices.',
    },
    {
