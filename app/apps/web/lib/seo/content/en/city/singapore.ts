...
const content: CityContent = {
  ...
  intro: [
    ...
    'For finding or starting an Origin, Singapore rewards organisation and genuine connection: the city runs on efficiency, so well-planned events win, and the hawker centre — a shared table over good food — is the fastest way to build belonging.',
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Yes — recurring formats are how most Singapore Origins start, and the city's efficiency sustains them. The how-to guides walk through the first event to a stable Origin.",
      },
    ],
  },
  faq: [
    {
      question: 'How do I find an Origin in Singapore?',
      answer:
        'Use the group-type pages for startup, creative, political, meetup, and small business Origins. Each describes the real districts, venues, and formats where Singaporeans gather. JoinOrigin is live — create your profile and find or start your Origin today.',
    },
    {
      question: 'Is it realistic to start an Origin in Singapore?',
      answer:
        'Yes. Singapore is compact, efficient, and full of well-organised venues, from hawker centres to coworking floors. The guides cover starting an Origin, organizing a meetup, and getting your first ten members.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Singaporeans find or start Origins.',
    },
  ],
};
