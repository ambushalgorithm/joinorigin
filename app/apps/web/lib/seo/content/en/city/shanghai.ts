...
const content: CityContent = {
  ...
  intro: [
    ...
    "For finding or starting a community, Shanghai rewards people who understand the city's rhythm: formats are fast, platforms move quickly, and a well-organised event with a clear purpose reliably draws a crowd. The café culture of the French Concession provides natural homes for smaller, more intimate groups.",
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Yes — recurring formats are how most Shanghai communities start, and the city's speed sustains them. The how-to guides walk through the first event to a stable community.",
      },
    ],
  },
  faq: [
    {
      question: 'How do I find a community in Shanghai?',
      answer:
        'Use the group-type pages for startup, creative, political, meetup, and small business communities. Each describes the real districts, venues, and formats where Shanghainese gather. JoinOrigin is live — create your profile and find or start your community today.',
    },
    {
      question: 'Is it realistic to start a community in Shanghai?',
      answer:
        'Yes. Shanghai has a huge population, a fast culture, and a welcoming international scene. The guides cover starting a community, organizing a meetup, and getting your first ten members.',
    },
    {
      question: 'Are the venue suggestions on this page real?',
      answer:
        'Yes. Every venue type mentioned — the Bund, French Concession cafés, West Bund galleries, M50 studios — exists in Shanghai. We never fabricate member counts, ratings, or local offices.',
    },
    {
      question: 'Does JoinOrigin have an office in Shanghai?',
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Shanghainese find or start communities.',
    },
  ],
};
