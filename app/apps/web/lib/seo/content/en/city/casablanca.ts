...
const content: CityContent = {
  ...
  intro: [
    ...
    'For anyone looking to find or start an Origin, Casablanca rewards choosing a district, respecting the café rhythm, and committing to a regular event — the city’s size and energy will do the rest.',
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes — recurring formats are how most Casablanca Origins start, and the café culture gives you a proven pattern of regular gathering. The how-to guides walk through the first event to a stable Origin.',
      },
    ],
  },
  faq: [
    {
      question: 'How do I find an Origin in Casablanca?',
      answer:
        'Use the group-type pages for startup, creative, political, meetup, and small business Origins. Each describes the real districts, venues, and formats where Casablanca residents gather. JoinOrigin is live — create your profile and find or start your Origin today.',
    },
    {
      question: 'Is it realistic to start an Origin in Casablanca?',
      answer:
        'Yes. Casablanca has a compact city center, a rich café culture, and a strong tradition of self-organized groups. The guides cover starting an Origin, organizing a meetup, and getting your first ten members.',
    },
    {
      question: 'Are the venue suggestions on this page real?',
      answer:
        'Yes. Every venue type mentioned — the Corniche beaches, Maarif cafés, the Technopark, the old medina — exists in Casablanca. Venue suggestions are compiled from real, publicly known community spaces and current community reporting.',
    },
    {
      question: 'Does JoinOrigin have an office in Casablanca?',
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Casablanca residents find or start Origins.',
    },
  ],
};
