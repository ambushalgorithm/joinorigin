...
const content: CityContent = {
  ...
  intro: [
    ...
    'Montreal winters are long and real, which the city has turned into a culture: sugar shacks, skating rinks, indoor festivals, and café terraces with heaters keep communities meeting through February. For finding or starting an Origin, Montreal rewards choosing a language (or embracing both), picking a neighborhood, and building a rhythm that runs through all four seasons.',
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes — recurring formats are how most Montreal Origins start. The how-to guides walk through the steps from a first event to a stable Origin with organizers and rituals.',
      },
    ],
  },
  faq: [
    {
      question: 'How do I find an Origin in Montreal?',
      answer:
        'Start with the group-type pages: startup, creative, political, meetup, and small business Origins. Each describes the real neighborhoods, venues, and formats where Montrealers gather. JoinOrigin is live — create your profile and find or start your Origin today.',
    },
    {
      question: 'Is it realistic to start an Origin in Montreal?',
      answer:
        'Yes. The city has free public venues, a warm café culture, and a world-famous festival scene. The guides cover starting an Origin, organizing a meetup, and getting your first ten members.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Montrealers find or start Origins.',
    },
  ],
};
