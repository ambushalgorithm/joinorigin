...
const content: CityContent = {
  ...
  intro: [
    ...
    'For finding or starting a community, Tokyo rewards consistency and clear rituals: a nomikai (after-work drink) after a monthly meetup, a fixed café table, a standing time — these small structures make it easy for busy people to show up again and again.',
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes — recurring formats and small rituals are how most Tokyo communities start. The how-to guides walk through the first event to a stable community.',
      },
    ],
  },
  faq: [
    {
      question: 'How do I find a community in Tokyo?',
      answer:
        'Use the group-type pages for startup, creative, political, meetup, and small business communities. Each describes the real districts, venues, and formats where Tokyoites gather. JoinOrigin is live — create your profile and find or start your community today.',
    },
    {
      question: 'Is it realistic to start a community in Tokyo?',
      answer:
        'Yes. Tokyo has enormous scale, reliable trains, and a culture of small, repeatable rituals. The guides cover starting a community, organizing a meetup, and getting your first ten members.',
    },
    {
      question: 'Are the venue suggestions on this page real?',
      answer:
        'Yes. Every venue type mentioned — izakayas, Yoyogi Park, Shimokitazawa live houses, shotengai halls — exists in Tokyo. We never fabricate member counts, ratings, or local offices.',
    },
    {
      question: 'Does JoinOrigin have an office in Tokyo?',
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Tokyoites find or start communities.',
    },
  ],
};
