...
const content: CityContent = {
  ...
  intro: [
    ...
    "For finding or starting a community, Taipei rewards clear purpose and a good venue: the city's civic-tech and social-movement history means people respond to concrete issues and well-run events, and its food culture makes shared meals a natural part of any gathering.",
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Yes — recurring formats are how most Taipei communities start, and the city's warmth keeps members coming back. The how-to guides walk through the first event to a stable community.",
      },
    ],
  },
  faq: [
    {
      question: 'How do I find a community in Taipei?',
      answer:
        'Use the group-type pages for startup, creative, political, meetup, and small business communities. Each describes the real districts, venues, and formats where Taipei residents gather. JoinOrigin is live — create your profile and find or start your community today.',
    },
    {
      question: 'Is it realistic to start a community in Taipei?',
      answer:
        'Yes. Taipei is compact, well-connected by the MRT, and has a strong civic and café culture. The guides cover starting a community, organizing a meetup, and getting your first ten members.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Taipei residents find or start communities.',
    },
  ],
};
