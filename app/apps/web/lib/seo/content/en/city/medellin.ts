...
const content: CityContent = {
  ...
  intro: [
    ...
    'Medellín is proud of its paisa identity — the friendly, hardworking, entrepreneurial culture of the region — and of its flowers: the Feria de las Flores is the city’s biggest celebration. For finding or starting an Origin, Medellín rewards showing up with genuine commitment, building trust with existing organizations, and choosing a neighborhood — the city’s communities are strong, and they welcome people who respect that strength.',
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes — recurring formats are how most Medellín Origins start. The how-to guides walk through the steps from a first event to a stable Origin with organizers and rituals.',
      },
    ],
  },
  faq: [
    {
      question: 'How do I find an Origin in Medellín?',
      answer:
    ...
    {
      question: 'Is it realistic to start an Origin in Medellín?',
      answer:
        'Yes. The city has free public venues, a year-round mild climate, and a strong culture of community organization. The guides cover starting an Origin, organizing a meetup, and getting your first ten members.',
    },
    {
      question: 'Are the venue suggestions on this page real?',
      answer:
        'Yes. Every venue type mentioned — the Botanical Garden, Parque Arví, El Poblado cafés, Comuna 13, library parks — exists in Medellín. Venue suggestions are compiled from real, publicly known community spaces and current community reporting.',
    },
    {
