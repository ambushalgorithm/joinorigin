...
const content: CityContent = {
  ...
  intro: [
    ...
    "For finding or starting a community, Hyderabad rewards organizers who respect the city's geography: pick a venue in the corridor for tech audiences and one in the old city for culture and food, and lean on the city's famous hospitality to make newcomers feel welcome.",
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Yes — recurring formats are how most Hyderabad communities start, and the city's hospitality makes people come back. The how-to guides walk through the first event to a stable community.",
      },
    ],
  },
  faq: [
    {
      question: 'How do I find a community in Hyderabad?',
      answer:
        'Use the group-type pages for startup, creative, political, meetup, and small business communities. Each describes the real districts, venues, and formats where Hyderabadis gather. JoinOrigin is live — create your profile and find or start your community today.',
    },
    {
      question: 'Is it realistic to start a community in Hyderabad?',
      answer:
        'Yes. Hyderabad has a fast-growing tech corridor, a rich heritage culture, and a famously hospitable population. The guides cover starting a community, organizing a meetup, and getting your first ten members.',
    },
    {
      question: 'Are the venue suggestions on this page real?',
      answer:
        'Yes. Every venue type mentioned — Necklace Road, Charminar lanes, T-Hub floors, Jubilee Hills cafés — exists in Hyderabad. We never fabricate member counts, ratings, or local offices.',
    },
    {
      question: 'Does JoinOrigin have an office in Hyderabad?',
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Hyderabadis find or start communities.',
    },
  ],
};
