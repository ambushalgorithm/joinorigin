...
const content: CityContent = {
  ...
  intro: [
    ...
    'For anyone looking to find or start an Origin, Lagos rewards boldness, consistency, and knowing your neighborhood — the city is large enough that a hyper-local group can thrive.',
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes — recurring formats are how most Lagos Origins start, and the trader and esusu traditions give you proven patterns of trust and consistency. The how-to guides walk through the first event to a stable Origin.',
      },
    ],
  },
  faq: [
    {
      question: 'How do I find an Origin in Lagos?',
      answer:
        'Use the group-type pages for startup, creative, political, meetup, and small business Origins. Each describes the real neighborhoods, venues, and formats where Lagosians gather. JoinOrigin is live — create your profile and find or start your Origin today.',
    },
    {
      question: 'Is it realistic to start an Origin in Lagos?',
      answer:
        'Yes. Lagos has abundant energy, active markets, beaches, and a strong culture of self-organized groups. The guides cover starting an Origin, organizing a meetup, and getting your first ten members.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Lagos residents find or start Origins.',
    },
  ],
};
