...
const content: CityContent = {
  ...
  intro: [
    ...
    'The University of Texas at Austin is the intellectual anchor, feeding students, researchers, and alumni into local communities year after year. For finding or starting a community, Austin rewards a casual, welcoming format — a Sunday paddle, a porch jam, a taco meetup — and a consistent venue, because the city’s transplants are always looking for the group that feels like home.',
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes — recurring formats are how most Austin communities start. The how-to guides walk through the steps from a first event to a stable community with organizers and rituals.',
      },
    ],
  },
  faq: [
    {
      question: 'How do I find a community in Austin?',
      answer:
        'Start with the group-type pages: startup, creative, political, meetup, and small business communities. Each describes the real neighborhoods, venues, and formats where Austinites gather. JoinOrigin is live — create your profile and find or start your community today.',
    },
    {
      question: 'Is it realistic to start a community in Austin?',
      answer:
        'Yes. The city has free public venues, year-round outdoor weather, and a transplant-friendly culture. The guides cover starting a community, organizing a meetup, and getting your first ten members.',
    },
    {
      question: 'Are the venue suggestions on this page real?',
      answer:
        'Yes. Every venue type mentioned — Zilker Park, Barton Springs, Lady Bird Lake, food-truck courts, Red River clubs — exists in Austin. We never fabricate member counts, ratings, or local offices.',
    },
    {
      question: 'Does JoinOrigin have an office in Austin?',
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Austinites find or start communities.',
    },
  ],
};
