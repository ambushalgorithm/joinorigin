...
const content: CityContent = {
  ...
  intro: [
    ...
    "For finding or starting an Origin, Pune rewards organizers who tap into the student energy and the city's tradition of intellectual clubs: choose a venue near a college or a café district, keep formats simple and affordable, and the city's enthusiasm will sustain the group.",
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes — recurring formats are how most Pune Origins start, and the student energy sustains them. The how-to guides walk through the first event to a stable Origin.',
      },
    ],
  },
  faq: [
    {
      question: 'How do I find an Origin in Pune?',
      answer:
        'Use the group-type pages for startup, creative, political, meetup, and small business Origins. Each describes the real districts, venues, and formats where Punekars gather. JoinOrigin is live — create your profile and find or start your Origin today.',
    },
    {
      question: 'Is it realistic to start an Origin in Pune?',
      answer:
        'Yes. Pune has a huge student population, affordable venues, and a strong tradition of clubs and societies. The guides cover starting an Origin, organizing a meetup, and getting your first ten members.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Punekars find or start Origins.',
    },
  ],
};
