...
const content: CityContent = {
  ...
  intro: [
    ...
    'São Paulo is dense, humid, and fast, and the traffic is legendary — which shapes community life: groups anchor to neighborhoods and transit lines, and a good venue is worth the commute. For finding or starting a community, São Paulo rewards choosing a neighborhood, a clear format, and a venue with Metro access, then building a rhythm that matches the city’s relentless energy.',
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes — recurring formats are how most São Paulo communities start. The how-to guides walk through the steps from a first event to a stable community with organizers and rituals.',
      },
    ],
  },
  faq: [
    {
      question: 'How do I find a community in São Paulo?',
      answer:
        'Start with the group-type pages: startup, creative, political, meetup, and small business communities. Each describes the real neighborhoods, venues, and formats where Paulistanos gather. JoinOrigin is live — create your profile and find or start your community today.',
    },
    {
      question: 'Is it realistic to start a community in São Paulo?',
      answer:
        'Yes. The city has free public venues, a vast and energetic population, and a rich culture of gathering. The guides cover starting a community, organizing a meetup, and getting your first ten members.',
    },
    {
      question: 'Are the venue suggestions on this page real?',
      answer:
        'Yes. Every venue type mentioned — Ibirapuera Park, Avenida Paulista, Vila Madalena cafés, the Mercado Municipal, feiras — exists in São Paulo. We never fabricate member counts, ratings, or local offices.',
    },
    {
      question: 'Does JoinOrigin have an office in São Paulo?',
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Paulistanos find or start communities.',
    },
  ],
};
