...
const content: CityContent = {
  ...
  intro: [
    ...
    'For anyone looking to find or start a community, Dubai rewards choosing a district and a weekday rhythm — the expat culture is open, and a consistent monthly event can grow quickly.',
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes — recurring formats are how most Dubai communities start, and the expat culture is open to new groups. The how-to guides walk through the first event to a stable community.',
      },
    ],
  },
  faq: [
    {
      question: 'How do I find a community in Dubai?',
      answer:
        'Use the group-type pages for startup, creative, political, meetup, and small business communities. Each describes the real districts, venues, and formats where Dubai residents gather. JoinOrigin is live — create your profile and find or start your community today.',
    },
    {
      question: 'Is it realistic to start a community in Dubai?',
      answer:
        'Yes. Dubai has an international population, abundant venues, and a culture of people actively looking to connect. The guides cover starting a community, organizing a meetup, and getting your first ten members.',
    },
    {
      question: 'Are the venue suggestions on this page real?',
      answer:
        'Yes. Every venue type mentioned — Kite Beach, Alserkal Avenue, d3 studios, DIFC event floors, district cafés — exists in Dubai. We never fabricate member counts, ratings, or local offices.',
    },
    {
      question: 'Does JoinOrigin have an office in Dubai?',
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Dubai residents find or start communities.',
    },
  ],
};
