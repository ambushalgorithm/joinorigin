...
const content: CityContent = {
  ...
  intro: [
    ...
    "For finding or starting an Origin, Ho Chi Minh City rewards energy and authenticity: the city's culture is fast, young, and optimistic, and groups that meet regularly over coffee or street food build loyalty quickly.",
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Yes — recurring formats are how most Ho Chi Minh City Origins start, and the city's energy sustains them. The how-to guides walk through the first event to a stable Origin.",
      },
    ],
  },
  faq: [
    {
      question: 'How do I find an Origin in Ho Chi Minh City?',
      answer:
        'Use the group-type pages for startup, creative, political, meetup, and small business Origins. Each describes the real districts, venues, and formats where residents gather. JoinOrigin is live — create your profile and find or start your Origin today.',
    },
    {
      question: 'Is it realistic to start an Origin in Ho Chi Minh City?',
      answer:
        'Yes. The city has a young population, a booming startup scene, and a legendary food and coffee culture. The guides cover starting an Origin, organizing a meetup, and getting your first ten members.',
    },
    {
      question: 'Are the venue suggestions on this page real?',
      answer:
        'Yes. Every venue type mentioned — Ben Thanh market, Tao Dan Park, District 3 cafés, riverside promenades — exists in Ho Chi Minh City. Venue suggestions are compiled from real, publicly known community spaces and current community reporting.',
    },
    {
