...
const content: CityContent = {
  ...
  intro: [
    ...
    'For anyone looking to find or start an Origin, Johannesburg rewards joining a neighborhood first — the city is too big for a generic group, but a hyper-local one with a clear purpose can thrive.',
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes — recurring formats are how most Johannesburg Origins start, and the city’s stokvel and association traditions give you proven patterns of trust. The how-to guides walk through the first event to a stable Origin.',
      },
    ],
  },
  faq: [
    {
      question: 'How do I find an Origin in Johannesburg?',
      answer:
        'Use the group-type pages for startup, creative, political, meetup, and small business Origins. Each describes the real neighborhoods, venues, and formats where Johannesburg residents gather. JoinOrigin is live — create your profile and find or start your Origin today.',
    },
    {
      question: 'Is it realistic to start an Origin in Johannesburg?',
      answer:
        'Yes. Johannesburg has distinct neighborhoods, active venues, and a strong culture of self-organized groups. The guides cover starting an Origin, organizing a meetup, and getting your first ten members.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Johannesburg residents find or start Origins.',
    },
  ],
};
