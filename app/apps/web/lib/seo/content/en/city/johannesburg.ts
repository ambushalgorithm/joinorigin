...
const content: CityContent = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Yes. Every venue type mentioned — Maboneng studios, Market Theatre spaces, Melville Koppies, Rosebank parks, Tshimologong Precinct — exists in Johannesburg. We never fabricate member counts, ratings, or local offices.',
    },
    {
