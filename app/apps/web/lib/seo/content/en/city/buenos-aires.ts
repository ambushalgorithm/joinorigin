...
const content: CityContent = {
  ...
  intro: [
    ...
    'Porteños are famous for staying out late, drinking mate, and building deep friendships — community life runs on warmth and word of mouth. The economy has been through hard cycles, which has produced a culture of resourcefulness and mutual support that shows up in everything from barter networks to free events. For finding or starting a community, Buenos Aires rewards authenticity, a good venue, and a group that feeds the city’s hunger for conversation.',
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Yes — recurring formats are how most Buenos Aires communities start. The how-to guides walk through the steps from a first event to a stable community with organizers and rituals.',
      },
    ],
  },
  faq: [
    {
      question: 'How do I find a community in Buenos Aires?',
      answer:
        'Start with the group-type pages: startup, creative, political, meetup, and small business communities. Each describes the real neighborhoods, venues, and formats where porteños gather. JoinOrigin is live — create your profile and find or start your community today.',
    },
    {
      question: 'Is it realistic to start a community in Buenos Aires?',
      answer:
        'Yes. The city has free public venues, a warm social culture, and a rich café and cultural life. The guides cover starting a community, organizing a meetup, and getting your first ten members.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps porteños find or start communities.',
    },
  ],
};
