...
const content: CityContent = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Yes. Every venue type mentioned — harbour baths, Torvehallerne, Refshaleøen studios, co-housing common houses, parks — exists in Copenhagen. Venue suggestions are compiled from real, publicly known community spaces and current community reporting.',
    },
    {
