...
const content: CityContent = {
  ...
  intro: [
    ...
    "For finding or starting a community, Bangkok rewards warmth and consistency: the city's culture is famously friendly, food is the great social glue, and groups that meet regularly at the same venue build loyalty quickly.",
  ],
  dataPoints: [
  ...
  ideaPage: {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "Yes — recurring formats are how most Bangkok communities start, and the city's warmth keeps members coming back. The how-to guides walk through the first event to a stable community.",
      },
    ],
  },
  faq: [
    {
      question: 'How do I find a community in Bangkok?',
      answer:
        'Use the group-type pages for startup, creative, political, meetup, and small business communities. Each describes the real districts, venues, and formats where Bangkok residents gather. JoinOrigin is live — create your profile and find or start your community today.',
    },
    {
      question: 'Is it realistic to start a community in Bangkok?',
      answer:
        'Yes. Bangkok has a warm culture, legendary food, and a growing startup and creative scene. The guides cover starting a community, organizing a meetup, and getting your first ten members.',
    },
    {
      question: 'Are the venue suggestions on this page real?',
      answer:
        'Yes. Every venue type mentioned — Chatuchak market, Lumphini Park, Thonglor cafés, Charoenkrung galleries — exists in Bangkok. We never fabricate member counts, ratings, or local offices.',
    },
    {
      question: 'Does JoinOrigin have an office in Bangkok?',
      answer:
        'No. JoinOrigin has no local offices or staff. All community descriptions reflect the real city landscape, and the platform helps Bangkok residents find or start communities.',
    },
  ],
};
