...
const content: RegionContent = {
  ...
  slug: 'western-cape',
  intro:
    'The Western Cape is South Africa’s southernmost province and home to the legislative capital Cape Town, a city shaped by two dramatic features: the mountains that rise directly from the city bowl and the ocean that wraps around the peninsula. Table Mountain, Lion’s Head, and Signal Hill give residents world-class hiking at their doorstep, while beaches from Camps Bay to Muizenberg anchor surf, swim, and picnic cultures that run year-round. Beyond the city, the province holds the winelands of Stellenbosch and Franschhoek, the whale coast of Hermanus, and the garden route towns of George and Knysna, each with its own community life. The province mixes a mature creative and tech scene — Woodstock, Observatory, and the City Bowl host galleries, studios, and coworking spaces, and the Silicon Cape community organizes meetups, founder breakfasts, and demo nights — with the deep associational life of its diverse neighborhoods, from the Southern Suburbs to Khayelitsha and other townships. Universities including UCT, CPUT, and Stellenbosch supply students and researchers, and the province’s outdoor culture means many communities meet outside. For anyone looking to find or start a community, the Western Cape rewards showing up outdoors and building on the province’s habit of mixing business with beauty.',
  dataPoints: [
