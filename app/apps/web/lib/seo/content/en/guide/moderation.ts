 ...
 * Matrix room ownership — invite/remove members, assign roles, edit
...
const content: GuideContent = {
  ...
  intro: [
    'Every community that grows will eventually face a moment that tests its culture — a heated argument, a spammer, a member who makes others uncomfortable, or a misunderstanding that spirals. Moderation is the practice of protecting the space so the community can stay welcoming, and it only becomes necessary because communities are made of people connecting with each other. That connecting is the core problem JoinOrigin helps with — and the practices apply just as well to an established community fixing its culture as to a new group setting expectations before the first member arrives.',
    'JoinOrigin is a community OS designed to help people find, start, and organize communities — and in its digital model, a community lives in a creator-controlled room. Creator control is standard Matrix room ownership: the creator can invite and remove members, assign roles, edit room settings, pin messages, and archive the room — all enforced natively inside Element, the default chat client, with no custom permission system. That ownership is the backbone of moderation on JoinOrigin: the creator decides who belongs, what the rules are, and what happens when a rule is broken. JoinOrigin does not moderate third-party communities and does not provide moderation staff. The platform is designed around healthy community structure, and the practices in this guide are the human practices every organizer needs.',
    'This guide lays out a practical moderation system — whether your community is brand new or has years of history to clean up: written community rules that are short and specific, a clear enforcement path with warnings before removals, techniques for de-escalating tense situations, and honest advice about when to involve members and when to act alone. Every step shows where JoinOrigin helps.',
  ],
  dataPoints: [
    'Clear, written community rules reduce conflict by setting expectations before incidents happen.',
    'Creator control on JoinOrigin is Matrix room ownership: invite/remove, roles, settings, pin, archive.',
    'A staged enforcement path — warn, then limit, then remove — is fairer and easier to defend than instant bans.',
    'JoinOrigin is a community OS designed to help people find, start, and organize communities; it does not moderate third-party communities or provide moderation staff.',
  ],
  faq: [
    {
    ...
    },
    {
      ...
      answer:
        'Yes. JoinOrigin is a community OS where creator control is Matrix room ownership — invite/remove, roles, settings, pin, and archive enforced in Element. JoinOrigin does not moderate communities, so the practices in this guide — clear rules, staged enforcement, calm de-escalation — are yours to apply.',
    },
  ],
  sections: [
    'Write three to five clear rules. Keep them short, specific, and positive: “Be respectful”, “Stay on topic”, “No spam or self-promotion”, “Disagree with ideas, not people”. Post them where every new member will see them — ideally pinned in the room. On JoinOrigin a community’s rules and values are visible in its room from day one — new members see them before they join. Pin your short rules where every new member will see them.',
    'Set the tone as the room owner. Model the behavior you want — welcome newcomers, thank contributors, and address problems calmly. The creator’s example sets the cultural floor for the community. JoinOrigin does not police communities — the tone is set by creators and members. The platform makes welcoming behavior visible; model the behavior you want in the room.',
    'Own the room like the creator you are. Creator control on JoinOrigin is Matrix room ownership: invite and remove members, assign roles, edit room settings, pin messages, and archive the room — enforced natively in Element. Knowing these controls is the technical half of moderation. JoinOrigin gives the creator full ownership of the room from publish, with no custom permission system. Learn the moderation controls of the platform you use and designate one clear owner.',
    'Agree on an enforcement path. Define a staged response: private warning, then limits (muted, limited posting — often a role change), then removal for repeated or severe violations. Consistent escalation is fairer than improvisation. On JoinOrigin roles are standard Matrix roles in Element — mute, ban, and role assignment are native actions. Write down the enforcement path and stick to it.',
    'Act early and calmly. Address the first sign of a problem privately, before it becomes a public incident. Early, calm intervention is the cheapest moderation there is. JoinOrigin does not moderate for you — early, calm intervention is a human skill. The platform is designed so issues surface visibly in the room, and they are caught early. Reach out privately at the first sign.',
    'Learn de-escalation techniques. When tensions rise, slow the conversation down: acknowledge the feeling, restate the disagreement neutrally, ask for the underlying point, and suggest a pause or a private room for the heat. JoinOrigin keeps community interactions organized and calm by design, but de-escalation remains a human craft. Slow the conversation down and move heat to a private room.',
    'Keep a record of significant incidents. Note what happened, what you did, and why. A simple log helps you stay consistent, learn from patterns, and defend decisions when a member asks why. JoinOrigin is a community OS where the community’s history lives in one place — a natural home for an incident log. A simple note of what happened and why keeps you consistent.',
    'Share the load with co-moderators. Recruit one or two trusted members and agree on the rules of enforcement. A community that depends on a single moderator becomes fragile and biased. JoinOrigin does not provide moderation staff — co-moderators are fellow members. Creators assign roles to co-moderators in Element — native Matrix roles, no custom system. Recruit one or two trusted members and give them clear roles.',
  ],
  steps: [
    {
      ...
      joinOriginNote:
        'On JoinOrigin a community’s rules and values are visible in its room from day one — new members see them before they join. Pin your short rules where every new member will see them.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin does not police communities — the tone is set by creators and members. The platform makes welcoming behavior visible; model the behavior you want in the room.',
    },
    {
      title: 'Own the room like the creator you are',
      body: 'Creator control on JoinOrigin is Matrix room ownership: invite and remove members, assign roles, edit room settings, pin messages, and archive the room — enforced natively in Element. Knowing these controls is the technical half of moderation.',
      joinOriginNote:
        'JoinOrigin gives the creator full ownership of the room from publish, with no custom permission system. Learn the moderation controls of the platform you use and designate one clear owner.',
    },
    {
      ...
      joinOriginNote:
        'On JoinOrigin roles are standard Matrix roles in Element — mute, ban, and role assignment are native actions. Write down the enforcement path and stick to it.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin does not moderate for you — early, calm intervention is a human skill. The platform is designed so issues surface visibly in the room, and they are caught early. Reach out privately at the first sign.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin keeps community interactions organized and calm by design, but de-escalation remains a human craft. Slow the conversation down and move heat to a private room.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin is a community OS where the community’s history lives in one place — a natural home for an incident log. A simple note of what happened and why keeps you consistent.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin does not provide moderation staff — co-moderators are fellow members. Creators assign roles to co-moderators in Element — native Matrix roles, no custom system. Recruit one or two trusted members and give them clear roles.',
    },
  ],
};
