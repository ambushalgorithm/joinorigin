...
const content: GuideContent = {
  ...
  intro: [
    'Every community that grows will eventually face a moment that tests its culture — a heated argument, a spammer, a member who makes others uncomfortable, or a misunderstanding that spirals. Moderation is the practice of protecting the space so the community can stay welcoming, and it only becomes necessary because communities are made of people connecting with each other. That connecting is the core problem JoinOrigin is being built to help with.',
    'JoinOrigin is a community OS still on the waitlist, designed to help people find, start, and organize communities — and in its digital model, a community lives in a creator-controlled room. Creator control is standard Matrix room ownership: the creator can invite and remove members, assign roles, edit room settings, pin messages, and archive the room — all enforced natively inside Element, the default chat client, with no custom permission system. That ownership is the backbone of moderation on JoinOrigin: the creator decides who belongs, what the rules are, and what happens when a rule is broken. JoinOrigin does not moderate third-party communities and does not provide moderation staff; it is still on the waitlist. But the platform is designed around healthy community structure, and the practices in this guide are the human practices every organizer needs regardless of tooling.',
  ...
  steps: [
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin is designed so the creator has full ownership of the room from publish, with no custom permission system. Today, learn the moderation controls of the platform you use and designate one clear owner.',
    },
    {
