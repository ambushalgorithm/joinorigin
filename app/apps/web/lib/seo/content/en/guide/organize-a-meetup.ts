  ...
  steps: [
    {
      ...
      joinOriginNote:
        'JoinOrigin is being built so that publishing a group auto-creates its room, a creator-controlled space where members plan and stay connected. Until early access opens, set up your group and its room in the tools you already use before you plan a single event.',
    },
    {
