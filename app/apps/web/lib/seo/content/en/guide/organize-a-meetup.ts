 ...
 * (per-step `joinOriginNote`), with honest waitlist framing — JoinOrigin
...
const content: GuideContent = {
  ...
  description:
    'Organize a meetup once your group has formed — choose a format, book a venue, build an agenda, promote it, and run the night. A practical checklist from JoinOrigin.',
  intro: [
    'A meetup is a recurring in-person event where people gather around a shared interest — and on JoinOrigin it can be a natural next step after communicating in the room. The digital path comes first: people find and join a group through a link, and the group’s room becomes the place where members talk, plan, and stay connected between gatherings. The in-person meetup can be a natural next step of that formed community.',
    'JoinOrigin is a community OS still on the waitlist, designed to help people find communities to join and start their own — so a meetup has a home where interested members can discover the group, join its room, and coordinate the gathering instead of depending on one person’s contact list. JoinOrigin does not book venues or staff events, and it is still on the waitlist, but the entire purpose of the platform is connecting people who share an interest.',
    'This guide covers the full lifecycle of a meetup after the group exists: choosing a format that fits your audience, finding and booking a venue without breaking the budget, building an agenda with a clear start and end, promoting the event where your audience actually looks, and running the night so that attendees leave wanting the next one. Every step includes a note on how JoinOrigin is designed to help — and the first step is about the digital group, because without a group and its room there is no community to meet.',
  ],
  dataPoints: [
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'JoinOrigin is being built to help people find and start communities — one organized digital home where a group’s room is where members coordinate and where a meetup can be discovered — but it is still on a waitlist and does not organize events itself. The practical steps in this guide work today without any platform.',
    },
  ],
  sections: [
    'Form the group and open its room first. A meetup is what a group does after it forms — so start with the digital core: publish the group, let its room be auto-created, and invite members through a link. JoinOrigin is being built so that publishing a group auto-creates its room, a creator-controlled space where members plan and stay connected. Until the platform opens, set up your group and its room in the tools you already use before you plan a single event.',
  ...
  steps: [
    {
      ...
      joinOriginNote:
        'JoinOrigin is being built so that publishing a group auto-creates its room, a creator-controlled space where members plan and stay connected. Until the platform opens, set up your group and its room in the tools you already use before you plan a single event.',
    },
    {
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin does not book venues or coordinate physical spaces — its design focus is connecting people in the digital room. Until the platform opens, confirm capacity and opening hours directly with the venue in writing.',
    },
    {
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin is designed to be the place where people looking for a community find it and join through a link. Today, promote in the niche groups and newsletters where your audience already gathers, and share the join link with every attendee.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin does not staff events — the experience is yours. The platform is being built to keep the community’s story in one organized room — the promise, the rhythm, and the people. Today, ending on time is the strongest signal of respect.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin is designed to give a community a persistent room where the recap, next date, and feedback live — turning a single event into a recurring community. Joining the waitlist keeps you first in line when the platform opens.',
    },
  ],
};
