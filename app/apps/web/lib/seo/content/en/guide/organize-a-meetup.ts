...
const content: GuideContent = {
  ...
  sections: [
    'Form the group and open its room first. A meetup is what a group does after it forms — so start with the digital core: publish the group, let its room be auto-created, and invite members through a link. JoinOrigin is being built so that publishing a group auto-creates its room (D1), a creator-controlled space where members plan and stay connected. Until early access opens, set up your group and its room in the tools you already use before you plan a single event.',
  ...
  steps: [
    {
      ...
      joinOriginNote:
        'JoinOrigin is being built so that publishing a group auto-creates its room (D1), a creator-controlled space where members plan and stay connected. Until early access opens, set up your group and its room in the tools you already use before you plan a single event.',
    },
    {
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin does not book venues or coordinate physical spaces — its design focus is connecting people in the digital room. Until early access opens, confirm capacity and opening hours directly with the venue in writing.',
    },
    {
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin is designed to give a community a persistent room where the recap, next date, and feedback live — turning a single event into a recurring community. Joining the waitlist keeps you first in line for early access.',
    },
  ],
};
