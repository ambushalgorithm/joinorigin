 ...
 * honest framing — JoinOrigin does not recruit members or run events.
 * Single H1, step-by-step structure, FAQ mirrored 1:1 in `FAQPage`
...
const content: GuideContent = {
  ...
  dataPoints: [
    ...
    'JoinOrigin is a community OS designed to help people find or start communities — it does not recruit members or run events.',
  ],
  faq: [
    {
    ...
    },
    {
      ...
      answer:
        'Yes. JoinOrigin helps people discover and start communities — a place where people looking for a group can find yours and join its room through a link. The steps in this guide — personal invitations and a great first gathering — are the most reliable ways to find your first members.',
    },
  ],
  sections: [
    ...
    'Invite every attendee into the room. At the end of the gathering, share the join link and add anyone who wants to stay. The room is where the community lives between gatherings — a member who joined the room is a member who is likely to return. JoinOrigin keeps your community’s membership and communication in one organized room instead of a sign-up sheet. A simple link into the room keeps the follow-up possible.',
    'Follow up within 24 hours with a next date. Thank each attendee, share a one-paragraph recap, and confirm the next gathering — in the room, where everyone can see it. The follow-up is where a one-time attendee becomes a member. On JoinOrigin a follow-up has a natural home — one place where the recap and next date live. A personal thank-you within 24 hours is what converts an attendee into a member.',
    'Make it trivially easy to invite others. Give members one sentence they can repeat and one link they can share: “It’s a monthly meetup for new founders to share lessons — join here.” A clear, short description is the most effective recruitment tool. JoinOrigin lets a community be described, found, and joined in one place — members can point people to the room instead of explaining it. Give members one sentence and one link they can repeat.',
  ],
  steps: [
    {
      ...
      joinOriginNote:
        'JoinOrigin gives your community a visible home and a room people can find — but the first names still come from people you know. List fifty and treat every one as a personal introduction.',
    },
    {
    ...
    },
    {
      ...
      body: 'Send a short message naming the community, the first date or first conversation, and why you think they would enjoy it — and include the join link. Personal messages beat generic posts, and a specific date beats a vague promise.',
      joinOriginNote:
        'JoinOrigin removes the friction of joining once people find you — one link, one click, into the room. A short personal message with a specific date and a link converts better than any public post.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin gives members one shareable home for the community — so referral conversations point to a real link and a real room. Make “bring a friend” part of the ask, and give them the link to share.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin does not run events — the experience is yours. The platform helps the community form around it: one room where members can point to afterward and keep the connection going.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin keeps your community’s membership and communication in one organized room instead of a sign-up sheet. A simple link into the room keeps the follow-up possible.',
    },
    {
      ...
      joinOriginNote:
        'On JoinOrigin a follow-up has a natural home — one place where the recap and next date live. A personal thank-you within 24 hours is what converts an attendee into a member.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin lets a community be described, found, and joined in one place — members can point people to the room instead of explaining it. Give members one sentence and one link they can repeat.',
    },
  ],
};
