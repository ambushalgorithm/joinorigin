 ...
 * PUBLISH (D1) → creator controls the room (D2) → feed/invite growth. The
 * idea page is the storefront promise; the room is where customers,
 * collaborators, and early believers gather around the business. Honest
...
const content: GuideContent = {
  ...
  intro: [
    ...
    'JoinOrigin is being designed around the digital loop: you publish a small business idea, its public idea page appears, and its room is auto-created at the moment of publishing (D1). People discover the page or follow a link, joining is a single click, and they land in the room — a creator-controlled Matrix room where customers, collaborators, and early believers can ask questions, share feedback, and get involved. JoinOrigin is still on the waitlist and these features are not built yet, so the practical steps in this guide work today with the tools you already have.',
  ...
  dataPoints: [
    ...
    'In the JoinOrigin design, publishing an idea auto-creates its room (D1) — the business has a place for customers and collaborators from the start.',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'In the JoinOrigin design, the room is auto-created the moment you publish the idea (D1). The creator owns the room from second zero and can invite, remove, and assign roles inside Element. Until the platform opens, open a room with the tools you already use and invite the people who care about the problem.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'JoinOrigin is being designed so that publishing an idea creates its page and room atomically — but the platform is still on the waitlist and the features are not built yet. Today, publish the idea somewhere public and open a room for discussion; joining the waitlist keeps you informed as the platform opens.',
    },
  ],
  sections: [
    'Name the customer and the problem. Before you write anything, name the specific person who feels this problem and describe the problem in their words. A small business succeeds when it serves one real need well. JoinOrigin is designed around findable idea pages, and the clearest pages start from a named customer. Until the platform opens, write the customer and problem down and test them on three people who fit.',
    'Write the idea page like a storefront. The page should show what you are offering, who it is for, what it costs in time or money, and what stage the idea is at. Keep it concrete — a pop-up, a product, a service, a shop. JoinOrigin is being built so that publishing an idea auto-creates its page and room (D1), with the creator controlling the room from the start. Today, draft the page as a short public post and refine it with feedback.',
    'Publish the idea and open its room. Publishing is the moment the business idea becomes findable. In the JoinOrigin model, the room is auto-created at the same moment (D1) — there is no separate setup step, and the creator owns it. JoinOrigin is being designed so the page, the room, and the join link are one publish. Today, publish the idea publicly and open a room for the conversation around it.',
    'Share the page with your local network. Small businesses grow through local reach. Share the idea page with neighbors, colleagues, local groups, and anyone who knows the problem firsthand. JoinOrigin is designed so joining is a single action — clicking Join on the public page or following a direct invite link from a member. Until the platform opens, one short, clear link to your idea does the same job.',
    'Invite early customers and collaborators. Invite the people who would actually buy or help: potential customers, someone with a skill you are missing, a mentor, or a local organizer. JoinOrigin is being built to make discovery easier — a place where people looking for an idea can find yours and join through a link. Personal invitations still do the heavy lifting today, and every joiner becomes a channel to their own network.',
    'Listen in the room. Ask joiners how they would use the offer, what they would pay, and what stops them. The room is where real demand shows up — or does not. JoinOrigin does not run these conversations; the room is yours to shape. The platform is designed to give the business idea one room where interest becomes feedback, and the creator owns that room (D2). Today, ask members directly in the room.',
    'Refine the offer from real feedback. Adjust the price, the scope, the channel, or the promise based on what joiners say. Small businesses are built in small iterations. JoinOrigin is being built to keep an idea’s shared memory in one place — notes, decisions, and feedback in the room — so refinement is visible instead of lost. Today, change one thing at a time and watch the response.',
    'Grow the room into your first customer base. Keep inviting, keep sharing updates, and keep the room alive as the offer firms up. The people in the room are your first customers and your first promoters. JoinOrigin is designed to keep your idea page and its room connected as the business grows — one place where the promise, the conversation, and the people are visible. Joining the waitlist keeps you informed as the platform opens.',
  ],
  steps: [
    {
      ...
      joinOriginNote:
        'JoinOrigin is designed around findable idea pages, and the clearest pages start from a named customer. Until the platform opens, write the customer and problem down and test them on three people who fit.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin is being built so that publishing an idea auto-creates its page and room (D1), with the creator controlling the room from the start. Today, draft the page as a short public post and refine it with feedback.',
    },
    {
      title: 'Publish the idea and open its room',
      body: 'Publishing is the moment the business idea becomes findable. In the JoinOrigin model, the room is auto-created at the same moment (D1) — there is no separate setup step, and the creator owns it.',
      joinOriginNote:
        'JoinOrigin is being designed so the page, the room, and the join link are one publish. Today, publish the idea publicly and open a room for the conversation around it.',
    },
    {
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin does not run these conversations; the room is yours to shape. The platform is designed to give the business idea one room where interest becomes feedback, and the creator owns that room (D2). Today, ask members directly in the room.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin is being built to keep an idea’s shared memory in one place — notes, decisions, and feedback in the room — so refinement is visible instead of lost. Today, change one thing at a time and watch the response.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin is designed to keep your idea page and its room connected as the business grows — one place where the promise, the conversation, and the people are visible. Joining the waitlist keeps you informed as the platform opens.',
    },
  ],
};
