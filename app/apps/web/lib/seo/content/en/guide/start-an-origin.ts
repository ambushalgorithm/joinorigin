...
const content: GuideContent = {
  ...
  intro: [
    ...
    'The approach works for any community type: a founder circle, a book club, a local running group, a small business network, or an online professional community — and it works whether you are starting from zero or formalizing a group that already meets informally. The core principle is simple — people join because of a clear promise, and they stay because the experience reliably delivers on that promise. You do not need a big budget, a venue, or an existing audience to begin; you need a clear purpose, a realistic first step, and the discipline to repeat it.',
  ],
  dataPoints: [
