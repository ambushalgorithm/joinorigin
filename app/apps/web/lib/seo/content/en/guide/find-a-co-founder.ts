...
const content: GuideContent = {
  ...
  intro: [
    'Finding a co-founder is a relationship decision disguised as a hiring decision, and at its core it is another connecting-people problem: the right person is often one warm introduction away, somewhere in a community you have not discovered yet. That is the problem JoinOrigin helps with — and it is the same problem whether you are still at the idea stage or running an existing company that needs a partner to take the next step.',
  ...
  sections: [
    ...
    'Have structured first conversations. Ask about their skills, risk tolerance, time commitment, and why they want to start or grow something. Share your own answers. This is a mutual interview, not a pitch. JoinOrigin does not match founders or run conversations — the mutual interview is yours. The platform puts you in the same communities and rooms as potential collaborators — the rest is up to you.',
  ...
  steps: [
    ...
    },
    {
      ...
      body: 'Ask about their skills, risk tolerance, time commitment, and why they want to start or grow something. Share your own answers. This is a mutual interview, not a pitch.',
      joinOriginNote:
