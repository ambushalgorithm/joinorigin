 ...
 * intro and every step (per-step `joinOriginNote`), with honest waitlist
...
const content: GuideContent = {
  ...
  sections: [
    ...
    'Publish your idea and open its room. An idea no one can find attracts no co-founder. Publish a clear idea page — what you are building, why, and the kind of person you need — and let its room be auto-created so interested people have a place to talk. JoinOrigin is being built so that publishing an idea auto-creates its room (D1), the place where co-founder conversations happen. Until the platform opens, publish your idea somewhere public and open a room for discussion around it.',
    ...
    'Decide based on the trial, not the potential. Ask whether you would trust this person with your reputation, whether they communicate honestly, and whether working together energizes you. If the trial felt strained, trust that signal. JoinOrigin does not make the decision for you. Its honest value, when the platform opens, is the community and room context that lets you meet and work with candidates — the trial still tells you the truth.',
  ...
  steps: [
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin is being built so that publishing an idea auto-creates its room (D1), the place where co-founder conversations happen. Until the platform opens, publish your idea somewhere public and open a room for discussion around it.',
    },
    {
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin does not make the decision for you. Its honest value, when the platform opens, is the community and room context that lets you meet and work with candidates — the trial still tells you the truth.',
    },
    {
