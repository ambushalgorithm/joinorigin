...
const content: GuideContent = {
  ...
  intro: [
    'Finding a co-founder is a relationship decision disguised as a hiring decision, and at its core it is another connecting-people problem: the right person is often one warm introduction away, somewhere in a community you have not discovered yet. That is the problem JoinOrigin is being built to help with.',
