...
/**
 * "Bir Origin Nasıl Başlatılır" — L1 kalıcı rehber (tasarım §6.1, TASK-326).
 *
...
const content: GuideContent = {
  ...
  title: 'Bir Origin Nasıl Başlatılır: Adım Adım Rehber | JoinOrigin',
  description:
    'Bir Origin’i nasıl başlatacağınızı öğrenin — ya da mevcut bir Origin’e tek bir dijital yuva verin — bir grup yayınlayın, odasını açın ve üyeleri bir katılım bağlantısıyla getirin. JoinOrigin’den pratik adımlar.',
  intro: [
    'Bir Origin’i başlatmanın en zor kısmı nadiren mekan, gündem ya da bütçedir — ilgi alanınızı paylaşan ilk insanları bulmak ve onlara bağlanmak için tek net bir yer vermektir. JoinOrigin’in tam olarak çözdüğü sorun budur.',
    'JoinOrigin, dijital döngü etrafında kurulmuş bir topluluk işletim sistemidir: bir grup yayınlarsınız, odası otomatik oluşturulur ve üyeler bir bağlantıyla katılır. Oda, Origin’in gerçekten yaşadığı yerdir — üyelerin ilk günden itibaren konuştuğu, güncellemeler paylaştığı ve birlikte planladığı, oluşturan kişinin kontrolündeki bir Matrix odası; tablolar, dağınık mesajlar ve kayıt formları yerine. Yüz yüze etkinlikler yalnızca aşağı yönlü bir sonuç olarak vardır: bir grup oluştuğunda ve odası canlandığında, üyeler yüz yüze buluşmayı seçebilir — ve JoinOrigin yerel etkinlikler düzenlemez. Platformun tüm amacı, aksi halde asla tanışmayacak insanları bağlamaktır; bu nedenle bu rehberdeki her adım, JoinOrigin’in yardımcı olduğu bir şeye karşılık gelir.',
    'Yaklaşım her Origin türü için çalışır: bir kurucu çevresi, bir kitap kulübü, yerel bir koşu grubu, küçük bir işletme ağı ya da çevrimiçi bir profesyonel Origin — ve hem sıfırdan başlıyorsanız hem de zaten resmi olmayan şekilde bir araya gelen bir grubu resmileştiriyorsanız çalışır. Temel ilke basittir — insanlar net bir vaat yüzünden katılır ve deneyim o vaadi güvenilir şekilde yerine getirdiği için kalır. Başlamak için büyük bir bütçeye, bir mekana ya da mevcut bir kitleye ihtiyacınız yoktur; net bir amaca, gerçekçi bir ilk adıma ve onu tekrarlama disiplinine ihtiyacınız vardır.',
  ],
  dataPoints: [
    'Başarılı Origin’lerin çoğu “ilgilenen herkes” yerine dar, spesifik bir hedef kitleyle başlar.',
    ...
    'JoinOrigin, insanların Origins bulmasına veya başlatmasına yardımcı olmak için tasarlanmış bir topluluk işletim sistemidir — yerel etkinlikler düzenlemez ve yerel personel iddia etmez.',
  ],
  faq: [
    {
      question: 'Bir Origin’i başlatmak ne kadar sürer?',
      answer:
        'Kapsamı küçük tutarsanız birkaç hafta içinde bir grup yayınlayabilir ve odasını açabilirsiniz: tek bir amaç, tek bir katılım bağlantısı ve istikrarlı bir kişisel davet akışı. Origin’in kendisi, yerleşmiş hissetmeden önce odada birkaç ay tutarlı katılım gerektirir.',
    },
    {
      question: 'Başlamak için paraya ya da mekana ihtiyacım var mı?',
      answer:
        'Hayır. Bir Origin’in dijital çekirdeği — yayınlanmış bir grup ve odası — hiçbir maliyet gerektirmez ve mekan gerektirmez. Çoğu grup daha sonra yüz yüze buluşmayı seçer; kütüphaneler, kafeler, parklar ve ortak çalışma salonları çoğu şehirde ilk buluşmalara ücretsiz ev sahipliği yapar.',
    },
    {
      question: 'Bir Origin’i başlatırken en sık yapılan hata nedir?',
      answer:
        'Herkesi memnun etmeye çalışmak. Belirsiz bir amaca sahip bir Origin az sayıda bağlı üye çeker. Tek bir spesifik hedef kitle ve tek bir net sonuç tanımlayın, grup sayfasına koyun ve Origin’in oradan gelişmesine izin verin.',
    },
    {
      question: 'JoinOrigin bir Origin başlatmama nasıl yardımcı olabilir?',
      answer:
        'JoinOrigin’de bir grubu yayınlamak odasını otomatik oluşturur ve üyeler bir bağlantıyla katılır — bir Origin’in amacı, insanları ve sohbeti için tek bir düzenli dijital yuva. JoinOrigin yerel etkinlikler düzenlemez, bu nedenle bu rehberdeki pratik adımlar platformda ve hâlihazırda sahip olduğunuz araçlarla çalışır.',
    },
  ],
  sections: [
    'Net bir amaç tanımlayın. Origin’in kimin için olduğuna, hangi sorunu çözdüğüne ve başarılı bir üyenin nasıl göründüğüne karar verin. “Brooklyn’deki yeni kurucuların erken dönem derslerini paylaştığı bir grup” gibi tek cümlelik bir misyon yazın. JoinOrigin amacınıza bir yuva verir — misyonun, hedef kitlenin ve vaadin, sizinki gibi bir grup arayan herkese görünür olduğu herkese açık bir grup sayfası. Misyonu yazın ve her davetin önünde tutun.',
    'Grubu yayınlayın ve odasını açın. Bir Origin’in dijital çekirdeği, üyelerin konuşabileceği bir odası olan yayınlanmış bir gruptur. JoinOrigin’de bir grubu yayınlamak odasını otomatik oluşturur — oluşturan kişi sıfırıncı saniyeden itibaren sahiptir ve Element içinde davet edebilir, çıkarabilir ve roller atayabilir. JoinOrigin’de “sohbeti sonra oluştur” adımı yoktur: grubu yayınlayın ve oda hemen var olur, oluşturan kişi oda sahibi olur. İsterseniz grup yuvasını ve odasını hâlihazırda kullandığınız araçlarda da kurun.',
  ...
  steps: [
    ...
    },
    {
      ...
      body: 'Bir Origin’in dijital çekirdeği, üyelerin konuşabileceği bir odası olan yayınlanmış bir gruptur. JoinOrigin’de bir grubu yayınlamak odasını otomatik oluşturur — oluşturan kişi sıfırıncı saniyeden itibaren sahiptir ve Element içinde davet edebilir, çıkarabilir ve roller atayabilir.',
      joinOriginNote:
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin keşfi kolaylaştırır — bir Origin arayan insanların sizinkini bulup bir bağlantıyla katılabileceği bir yer. Kişisel davetler hâlâ asıl işi yapar ve davet ettiğiniz her üye kendi ağına açılan bir kanal olur.',
    },
    {
      title: 'Bir format ve ritim seçin (aşağı yönlü bir seçim)',
      body: 'Grup oluşmaya başladığında tekrarlanan bir format seçin — aylık bir tartışma, haftalık bir çalışma oturumu, bir konuşma ya da sosyal bir yürüyüş. Tekrarlanan formatlar tek seferlik olanları yener çünkü alışkanlıklar yabancıları üyeye dönüştürür. Bu aşağı yönlü bir seçimdir: grup daha sonra yüz yüze toplanabilir, ancak oda zaten Origin’in yuvasıdır.',
      joinOriginNote:
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin buluşmalara personel sağlamaz ya da düzenlemez — deneyim sizin tasarımınızdır. Platform Origin’in etrafında oluşmasına yardımcı olur: tarihin, özetin ve sonraki adımların yaşadığı tek bir ortak oda.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin, bir Origin’in ortak hafızasını tek bir yerde tutar — notlar, kararlar ve üyelerin istedikleri — böylece yineleme kaybolmak yerine görünür olur. Her buluşmadan sonra üyelere doğrudan odada sorun.',
    },
    {
      title: 'Tutarlı bir ritim yayınlayın ve yavaş büyüyün',
      body: 'Genişlemeden önce aynı günü ve formatı birkaç ay koruyun. Her üye Origin’in ne olduğunu tek cümleyle anlatıp katılım bağlantısını paylaşabildiğinde büyüme tavsiyelerle bileşik etki yaratır.',
      joinOriginNote:
        'JoinOrigin, Origin’inizin büyürken bulunabilir ve bağlı kalmasına yardımcı olur — ritmin, vaadin, odanın ve insanların görünür olduğu tek bir yer. Keşfedilin ve büyüyün.',
    },
  ],
};
