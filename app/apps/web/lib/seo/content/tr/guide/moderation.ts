...
/**
 * "Origin Moderasyonu" — L1 kalıcı rehber (tasarım §6.1, TASK-326).
 *
 ...
 * JoinOrigin üçüncü taraf Origins moderasyon etmez ya da moderasyon
...
const content: GuideContent = {
  ...
  locale: 'tr',
  slug: 'moderation',
  title: 'Origin Moderasyonu: Gruplar Nasıl Sağlıklı ve Davetkâr Tutulur | JoinOrigin',
  description:
  ...
  intro: [
    'Büyüyen her Origin eninde sonunda kültürünü test eden bir anla karşılaşır — hararetli bir tartışma, bir spam gönderici, başkalarını rahatsız eden bir üye ya da kontrolden çıkan bir yanlış anlama. Moderasyon, Origin’in davetkâr kalabilmesi için alanı koruma pratiğidir ve yalnızca topluluklar birbirine bağlanan insanlardan oluştuğu için gerekli hale gelir. Bu bağlanma, JoinOrigin’in yardımcı olduğu çekirdek sorundur — ve uygulamalar, kültürünü düzelten yerleşik bir Origin için de ilk üye gelmeden önce beklentileri belirleyen yeni bir grup için de aynı şekilde geçerlidir.',
    ...
    'Bu rehber pratik bir moderasyon sistemi ortaya koyar — Origin’iniz yepyeni olsun ya da temizlenecek yıllarca geçmişi olsun: kısa ve spesifik yazılmış Origin kuralları, çıkarmalardan önce uyarılarla net bir uygulama yolu, gergin durumları yatıştırma teknikleri ve üyeleri ne zaman dahil edeceğiniz, ne zaman yalnız hareket edeceğiniz konusunda dürüst tavsiyeler. Her adım JoinOrigin’in nerede yardımcı olduğunu gösterir.',
  ],
  dataPoints: [
    'Net, yazılı Origin kuralları, olaylar olmadan önce beklentileri belirleyerek çatışmayı azaltır.',
  ...
  faq: [
    {
      question: 'Küçük Origins gerçekten moderasyon kurallarına ihtiyaç duyar mı?',
      answer:
        'Evet ve ne kadar erken olursa o kadar iyi. Bir çatışmadan önce yazılmış iki ya da üç kısa kural, bir çatışmadan sonra uydurulan kurallardan çok daha kolay uygulanır. Küçük Origins daha az olay olur, ancak yaşadıkları olaylar aynı derecede acı vericidir.',
    },
    {
    ...
    {
      question: 'Birini Origin’den ne zaman çıkarmalıyım?',
      answer:
  ...
  sections: [
    ...
    'Yükü ortak moderatörlerle paylaşın. Güvendiğiniz bir ya da iki üye bulun ve uygulama kuralları üzerinde anlaşın. Tek bir moderatöre bağımlı bir Origin kırılgan ve yanlı olur. JoinOrigin moderasyon personeli sağlamaz — ortak moderatörler diğer üyelerdir. Oluşturan kişiler, Element’te ortak moderatörlere roller atar — özel bir sistem olmadan doğal Matrix rolleri. Güvendiğiniz bir ya da iki üye bulun ve onlara net roller verin.',
  ],
  steps: [
    {
    ...
    },
    {
      ...
      body: 'İstediğiniz davranışı modelleyin — yeni gelenleri karşılayın, katkıda bulunanlara teşekkür edin ve sorunları sakin şekilde ele alın. Oluşturan kişinin örneği, Origin’in kültürel tabanını belirler.',
      joinOriginNote:
        'JoinOrigin Origins denetlemez — tonu oluşturan kişiler ve üyeler belirler. Platform, karşılayıcı davranışı görünür kılar; odada istediğiniz davranışı modelleyin.',
    },
    {
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin Origin etkileşimlerini tasarım gereği düzenli ve sakin tutar, ancak yatıştırma insani bir zanaat olarak kalır. Sohbeti yavaşlatın ve harareti özel bir odaya taşıyın.',
    },
    {
    ...
    },
    {
      ...
      body: 'Güvendiğiniz bir ya da iki üye bulun ve uygulama kuralları üzerinde anlaşın. Tek bir moderatöre bağımlı bir Origin kırılgan ve yanlı olur.',
      joinOriginNote:
