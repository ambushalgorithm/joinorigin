...
const content: GuideContent = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Evet. JoinOrigin, insanların toplulukları bulmasına ve başlatmasına yardımcı olur — bir grubun odasının üyelerin koordine olduğu ve bir buluşmanın keşfedilebildiği tek bir düzenli dijital yuva. JoinOrigin etkinlikleri kendisi organize etmez, bu nedenle bu rehberdeki pratik adımları yürütmek sizindir.',
    },
  ],
  sections: [
  ...
  steps: [
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin, bir topluluk arayan insanların onu bulup bir bağlantıyla katıldığı yerdir. Hedef kitlenizin zaten toplandığı niş gruplarda ve bültenlerde tanıtım yapın ve katılım bağlantısını her katılımcıyla paylaşın.',
    },
    {
