...
const content: GuideContent = {
  ...
  description:
    'Becerilerinizi tamamlayan bir kurucu ortak bulun — ister yeni bir girişim başlatıyor ister mevcut bir işi büyütüyor olun — bir fikir sayfası yayınlayın, Origins ve odalarında buluşun, bir deneme projesi yürütün ve ayrılıkları önleyen soruları sorun. JoinOrigin’den.',
  intro: [
    'Kurucu ortak bulmak, işe alım kararı kılığına girmiş bir ilişki kararıdır ve özünde bir başka insanları bağlama sorunudur: doğru kişi genellikle henüz keşfetmediğiniz bir Origin’de, bir sıcak tanıştırma uzağındadır. JoinOrigin’in yardımcı olduğu sorun budur — ve hâlâ fikir aşamasında olsanız da sonraki adımı atmak için bir ortak gerektiren mevcut bir şirketi işletiyor olsanız da aynı sorundur.',
  ...
  faq: [
    {
      ...
      answer:
        'Çoğu kurucu sıcak ağlar aracılığıyla tanışır — etkinlikler, Origins, odalar ve güvendikleri insanlardan gelen tanıştırmalar. İnsanların bulabileceği bir fikir yayınlamak, ardından aynı Origins ve odalarında tutarlı şekilde görünmek, potansiyel kurucu ortaklarla tanışmanın en güvenilir yoludur.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'JoinOrigin, insanların Origins ve iş birliği yapanları bulmasına yardımcı olur — kurucuların buluştuğu türdeki Origins dahil — sohbetlerin yaşanabileceği bir fikir sayfası ve bir odayla. JoinOrigin kurucuları eşleştirmez, bu nedenle bu rehberdeki ağ kurma ve deneme projesi adımları en güvenilir yolunuzdur.',
    },
  ],
  sections: [
    'Önce beceri boşluklarınızı haritalayın. Gerçekten iyi olduğunuz şeyleri ve girişimin sizde olmayan ihtiyaçlarını yazın. Bir kurucu ortak en büyük boşluğunuzu kapatmalıdır — teknik, ticari ya da operasyonel — güçlü yanlarınızı tekrarlamamalıdır. JoinOrigin eşleştirme değil, profiller, fikirler ve Origins etrafında kurulmuştur — bu yüzden dürüst tavsiye her zamanki gibidir: bakmadan önce hangi boşluğu kapatmanız gerektiğini bilin. Güçlü yanlarınızı ve girişimin ihtiyaçlarını yazın.',
    ...
    'Sıcak tanıştırmalar için mevcut ağınızı çalıştırın. Güvendiğiniz beş kişiye ne inşa ettiğinizi ve ne tür bir kurucu ortağa ihtiyacınız olduğunu söyleyin. Her birinden tek bir isim isteyin. Sıcak tanıştırmalar, soğuk erişimden neredeyse her durumda daha iyidir. JoinOrigin Origins bulunabilir kılar, bu da sıcak ağınızı zamanla genişletir — ve her tanıştırma, gerçek sohbetin yaşandığı bir odaya götürebilir. Güvendiğiniz beş kişiye tam olarak ne tür bir kurucu ortağa ihtiyacınız olduğunu söyleyin.',
    'İlgili Origins ve odalarında tutarlı şekilde görünün. Doğru türden insanların toplandığı etkinliklere katılın ve gruplara üye olun: kurucu buluşmaları, sektör toplulukları, ortak çalışma alanları ve çevrimiçi odalar. Tekrar, tanıştırmalara götüren güveni inşa eder. JoinOrigin, insanların hedeflerine uyan Origins — kurucuların buluştuğu türde yerleri — bulmasına ve odalarına katılmasına yardımcı olur. Doğru insanların zaten toplandığı buluşmaları ve odaları seçin ve görünmeye devam edin.',
    'Yapılandırılmış ilk sohbetler yapın. Becerilerini, risk toleranslarını, zaman taahhütlerini ve neden bir şey başlatmak ya da büyütmek istediklerini sorun. Kendi yanıtlarınızı paylaşın. Bu karşılıklı bir mülakattır, bir sunum değil. JoinOrigin kurucuları eşleştirmez ya da sohbetleri yürütmez — karşılıklı mülakat sizindir. Platform sizi potansiyel iş birliği yapanlarla aynı Origins ve odalara koyar — gerisi size kalmıştır.',
    'Birlikte bir deneme projesi yürütün. Küçük ve gerçek bir şey seçin — bir prototip, bir açılış sayfası ya da ücretli bir pilot — ve dört ila altı hafta üzerinde çalışın. İşi nasıl böldüğünüzü, geri bildirimi nasıl ele aldığınızı ve baskı altında nasıl davrandığınızı izleyin. JoinOrigin, Origins işleri ve projeleri için ortak bir oda verir — bir deneme projesinin ortaya çıkması için doğal bir yer. Küçük, gerçek bir prototip en güvenilir testtir.',
    'Potansiyele göre değil, denemeye göre karar verin. Bu kişiye itibarınızı emanet edip etmeyeceğinizi, dürüst iletişim kurup kurmadığını karşı ve birlikte çalışmanın sizi enerjilendirip enerjilendirmediğini sorun. Deneme zorlayıcı geldiyse o sinyale güvenin. JoinOrigin kararı sizin yerinize vermez. Dürüst değeri, adaylarla tanışıp çalışmanızı sağlayan Origin ve oda bağlamıdır — gerçeği yine de deneme söyler.',
  ...
  steps: [
    {
      ...
      joinOriginNote:
        'JoinOrigin eşleştirme değil, profiller, fikirler ve Origins etrafında kurulmuştur — bu yüzden dürüst tavsiye her zamanki gibidir: bakmadan önce hangi boşluğu kapatmanız gerektiğini bilin. Güçlü yanlarınızı ve girişimin ihtiyaçlarını yazın.',
    },
    {
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin Origins bulunabilir kılar, bu da sıcak ağınızı zamanla genişletir — ve her tanıştırma, gerçek sohbetin yaşandığı bir odaya götürebilir. Güvendiğiniz beş kişiye tam olarak ne tür bir kurucu ortağa ihtiyacınız olduğunu söyleyin.',
    },
    {
      title: 'İlgili Origins ve odalarında tutarlı şekilde görünün',
      ...
      joinOriginNote:
        'JoinOrigin, insanların hedeflerine uyan Origins — kurucuların buluştuğu türde yerleri — bulmasına ve odalarına katılmasına yardımcı olur. Doğru insanların zaten toplandığı buluşmaları ve odaları seçin ve görünmeye devam edin.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin kurucuları eşleştirmez ya da sohbetleri yürütmez — karşılıklı mülakat sizindir. Platform sizi potansiyel iş birliği yapanlarla aynı Origins ve odalara koyar — gerisi size kalmıştır.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin, Origins işleri ve projeleri için ortak bir oda verir — bir deneme projesinin ortaya çıkması için doğal bir yer. Küçük, gerçek bir prototip en güvenilir testtir.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin kararı sizin yerinize vermez. Dürüst değeri, adaylarla tanışıp çalışmanızı sağlayan Origin ve oda bağlamıdır — gerçeği yine de deneme söyler.',
    },
    {
