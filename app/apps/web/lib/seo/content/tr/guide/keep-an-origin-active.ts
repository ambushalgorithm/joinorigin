...
/**
 * "Bir Origin Nasıl Aktif Tutulur" — L1 kalıcı rehber (tasarım §6.1,
 * TASK-326).
 *
 * Dijital bağlan→katıl→oda modeline göre yeniden odaklanmıştır: oda ve
 * etkinliği (akışı beslemek) elde tutma yüzeyidir — Origin buluşmalar
 ...
 * işlenmiştir, dürüst çerçeveyle — JoinOrigin Origins yönetmez ya da
...
const content: GuideContent = {
  ...
  title: 'Bir Origin Nasıl Aktif ve Bağlı Tutulur | JoinOrigin',
  description:
  ...
  intro: [
    'Çoğu Origin kötü bir lansmandan ölmez; sessizlikten ölür — insanların bağlı hissetmeyi bırakıp sessizce uzaklaştığı andan. Bir Origin’i aktif tutmak bu nedenle bir insanları bağlama sorunudur: insanlar aidiyet hissettiklerinde kalır ve Origin’in yaşadığı görünür, düzenli bir yer olduğunda aidiyet hissederler. JoinOrigin tam olarak budur — ve aynı mekanikler, Origin birkaç haftalık olup ritmini hâlâ buluyor olsa da ya da yıllardır var olup sessizliğe sürükleniyor olsa da geçerlidir.',
  ...
  faq: [
    {
      question: 'Aktif bir Origin ne sıklıkta toplanmalı?',
      answer:
    ...
    },
    {
      ...
      answer:
        'Evet. JoinOrigin, insanların Origins bulmasına, başlatmasına ve organize etmesine yardımcı olur — Origin’in buluşmalar arasında görünür kaldığı tek bir oda ve akış. Bu rehberdeki uygulamalar — ritüeller, paylaşılan roller ve küçük katkılar — platformda ve hâlihazırda sahip olduğunuz araçlarla çalışır.',
    },
  ],
  sections: [
    'Çekirdek bir ritüel tanımlayın. Herkesin güvenebileceği tek bir tekrarlanan uygulama seçin: aylık bir toplantı, haftalık bir kontrol, ortak bir okuma ya da bir proje güncellemesi. Ritüeller, bir Origin’i canlı tutan kalp atışını yaratır — ve dijital öncelikli bir Origin’de ritüel odada gerçekleşir. JoinOrigin’de bir Origin’in ritmi tek bir düzenli odada görünürdür — üyeler her zaman sonraki ritüeli bilir. Tek bir tekrarlanan uygulama seçin ve onu koruyun.',
    ...
    'Organizatör yükünü dağıtın. İki ya da üç ortak ev sahibi ya da yardımcı bulun ve küçük rolleri dönüşümlü olarak yapın: karşılama, not alma, konu seçimi, mekan iletişimi. Paylaşılan sahiplik, tükenmeye karşı en iyi savunmadır. JoinOrigin Origins personel sağlamaz ya da onları yönetmez — paylaşılan sahipliği siz kurarsınız. Platform, yardımcılara ve organizatörlere koordinasyon için tek bir oda verir. İki ya da üç ortak ev sahibi bulun ve rolleri dönüşümlü yapın.',
    'Küçük katkı yolları açın. Üyelere büyük taahhütler olmadan değer katmanın yollarını verin: bir üye vitrini, dönüşümlü bir tartışma lideri, ortak bir çalma ya da okuma listesi ya da odada sabitlenmiş bir “yardım aranıyor” bölümü. JoinOrigin’de üyelerin katkıda bulunmanın görünür yolları vardır — değer katmanın kolay olduğu bir Origin. Üye vitrinleri ve dönüşümlü liderler aynı sahiplik hissini yaratır.',
    ...
    'Etkileşim sinyallerini izleyin. Oda etkinliğini, tekrarlanan katılımı ve katkı oranını takip edin. Sağlıklı bir Origin, toplam boyutundan önce tekrarlanan katılım oranını büyütür — odaya geri dönen üyelere odaklanın. JoinOrigin’de organizatörler Origin’lerinin nasıl gittiğini tek bir düzenli oda ve akışta görebilir. Etkinliği, tekrarlanan katılımı ve katkı oranını basit bir tabloyla takip edin.',
    'Odada düzenli olarak geri bildirim isteyin. Her buluşmadan sonra basit bir tek soruluk anket kullanın: neyi beğendiniz, neyi değiştirirdiniz. Yanıtlara göre hareket edin ve Origin’e neyi değiştirdiğinizi söyleyin. JoinOrigin, geri bildirimi ait olduğu Origin ile birlikte — odada — toplar ve tutar. Her buluşmadan sonra tek soruluk bir anket işe yarar — ardından yanıtlara göre hareket edin.',
    'Origin olgunlaştıkça formatı uyarlayın. On üye için işe yarayan, elli üyeye uymayabilir. Formatı, mekanı ve sıklığı üç ayda bir gözden geçirin ve alışkanlıktan tutunmak yerine bilinçli olarak geliştirin. JoinOrigin Origins gelişmesine yardımcı olur — format değişikliklerinin ve duyuruların herkese ulaştığı tek bir oda. Formatınızı ve mekanınızı üç ayda bir bilinçli olarak gözden geçirin.',
  ],
  steps: [
    {
      title: 'Çekirdek bir ritüel tanımlayın',
      body: 'Herkesin güvenebileceği tek bir tekrarlanan uygulama seçin: aylık bir toplantı, haftalık bir kontrol, ortak bir okuma ya da bir proje güncellemesi. Ritüeller, bir Origin’i canlı tutan kalp atışını yaratır — ve dijital öncelikli bir Origin’de ritüel odada gerçekleşir.',
      joinOriginNote:
        'JoinOrigin’de bir Origin’in ritmi tek bir düzenli odada görünürdür — üyeler her zaman sonraki ritüeli bilir. Tek bir tekrarlanan uygulama seçin ve onu koruyun.',
    },
    {
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin Origins personel sağlamaz ya da onları yönetmez — paylaşılan sahipliği siz kurarsınız. Platform, yardımcılara ve organizatörlere koordinasyon için tek bir oda verir. İki ya da üç ortak ev sahibi bulun ve rolleri dönüşümlü yapın.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin’de üyelerin katkıda bulunmanın görünür yolları vardır — değer katmanın kolay olduğu bir Origin. Üye vitrinleri ve dönüşümlü liderler aynı sahiplik hissini yaratır.',
    },
    {
    ...
    },
    {
      ...
      body: 'Oda etkinliğini, tekrarlanan katılımı ve katkı oranını takip edin. Sağlıklı bir Origin, toplam boyutundan önce tekrarlanan katılım oranını büyütür — odaya geri dönen üyelere odaklanın.',
      joinOriginNote:
        'JoinOrigin’de organizatörler Origin’lerinin nasıl gittiğini tek bir düzenli oda ve akışta görebilir. Etkinliği, tekrarlanan katılımı ve katkı oranını basit bir tabloyla takip edin.',
    },
    {
      title: 'Odada düzenli olarak geri bildirim isteyin',
      body: 'Her buluşmadan sonra basit bir tek soruluk anket kullanın: neyi beğendiniz, neyi değiştirirdiniz. Yanıtlara göre hareket edin ve Origin’e neyi değiştirdiğinizi söyleyin.',
      joinOriginNote:
        'JoinOrigin, geri bildirimi ait olduğu Origin ile birlikte — odada — toplar ve tutar. Her buluşmadan sonra tek soruluk bir anket işe yarar — ardından yanıtlara göre hareket edin.',
    },
    {
      title: 'Origin olgunlaştıkça formatı uyarlayın',
      ...
      joinOriginNote:
        'JoinOrigin Origins gelişmesine yardımcı olur — format değişikliklerinin ve duyuruların herkese ulaştığı tek bir oda. Formatınızı ve mekanınızı üç ayda bir bilinçli olarak gözden geçirin.',
    },
  ],
};
