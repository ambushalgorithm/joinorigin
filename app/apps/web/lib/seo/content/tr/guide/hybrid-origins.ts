...
/**
 * "Hibrit Topluluklar" — L1 kalıcı rehber (tasarım §6.1, TASK-326).
 *
 ...
 * bağlayan şeydir — tek topluluk, tek oda, iki giriş noktası. JoinOrigin
...
const content: GuideContent = {
  ...
  locale: 'tr',
  slug: 'hybrid-origins',
  title: 'Hibrit Topluluklar: Yüz Yüze + Çevrimiçi Birlikte Nasıl Yürütülür | JoinOrigin',
  description:
    'Odanın yüz yüze ve çevrimiçi üyeleri bağladığı bir hibrit topluluk yürütün — ister sıfırdan başlıyor ister mevcut bir topluluğu hibrit yapıyor olun — doğru araçları seçin, eşit katılımı tasarlayın ve iki kitleyi de bağlı tutun. JoinOrigin’den.',
  intro: [
    'Hibrit bir topluluk, insanları aynı anda iki yerde bir araya getirir — fiziksel olarak bir mekanda ve sanal olarak bir ekran aracılığıyla — ve asıl zorluk yine insanlarla ilgilidir: iki kitlenin de ayrı iki topluluk değil, tek bir bağlı topluluk gibi hissetmesini sağlamak. JoinOrigin tam da bu insanları bağlama hedefiyle kurulmuştur ve model, zaten var olan bir topluluk için de yeni başlayan bir topluluk için de işe yarar — yerleşik bir yüz yüze grup çevrimiçi bir yarı ekleyebilir ve çevrimiçi bir topluluk yerel olarak buluşmaya başlayabilir.',
    ...
    'Bu rehber, hibrit toplulukları başarılı kılan pratik kararları kapsar — yeni gruplar için de mevcut gruplar için de: hibritin doğru model olup olmadığına karar vermek, iki kitlenin de paylaştığı odayı kurmak, uyan bir format ve araçlar seçmek, yüz yüze ve çevrimiçi üyelerin aynı deneyimi paylaşması için buluşmayı tasarlamak, hiçbir tarafın baskın olmaması için alanı yönetmek ve topluluğu buluşmalar arasında bir arada tutan kalıcı bir oda sürdürmek. Her adım JoinOrigin’in nerede yardımcı olduğunu gösterir.',
  ],
  dataPoints: [
    'Hibrit bir topluluk, ayrı ayrı hizmet verilecek iki kitle değil, iki giriş noktası olan tek bir topluluktur.',
  ...
  faq: [
    {
      question: 'Bir topluluk ne zaman hibrit olmalı?',
      answer:
        'Kitlenizin bir kısmı mesafe, program ya da hareketlilik nedeniyle güvenilir şekilde yüz yüze katılamadığında ve topluluk hâlâ tek bir paylaşılan kimlik istediğinde. Herkes yerel olarak buluşabiliyorsa yüz yüze buluşmak daha basit ve genellikle daha iyidir.',
    },
    {
    ...
    {
      question: 'JoinOrigin bir hibrit topluluk yürütmeme yardımcı olabilir mi?',
      answer:
        'Evet. JoinOrigin, insanların toplulukları bulmasına ve başlatmasına yardımcı olur — yerel ve uzak üyelerin bağlı kaldığı tek bir oda. JoinOrigin etkinlik araçları sağlamaz, bu nedenle bu rehberdeki pratik hibrit uygulamalar hâlihazırda sahip olduğunuz araçlarla çalışır.',
    },
  ],
  sections: [
    ...
    'İki kitlenin de paylaştığı odayı kurun. Her şeyden önce, topluluğun uzak ve yerel üyelerin konuştuğu, güncellemeler paylaştığı ve aynı sonraki adımları gördüğü ortak bir odaya sahip olduğundan emin olun. Oda, hibritin iki topluluk yerine tek bir topluluk gibi hissetmesini sağlayan şeydir. JoinOrigin’de her grubun yayından itibaren bir odası vardır — çevrimiçi ve yüz yüze kısımları bir arada tutan kalıcı yüzey. İki kitlenin de katılabileceği tek bir ortak oda kurun.',
    ...
    'Gündemi iki kitle için tasarlayın. Uzak üyeleri isimleriyle içeren bir tanışma turu yapın, görselleri ortak bir ekranda tutun ve çevrimiçi tarafın konuşması için alan bırakın. Hibrit bir gündem iki kitleyi de açıkça adlandırır. JoinOrigin’de iki kitle tek bir topluluk odasını paylaşır, bu da "iki kitle için tasarlamayı" doğal bir uyum haline getirir. İki kitleyi de gündemde açıkça adlandırın.',
    ...
    'Odayı buluşmalar arasında canlı tutun. Topluluk etkinlikler arasında odada yaşar: uzak ve yerel üyeler orada güncellemeler paylaşır, sorular sorar ve birlikte planlar. Hibrit tek bir etkinlik formatı değildir — devam eden bir paylaşılan alandır. Bu adım, JoinOrigin’in tasarım amacına en yakın adımdır: bir topluluk işletim sistemi, uzak ve yerel üyelerin güncellemeler paylaştığı ve birlikte planladığı kalıcı bir odadır. Ortak bir oda işe yarar — JoinOrigin o alandır.',
  ...
  steps: [
    ...
    },
    {
      ...
      body: 'Her şeyden önce, topluluğun uzak ve yerel üyelerin konuştuğu, güncellemeler paylaştığı ve aynı sonraki adımları gördüğü ortak bir odaya sahip olduğundan emin olun. Oda, hibritin iki topluluk yerine tek bir topluluk gibi hissetmesini sağlayan şeydir.',
      joinOriginNote:
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin’de iki kitle tek bir topluluk odasını paylaşır, bu da "iki kitle için tasarlamayı" doğal bir uyum haline getirir. İki kitleyi de gündemde açıkça adlandırın.',
    },
    {
    ...
    },
    {
      ...
      body: 'Topluluk etkinlikler arasında odada yaşar: uzak ve yerel üyeler orada güncellemeler paylaşır, sorular sorar ve birlikte planlar. Hibrit tek bir etkinlik formatı değildir — devam eden bir paylaşılan alandır.',
      joinOriginNote:
