...
const content: GuideContent = {
  ...
  description:
    'Finde eine:n Co-Gründer:in, der:die deine Fähigkeiten ergänzt — ob du startest oder ein bestehendes Vorhaben ausbaust — veröffentliche eine Ideenseite, treffe dich in Communities und ihren Räumen, führe ein Testprojekt durch und stelle die Fragen, die Trennungen verhindern. Von JoinOrigin.',
  intro: [
  ...
  dataPoints: [
    ...
    'JoinOrigin ist ein Community-Betriebssystem, das Menschen helfen soll, Communities und Mitgestalter:innen zu finden; es ist kein Matchmaking-Dienst und hat keine lokalen Büros.',
  ],
  faq: [
    {
      question: 'Wo finden die meisten Menschen ihre:n Co-Gründer:in?',
      answer:
        'Die meisten Gründer:innen treffen sich über warme Netzwerke — Events, Communities, Räume und Empfehlungen von Menschen, denen sie vertrauen. Eine Idee zu veröffentlichen, die Menschen finden können, und dann konsequent in denselben Communities und ihren Räumen aufzutauchen, ist der zuverlässigste Weg, potenzielle Co-Gründer:innen kennenzulernen.',
    },
    {
  ...
  sections: [
    ...
    'Arbeite dein bestehendes Netzwerk für warme Empfehlungen. Sag fünf Menschen, denen du vertraust, was du baust und welche Art von Co-Gründer:in du brauchst. Bitte jede:n um einen Namen. Warme Empfehlungen schlagen kalte Ansprache in fast jedem Fall. JoinOrigin macht Communities auffindbar, was dein warmes Netzwerk im Laufe der Zeit erweitert — und jede Empfehlung kann zu einem Raum führen, in dem das echte Gespräch stattfindet. Sag fünf Menschen, denen du vertraust, genau, welche Art von Co-Gründer:in du brauchst.',
    'Tauche konsequent in relevanten Communities und ihren Räumen auf. Besuche Events und tritt Gruppen bei, in denen die richtige Art von Mensch sich versammelt: Gründer:innen-Meetups, Branchen-Communities, Coworking-Spaces und Online-Räume. Wiederholung baut das Vertrauen auf, das zu Empfehlungen führt. JoinOrigin hilft Menschen, die Communities zu finden, die zu ihren Zielen passen — die Art von Ort, an dem Gründer:innen sich treffen — und ihren Räumen beizutreten. Wähle die Meetups und Räume, in denen die richtigen Menschen bereits zusammenkommen, und tauche weiter auf.',
    'Führe strukturierte erste Gespräche. Frag nach ihren Fähigkeiten, ihrer Risikotoleranz, ihrem Zeitaufwand und warum sie etwas starten oder ausbauen wollen. Teile deine eigenen Antworten. Das ist ein gegenseitiges Interview, kein Pitch. JoinOrigin matched keine Gründer:innen und führt keine Gespräche — das gegenseitige Interview ist deins. Die Plattform bringt dich in dieselben Communities und Räume wie potenzielle Mitgestalter:innen — der Rest liegt bei dir.',
    'Führt gemeinsam ein Testprojekt durch. Wähle etwas Kleines und Echtes — einen Prototyp, eine Landingpage oder einen bezahlten Pilot — und arbeite vier bis sechs Wochen daran. Beobachte, wie ihr Arbeit aufteilt, mit Feedback umgeht und unter Druck agiert. JoinOrigin gibt Communities einen gemeinsamen Raum für ihre Arbeit und Projekte — ein natürlicher Ort, an dem ein Testprojekt entstehen kann. Ein kleiner echter Prototyp ist der zuverlässigste Test.',
  ...
  steps: [
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin macht Communities auffindbar, was dein warmes Netzwerk im Laufe der Zeit erweitert — und jede Empfehlung kann zu einem Raum führen, in dem das echte Gespräch stattfindet. Sag fünf Menschen, denen du vertraust, genau, welche Art von Co-Gründer:in du brauchst.',
    },
    {
      title: 'Tauche konsequent in relevanten Communities und ihren Räumen auf',
      ...
      joinOriginNote:
        'JoinOrigin hilft Menschen, die Communities zu finden, die zu ihren Zielen passen — die Art von Ort, an dem Gründer:innen sich treffen — und ihren Räumen beizutreten. Wähle die Meetups und Räume, in denen die richtigen Menschen bereits zusammenkommen, und tauche weiter auf.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin matched keine Gründer:innen und führt keine Gespräche — das gegenseitige Interview ist deins. Die Plattform bringt dich in dieselben Communities und Räume wie potenzielle Mitgestalter:innen — der Rest liegt bei dir.',
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin gibt Communities einen gemeinsamen Raum für ihre Arbeit und Projekte — ein natürlicher Ort, an dem ein Testprojekt entstehen kann. Ein kleiner echter Prototyp ist der zuverlässigste Test.',
    },
    {
