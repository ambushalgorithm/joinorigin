...
/**
 * „So startest du eine Community“ — zeitlose L1-Anleitung (Design §6.1,
 * TASK-326).
 *
...
const content: GuideContent = {
  ...
  title: 'So startest du eine Community: Eine Schritt-für-Schritt-Anleitung | JoinOrigin',
  description:
    'Lerne, wie du eine Community startest — oder einer bestehenden ein einziges digitales Zuhause gibst — veröffentliche eine Gruppe, öffne ihren Raum und bringe Mitglieder über einen Beitrittslink herein. Praktische Schritte von JoinOrigin.',
  intro: [
    'Der schwerste Teil beim Starten einer Community ist selten der Ort, die Tagesordnung oder das Budget — es ist, die ersten Menschen zu finden, die dein Interesse teilen, und ihnen einen klaren Ort zum Verbinden zu geben. Genau das löst JoinOrigin.',
  ...
  dataPoints: [
    ...
    'JoinOrigin ist ein Community-Betriebssystem, das Menschen helfen soll, Communities zu finden oder zu starten — es führt keine lokalen Events durch und behauptet keine lokalen Mitarbeitenden.',
  ],
  faq: [
    {
      question: 'Wie lange dauert es, eine Community zu starten?',
      answer:
        'Du kannst eine Gruppe veröffentlichen und ihren Raum innerhalb weniger Wochen öffnen, wenn du den Umfang klein hältst: ein Zweck, ein Beitrittslink und ein stetiger Strom persönlicher Einladungen. Die Community selbst braucht ein paar Monate konsequenter Teilnahme im Raum, bevor sie sich etabliert anfühlt.',
    },
    {
    ...
    {
      question: 'Was ist der häufigste Fehler beim Starten einer Community?',
      answer:
        'Allen dienen zu wollen. Eine Community mit vagem Zweck zieht wenige engagierte Mitglieder an. Definiere eine konkrete Zielgruppe und ein klares Ergebnis, setze es auf die Gruppenseite und lass die Community sich von dort entwickeln.',
    },
    {
      question: 'Wie kann JoinOrigin mir helfen, eine Community zu starten?',
      answer:
        'Eine Gruppe auf JoinOrigin zu veröffentlichen erstellt automatisch ihren Raum, und Mitglieder treten über einen Link bei — ein organisiertes digitales Zuhause für Zweck, Menschen und Gespräch einer Community. JoinOrigin führt keine lokalen Events durch, daher funktionieren die praktischen Schritte dieser Anleitung auf der Plattform und mit den Tools, die du bereits hast.',
    },
  ],
  sections: [
    'Definiere einen klaren Zweck. Entscheide, für wen die Community ist, welches Problem sie löst und wie ein erfolgreiches Mitglied aussieht. Schreibe eine Mission in einem Satz, etwa „eine Gruppe für neue Gründer:innen in Brooklyn, um frühe Lektionen zu teilen“. JoinOrigin gibt deinem Zweck ein Zuhause — eine öffentliche Gruppenseite, auf der Mission, Zielgruppe und Versprechen für alle sichtbar sind, die nach einer Gruppe wie deiner suchen. Schreibe die Mission auf und halte sie vor jeder Einladung präsent.',
  ...
  steps: [
    ...
    },
    {
      ...
      joinOriginNote:
        'JoinOrigin macht das Entdecken einfacher — ein Ort, an dem Menschen, die eine Community suchen, deine finden und über einen Link beitreten können. Persönliche Einladungen leisten weiterhin die schwere Arbeit, und jedes Mitglied, das du einlädst, wird zu einem Kanal in sein eigenes Netzwerk.',
    },
    {
