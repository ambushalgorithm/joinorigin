...
const content: CountryContent = {
  ...
  description:
    'Finde oder gründe Origins in Deutschland – Startup, Kreativ, politisch, Meetups und Kleinunternehmen. Jetzt auf die JoinOrigin-Warteliste.',
  intro:
  ...
  faq: [
    {
      question: 'Wie finde ich Origins in Deutschland?',
      answer:
        'Nutze den /location-Bereich, um eine Stadt zu wählen, und erkunde dann die Gruppentyp-Seiten für Startup-, Kreativ-, politische, Meetup- und Kleinunternehmer-Origins. Lokale Vereine und Veranstaltungsplattformen sind ebenfalls gute Ausgangspunkte für Offline-Gruppen.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Ja. JoinOrigin hat keine lokalen Büros. Die Berlin-Seiten sind ins Deutsche übersetzt, und das Produkt hilft Menschen, überall in Deutschland Origins zu finden oder zu gründen.',
    },
  ],
};
