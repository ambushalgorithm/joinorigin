...
const content: CountryContent = {
  ...
  locale: 'it',
  slug: 'italy',
  title: 'Comunità in Italia | JoinOrigin',
  description:
    'Trova o crea comunità in Italia — dalle scene startup di Milano alle associazioni locali, alla cultura del cibo e alle reti di piccole imprese. Lista d’attesa di JoinOrigin.',
  intro:
  ...
  faq: [
    {
      question: 'Come trovo comunità in Italia?',
      answer:
    ...
    {
      question: 'Posso creare una comunità in una città italiana?',
      answer:
    ...
    },
    {
      ...
      answer:
        'Sì. JoinOrigin non ha uffici locali. Le pagine Italia e Milano sono tradotte in italiano, e la piattaforma aiuta le persone a trovare o creare comunità in qualsiasi parte del Paese.',
    },
  ],
};
