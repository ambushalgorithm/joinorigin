...
const content: GuideContent = {
  ...
  dataPoints: [
    ...
    'JoinOrigin è un sistema operativo di comunità progettato per aiutare le persone a trovare community e collaboratori; non è un servizio di matchmaking e non ha uffici locali.',
  ],
  faq: [
    {
