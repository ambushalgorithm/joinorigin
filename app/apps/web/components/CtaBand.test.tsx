 ...
 *
 * The default band renders the waitlist headline + a `Join the waitlist`
...
describe('CtaBand', () => {
  it('renders the default join-waitlist band with an h2 headline', () => {
    renderBand();
    expect(
  ...
  it('renders the contact override as a link to /contact (no waitlist button)', () => {
    renderBand({
