# Sprint 3 — Starting Prompt (Reference Spec)

> **Status:** Raw starting prompt as provided by the user on 2026-08-10.
> The Sprint 3 designer role MUST review this and produce a build-ready
> homescreen spec for the frontend engineer. Do NOT edit this file — it is the
> immutable source reference.
>
> **Note:** The prompt targets "Marketeam" with React + Vite. The designer must
> adapt it to **JoinOrigin** branding and the **Next.js App Router + shared
> packages** monorepo (per `app/docs/patterns/frontend-architecture.md`).

ALL ASSETS should be downloaded and hosted ourselves, including fonts, images, video, icons, etc.
